...
final api_instance = ApiregistrationV1Api();
final body = IoK8sKubeAggregatorPkgApisApiregistrationV1APIService(); // IoK8sKubeAggregatorPkgApisApiregistrationV1APIService | 
...
try {
    final result = api_instance.createApiregistrationV1APIService(body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
final api_instance = ApiregistrationV1Api();
final name = name_example; // String | name of the APIService
final pretty = pretty_example; // String | If 'true', then the output is pretty printed.
final dryRun = dryRun_example; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
...
try {
    final result = api_instance.deleteApiregistrationV1APIService(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.deleteApiregistrationV1CollectionAPIService(pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getApiregistrationV1APIResources();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listApiregistrationV1APIService(pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.patchApiregistrationV1APIService(name, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.patchApiregistrationV1APIServiceStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.readApiregistrationV1APIService(name, pretty);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.readApiregistrationV1APIServiceStatus(name, pretty);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.replaceApiregistrationV1APIService(name, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.replaceApiregistrationV1APIServiceStatus(name, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchApiregistrationV1APIService(name, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchApiregistrationV1APIServiceList(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
