...
**conditions** | [**List<IoK8sApiAppsV1DeploymentCondition>**](IoK8sApiAppsV1DeploymentCondition.md) | Represents the latest available observations of a deployment's current state. | [optional] [default to const []]
