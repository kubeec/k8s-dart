...
> IoK8sApiDiscoveryV1EndpointSlice createDiscoveryV1NamespacedEndpointSlice(namespace, body, pretty, dryRun, fieldManager, fieldValidation)
...
final api_instance = DiscoveryV1Api();
final namespace = namespace_example; // String | object name and auth scope, such as for teams and projects
final body = IoK8sApiDiscoveryV1EndpointSlice(); // IoK8sApiDiscoveryV1EndpointSlice | 
...
try {
    final result = api_instance.createDiscoveryV1NamespacedEndpointSlice(namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->createDiscoveryV1NamespacedEndpointSlice: $e\n');
}
```
 ...
 **body** | [**IoK8sApiDiscoveryV1EndpointSlice**](IoK8sApiDiscoveryV1EndpointSlice.md)|  | 
...
> IoK8sApimachineryPkgApisMetaV1Status deleteDiscoveryV1CollectionNamespacedEndpointSlice(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body)
...
try {
    final result = api_instance.deleteDiscoveryV1CollectionNamespacedEndpointSlice(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->deleteDiscoveryV1CollectionNamespacedEndpointSlice: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteDiscoveryV1NamespacedEndpointSlice(name, namespace, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body)
...
final api_instance = DiscoveryV1Api();
final name = name_example; // String | name of the EndpointSlice
final namespace = namespace_example; // String | object name and auth scope, such as for teams and projects
final pretty = pretty_example; // String | If 'true', then the output is pretty printed.
final dryRun = dryRun_example; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
final gracePeriodSeconds = 56; // int | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
...
try {
    final result = api_instance.deleteDiscoveryV1NamespacedEndpointSlice(name, namespace, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->deleteDiscoveryV1NamespacedEndpointSlice: $e\n');
}
```
...
try {
    final result = api_instance.getDiscoveryV1APIResources();
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->getDiscoveryV1APIResources: $e\n');
}
```
...
> IoK8sApiDiscoveryV1EndpointSliceList listDiscoveryV1EndpointSliceForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.listDiscoveryV1EndpointSliceForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->listDiscoveryV1EndpointSliceForAllNamespaces: $e\n');
}
```
...
> IoK8sApiDiscoveryV1EndpointSliceList listDiscoveryV1NamespacedEndpointSlice(namespace, pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.listDiscoveryV1NamespacedEndpointSlice(namespace, pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->listDiscoveryV1NamespacedEndpointSlice: $e\n');
}
```
...
> IoK8sApiDiscoveryV1EndpointSlice patchDiscoveryV1NamespacedEndpointSlice(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force)
...
try {
    final result = api_instance.patchDiscoveryV1NamespacedEndpointSlice(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->patchDiscoveryV1NamespacedEndpointSlice: $e\n');
}
```
...
> IoK8sApiDiscoveryV1EndpointSlice readDiscoveryV1NamespacedEndpointSlice(name, namespace, pretty)
...
try {
    final result = api_instance.readDiscoveryV1NamespacedEndpointSlice(name, namespace, pretty);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->readDiscoveryV1NamespacedEndpointSlice: $e\n');
}
```
...
> IoK8sApiDiscoveryV1EndpointSlice replaceDiscoveryV1NamespacedEndpointSlice(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation)
...
try {
    final result = api_instance.replaceDiscoveryV1NamespacedEndpointSlice(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->replaceDiscoveryV1NamespacedEndpointSlice: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchDiscoveryV1EndpointSliceListForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchDiscoveryV1EndpointSliceListForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->watchDiscoveryV1EndpointSliceListForAllNamespaces: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchDiscoveryV1NamespacedEndpointSlice(name, namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchDiscoveryV1NamespacedEndpointSlice(name, namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->watchDiscoveryV1NamespacedEndpointSlice: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchDiscoveryV1NamespacedEndpointSliceList(namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchDiscoveryV1NamespacedEndpointSliceList(namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling DiscoveryV1Api->watchDiscoveryV1NamespacedEndpointSliceList: $e\n');
}
```
