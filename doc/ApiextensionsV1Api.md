...
final api = K8s().getApiextensionsV1Api();
final IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition body = ; // IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition | 
...
try {
    final response = api.createApiextensionsV1CustomResourceDefinition(body, pretty, dryRun, fieldManager, fieldValidation);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->createApiextensionsV1CustomResourceDefinition: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteApiextensionsV1CollectionCustomResourceDefinition(pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body)
...
try {
    final response = api.deleteApiextensionsV1CollectionCustomResourceDefinition(pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->deleteApiextensionsV1CollectionCustomResourceDefinition: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteApiextensionsV1CustomResourceDefinition(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body)
...
final api = K8s().getApiextensionsV1Api();
final String name = name_example; // String | name of the CustomResourceDefinition
final String pretty = pretty_example; // String | If 'true', then the output is pretty printed.
final String dryRun = dryRun_example; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
final int gracePeriodSeconds = 56; // int | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
final bool orphanDependents = true; // bool | Deprecated: please use the PropagationPolicy, this field will be deprecated in 1.7. Should the dependent objects be orphaned. If true/false, the \"orphan\" finalizer will be added to/removed from the object's finalizers list. Either this field or PropagationPolicy may be set, but not both.
...
try {
    final response = api.deleteApiextensionsV1CustomResourceDefinition(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->deleteApiextensionsV1CustomResourceDefinition: $e\n');
}
```
...
try {
    final response = api.getApiextensionsV1APIResources();
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->getApiextensionsV1APIResources: $e\n');
}
```
...
try {
    final response = api.listApiextensionsV1CustomResourceDefinition(pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->listApiextensionsV1CustomResourceDefinition: $e\n');
}
```
...
try {
    final response = api.patchApiextensionsV1CustomResourceDefinition(name, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->patchApiextensionsV1CustomResourceDefinition: $e\n');
}
```
...
try {
    final response = api.patchApiextensionsV1CustomResourceDefinitionStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->patchApiextensionsV1CustomResourceDefinitionStatus: $e\n');
}
```
...
try {
    final response = api.readApiextensionsV1CustomResourceDefinition(name, pretty);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->readApiextensionsV1CustomResourceDefinition: $e\n');
}
```
...
try {
    final response = api.readApiextensionsV1CustomResourceDefinitionStatus(name, pretty);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->readApiextensionsV1CustomResourceDefinitionStatus: $e\n');
}
```
...
try {
    final response = api.replaceApiextensionsV1CustomResourceDefinition(name, body, pretty, dryRun, fieldManager, fieldValidation);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->replaceApiextensionsV1CustomResourceDefinition: $e\n');
}
```
...
try {
    final response = api.replaceApiextensionsV1CustomResourceDefinitionStatus(name, body, pretty, dryRun, fieldManager, fieldValidation);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->replaceApiextensionsV1CustomResourceDefinitionStatus: $e\n');
}
```
...
try {
    final response = api.watchApiextensionsV1CustomResourceDefinition(name, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->watchApiextensionsV1CustomResourceDefinition: $e\n');
}
```
...
try {
    final response = api.watchApiextensionsV1CustomResourceDefinitionList(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(response);
} catch on DioError (e) {
    print('Exception when calling ApiextensionsV1Api->watchApiextensionsV1CustomResourceDefinitionList: $e\n');
}
```
