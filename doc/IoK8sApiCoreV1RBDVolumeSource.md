# k8s.model.IoK8sApiCoreV1RBDVolumeSource
...
**monitors** | **BuiltList&lt;String&gt;** | monitors is a collection of Ceph monitors. More info: https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it | 
