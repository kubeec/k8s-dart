...
> IoK8sApiEventsV1Event createEventsV1NamespacedEvent(namespace, body, pretty, dryRun, fieldManager, fieldValidation)
...
try {
    final result = api_instance.createEventsV1NamespacedEvent(namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->createEventsV1NamespacedEvent: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteEventsV1CollectionNamespacedEvent(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body)
...
try {
    final result = api_instance.deleteEventsV1CollectionNamespacedEvent(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->deleteEventsV1CollectionNamespacedEvent: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteEventsV1NamespacedEvent(name, namespace, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body)
...
final api_instance = EventsV1Api();
final name = name_example; // String | name of the Event
final namespace = namespace_example; // String | object name and auth scope, such as for teams and projects
final pretty = pretty_example; // String | If 'true', then the output is pretty printed.
final dryRun = dryRun_example; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
final gracePeriodSeconds = 56; // int | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
...
try {
    final result = api_instance.deleteEventsV1NamespacedEvent(name, namespace, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->deleteEventsV1NamespacedEvent: $e\n');
}
```
...
try {
    final result = api_instance.getEventsV1APIResources();
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->getEventsV1APIResources: $e\n');
}
```
...
> IoK8sApiEventsV1EventList listEventsV1EventForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.listEventsV1EventForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->listEventsV1EventForAllNamespaces: $e\n');
}
```
...
> IoK8sApiEventsV1EventList listEventsV1NamespacedEvent(namespace, pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.listEventsV1NamespacedEvent(namespace, pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->listEventsV1NamespacedEvent: $e\n');
}
```
...
> IoK8sApiEventsV1Event patchEventsV1NamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force)
...
try {
    final result = api_instance.patchEventsV1NamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->patchEventsV1NamespacedEvent: $e\n');
}
```
...
> IoK8sApiEventsV1Event readEventsV1NamespacedEvent(name, namespace, pretty)
...
try {
    final result = api_instance.readEventsV1NamespacedEvent(name, namespace, pretty);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->readEventsV1NamespacedEvent: $e\n');
}
```
...
> IoK8sApiEventsV1Event replaceEventsV1NamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation)
...
try {
    final result = api_instance.replaceEventsV1NamespacedEvent(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->replaceEventsV1NamespacedEvent: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchEventsV1EventListForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchEventsV1EventListForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->watchEventsV1EventListForAllNamespaces: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchEventsV1NamespacedEvent(name, namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchEventsV1NamespacedEvent(name, namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->watchEventsV1NamespacedEvent: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchEventsV1NamespacedEventList(namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchEventsV1NamespacedEventList(namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling EventsV1Api->watchEventsV1NamespacedEventList: $e\n');
}
```
