# k8s.model.IoK8sApiCoreV1DownwardAPIVolumeSource
...
**items** | [**List<IoK8sApiCoreV1DownwardAPIVolumeFile>**](IoK8sApiCoreV1DownwardAPIVolumeFile.md) | Items is a list of downward API volume file | [optional] [default to const []]
