...
final api_instance = AuthenticationV1Api();
final body = IoK8sApiAuthenticationV1TokenReview(); // IoK8sApiAuthenticationV1TokenReview | 
...
try {
    final result = api_instance.createAuthenticationV1TokenReview(body, dryRun, fieldManager, fieldValidation, pretty);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getAuthenticationV1APIResources();
    print(result);
} catch (e) {
