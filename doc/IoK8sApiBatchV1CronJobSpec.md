# k8s.model.IoK8sApiBatchV1CronJobSpec
...
**failedJobsHistoryLimit** | **int** | The number of failed finished jobs to retain. Value must be non-negative integer. Defaults to 1. | [optional] 
...
**successfulJobsHistoryLimit** | **int** | The number of successful finished jobs to retain. Value must be non-negative integer. Defaults to 3. | [optional] 
