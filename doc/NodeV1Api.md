...
------------- | ------------- | -------------
[**createNodeV1RuntimeClass**](NodeV1Api.md#createnodev1runtimeclass) | **POST** /apis/node.k8s.io/v1/runtimeclasses | 
[**deleteNodeV1CollectionRuntimeClass**](NodeV1Api.md#deletenodev1collectionruntimeclass) | **DELETE** /apis/node.k8s.io/v1/runtimeclasses | 
[**deleteNodeV1RuntimeClass**](NodeV1Api.md#deletenodev1runtimeclass) | **DELETE** /apis/node.k8s.io/v1/runtimeclasses/{name} | 
[**getNodeV1APIResources**](NodeV1Api.md#getnodev1apiresources) | **GET** /apis/node.k8s.io/v1/ | 
[**listNodeV1RuntimeClass**](NodeV1Api.md#listnodev1runtimeclass) | **GET** /apis/node.k8s.io/v1/runtimeclasses | 
[**patchNodeV1RuntimeClass**](NodeV1Api.md#patchnodev1runtimeclass) | **PATCH** /apis/node.k8s.io/v1/runtimeclasses/{name} | 
[**readNodeV1RuntimeClass**](NodeV1Api.md#readnodev1runtimeclass) | **GET** /apis/node.k8s.io/v1/runtimeclasses/{name} | 
[**replaceNodeV1RuntimeClass**](NodeV1Api.md#replacenodev1runtimeclass) | **PUT** /apis/node.k8s.io/v1/runtimeclasses/{name} | 
[**watchNodeV1RuntimeClass**](NodeV1Api.md#watchnodev1runtimeclass) | **GET** /apis/node.k8s.io/v1/watch/runtimeclasses/{name} | 
[**watchNodeV1RuntimeClassList**](NodeV1Api.md#watchnodev1runtimeclasslist) | **GET** /apis/node.k8s.io/v1/watch/runtimeclasses | 


# **createNodeV1RuntimeClass**
> IoK8sApiNodeV1RuntimeClass createNodeV1RuntimeClass(body, pretty, dryRun, fieldManager, fieldValidation)
...
final api_instance = NodeV1Api();
final body = IoK8sApiNodeV1RuntimeClass(); // IoK8sApiNodeV1RuntimeClass | 
...
try {
    final result = api_instance.createNodeV1RuntimeClass(body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->createNodeV1RuntimeClass: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteNodeV1CollectionRuntimeClass(pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body)
...
try {
    final result = api_instance.deleteNodeV1CollectionRuntimeClass(pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->deleteNodeV1CollectionRuntimeClass: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteNodeV1RuntimeClass(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body)
...
final api_instance = NodeV1Api();
final name = name_example; // String | name of the RuntimeClass
final pretty = pretty_example; // String | If 'true', then the output is pretty printed.
final dryRun = dryRun_example; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
final gracePeriodSeconds = 56; // int | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
final orphanDependents = true; // bool | Deprecated: please use the PropagationPolicy, this field will be deprecated in 1.7. Should the dependent objects be orphaned. If true/false, the \"orphan\" finalizer will be added to/removed from the object's finalizers list. Either this field or PropagationPolicy may be set, but not both.
...
try {
    final result = api_instance.deleteNodeV1RuntimeClass(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->deleteNodeV1RuntimeClass: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1APIResourceList getNodeV1APIResources()
...
try {
    final result = api_instance.getNodeV1APIResources();
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->getNodeV1APIResources: $e\n');
}
```
...
> IoK8sApiNodeV1RuntimeClassList listNodeV1RuntimeClass(pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.listNodeV1RuntimeClass(pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->listNodeV1RuntimeClass: $e\n');
}
```
...
> IoK8sApiNodeV1RuntimeClass patchNodeV1RuntimeClass(name, body, pretty, dryRun, fieldManager, fieldValidation, force)
...
try {
    final result = api_instance.patchNodeV1RuntimeClass(name, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->patchNodeV1RuntimeClass: $e\n');
}
```
...
> IoK8sApiNodeV1RuntimeClass readNodeV1RuntimeClass(name, pretty)
...
try {
    final result = api_instance.readNodeV1RuntimeClass(name, pretty);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->readNodeV1RuntimeClass: $e\n');
}
```
...
> IoK8sApiNodeV1RuntimeClass replaceNodeV1RuntimeClass(name, body, pretty, dryRun, fieldManager, fieldValidation)
...
try {
    final result = api_instance.replaceNodeV1RuntimeClass(name, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->replaceNodeV1RuntimeClass: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchNodeV1RuntimeClass(name, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchNodeV1RuntimeClass(name, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->watchNodeV1RuntimeClass: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchNodeV1RuntimeClassList(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchNodeV1RuntimeClassList(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling NodeV1Api->watchNodeV1RuntimeClassList: $e\n');
}
```
