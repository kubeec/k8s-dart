...
final api = K8s().getAuthenticationV1alpha1Api();
final IoK8sApiAuthenticationV1alpha1SelfSubjectReview body = ; // IoK8sApiAuthenticationV1alpha1SelfSubjectReview | 
...
try {
    final response = api.createAuthenticationV1alpha1SelfSubjectReview(body, dryRun, fieldManager, fieldValidation, pretty);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.getAuthenticationV1alpha1APIResources();
    print(response);
} catch on DioError (e) {
