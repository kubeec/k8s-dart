...
final api_instance = AutoscalingV2Api();
final namespace = namespace_example; // String | object name and auth scope, such as for teams and projects
final body = IoK8sApiAutoscalingV2HorizontalPodAutoscaler(); // IoK8sApiAutoscalingV2HorizontalPodAutoscaler | 
...
try {
    final result = api_instance.createAutoscalingV2NamespacedHorizontalPodAutoscaler(namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
> IoK8sApimachineryPkgApisMetaV1Status deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body)
...
try {
    final result = api_instance.deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(result);
} catch (e) {
    print('Exception when calling AutoscalingV2Api->deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler: $e\n');
}
```
...
try {
    final result = api_instance.deleteAutoscalingV2NamespacedHorizontalPodAutoscaler(name, namespace, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getAutoscalingV2APIResources();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listAutoscalingV2HorizontalPodAutoscalerForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listAutoscalingV2NamespacedHorizontalPodAutoscaler(namespace, pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling AutoscalingV2Api->listAutoscalingV2NamespacedHorizontalPodAutoscaler: $e\n');
}
```
...
try {
    final result = api_instance.patchAutoscalingV2NamespacedHorizontalPodAutoscaler(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
    print('Exception when calling AutoscalingV2Api->patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus: $e\n');
}
```
...
try {
    final result = api_instance.readAutoscalingV2NamespacedHorizontalPodAutoscaler(name, namespace, pretty);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.readAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(name, namespace, pretty);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.replaceAutoscalingV2NamespacedHorizontalPodAutoscaler(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
> IoK8sApiAutoscalingV2HorizontalPodAutoscaler replaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation)
...
try {
    final result = api_instance.replaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchAutoscalingV2HorizontalPodAutoscalerListForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchAutoscalingV2NamespacedHorizontalPodAutoscaler(name, namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchAutoscalingV2NamespacedHorizontalPodAutoscalerList(namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling AutoscalingV2Api->watchAutoscalingV2NamespacedHorizontalPodAutoscalerList: $e\n');
}
```
