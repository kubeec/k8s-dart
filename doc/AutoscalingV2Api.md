...
try {
    final response = api.deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.listAutoscalingV2NamespacedHorizontalPodAutoscaler(namespace, pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(response);
} catch on DioError (e) {
...
try {
    final response = api.watchAutoscalingV2NamespacedHorizontalPodAutoscalerList(namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(response);
} catch on DioError (e) {
