# k8s.api.InternalApiserverV1alpha1Api
...
> IoK8sApiApiserverinternalV1alpha1StorageVersion createInternalApiserverV1alpha1StorageVersion(body, pretty, dryRun, fieldManager, fieldValidation)
...
final api_instance = InternalApiserverV1alpha1Api();
final body = IoK8sApiApiserverinternalV1alpha1StorageVersion(); // IoK8sApiApiserverinternalV1alpha1StorageVersion | 
...
try {
    final result = api_instance.createInternalApiserverV1alpha1StorageVersion(body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->createInternalApiserverV1alpha1StorageVersion: $e\n');
}
```
...
------------- | ------------- | ------------- | -------------
 **body** | [**IoK8sApiApiserverinternalV1alpha1StorageVersion**](IoK8sApiApiserverinternalV1alpha1StorageVersion.md)|  | 
...
> IoK8sApimachineryPkgApisMetaV1Status deleteInternalApiserverV1alpha1CollectionStorageVersion(pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body)
...
try {
    final result = api_instance.deleteInternalApiserverV1alpha1CollectionStorageVersion(pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->deleteInternalApiserverV1alpha1CollectionStorageVersion: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1Status deleteInternalApiserverV1alpha1StorageVersion(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body)
...
final api_instance = InternalApiserverV1alpha1Api();
final name = name_example; // String | name of the StorageVersion
final pretty = pretty_example; // String | If 'true', then the output is pretty printed.
final dryRun = dryRun_example; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
final gracePeriodSeconds = 56; // int | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
final orphanDependents = true; // bool | Deprecated: please use the PropagationPolicy, this field will be deprecated in 1.7. Should the dependent objects be orphaned. If true/false, the \"orphan\" finalizer will be added to/removed from the object's finalizers list. Either this field or PropagationPolicy may be set, but not both.
...
try {
    final result = api_instance.deleteInternalApiserverV1alpha1StorageVersion(name, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->deleteInternalApiserverV1alpha1StorageVersion: $e\n');
}
```
...
try {
    final result = api_instance.getInternalApiserverV1alpha1APIResources();
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->getInternalApiserverV1alpha1APIResources: $e\n');
}
```
...
> IoK8sApiApiserverinternalV1alpha1StorageVersionList listInternalApiserverV1alpha1StorageVersion(pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.listInternalApiserverV1alpha1StorageVersion(pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->listInternalApiserverV1alpha1StorageVersion: $e\n');
}
```
...
> IoK8sApiApiserverinternalV1alpha1StorageVersion patchInternalApiserverV1alpha1StorageVersion(name, body, pretty, dryRun, fieldManager, fieldValidation, force)
...
try {
    final result = api_instance.patchInternalApiserverV1alpha1StorageVersion(name, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->patchInternalApiserverV1alpha1StorageVersion: $e\n');
}
```
...
> IoK8sApiApiserverinternalV1alpha1StorageVersion patchInternalApiserverV1alpha1StorageVersionStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force)
...
try {
    final result = api_instance.patchInternalApiserverV1alpha1StorageVersionStatus(name, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->patchInternalApiserverV1alpha1StorageVersionStatus: $e\n');
}
```
...
> IoK8sApiApiserverinternalV1alpha1StorageVersion readInternalApiserverV1alpha1StorageVersion(name, pretty)
...
try {
    final result = api_instance.readInternalApiserverV1alpha1StorageVersion(name, pretty);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->readInternalApiserverV1alpha1StorageVersion: $e\n');
}
```
...
> IoK8sApiApiserverinternalV1alpha1StorageVersion readInternalApiserverV1alpha1StorageVersionStatus(name, pretty)
...
try {
    final result = api_instance.readInternalApiserverV1alpha1StorageVersionStatus(name, pretty);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->readInternalApiserverV1alpha1StorageVersionStatus: $e\n');
}
```
...
> IoK8sApiApiserverinternalV1alpha1StorageVersion replaceInternalApiserverV1alpha1StorageVersion(name, body, pretty, dryRun, fieldManager, fieldValidation)
...
try {
    final result = api_instance.replaceInternalApiserverV1alpha1StorageVersion(name, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->replaceInternalApiserverV1alpha1StorageVersion: $e\n');
}
```
...
> IoK8sApiApiserverinternalV1alpha1StorageVersion replaceInternalApiserverV1alpha1StorageVersionStatus(name, body, pretty, dryRun, fieldManager, fieldValidation)
...
try {
    final result = api_instance.replaceInternalApiserverV1alpha1StorageVersionStatus(name, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->replaceInternalApiserverV1alpha1StorageVersionStatus: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchInternalApiserverV1alpha1StorageVersion(name, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchInternalApiserverV1alpha1StorageVersion(name, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->watchInternalApiserverV1alpha1StorageVersion: $e\n');
}
```
...
> IoK8sApimachineryPkgApisMetaV1WatchEvent watchInternalApiserverV1alpha1StorageVersionList(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch)
...
try {
    final result = api_instance.watchInternalApiserverV1alpha1StorageVersionList(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
    print('Exception when calling InternalApiserverV1alpha1Api->watchInternalApiserverV1alpha1StorageVersionList: $e\n');
}
```
