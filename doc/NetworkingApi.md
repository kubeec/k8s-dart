...
final api_instance = NetworkingApi();

try {
    final result = api_instance.getNetworkingAPIGroup();
    print(result);
} catch (e) {
    print('Exception when calling NetworkingApi->getNetworkingAPIGroup: $e\n');
}
```
