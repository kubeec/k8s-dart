...
final api_instance = CoordinationV1Api();
final namespace = namespace_example; // String | object name and auth scope, such as for teams and projects
final body = IoK8sApiCoordinationV1Lease(); // IoK8sApiCoordinationV1Lease | 
...
try {
    final result = api_instance.createCoordinationV1NamespacedLease(namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.deleteCoordinationV1CollectionNamespacedLease(namespace, pretty, continue_, dryRun, fieldSelector, gracePeriodSeconds, labelSelector, limit, orphanDependents, propagationPolicy, resourceVersion, resourceVersionMatch, timeoutSeconds, body);
    print(result);
} catch (e) {
...
final api_instance = CoordinationV1Api();
final name = name_example; // String | name of the Lease
final namespace = namespace_example; // String | object name and auth scope, such as for teams and projects
final pretty = pretty_example; // String | If 'true', then the output is pretty printed.
final dryRun = dryRun_example; // String | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed
final gracePeriodSeconds = 56; // int | The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately.
...
try {
    final result = api_instance.deleteCoordinationV1NamespacedLease(name, namespace, pretty, dryRun, gracePeriodSeconds, orphanDependents, propagationPolicy, body);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.getCoordinationV1APIResources();
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listCoordinationV1LeaseForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.listCoordinationV1NamespacedLease(namespace, pretty, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.patchCoordinationV1NamespacedLease(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.readCoordinationV1NamespacedLease(name, namespace, pretty);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.replaceCoordinationV1NamespacedLease(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchCoordinationV1LeaseListForAllNamespaces(allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchCoordinationV1NamespacedLease(name, namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
...
try {
    final result = api_instance.watchCoordinationV1NamespacedLeaseList(namespace, allowWatchBookmarks, continue_, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
    print(result);
} catch (e) {
