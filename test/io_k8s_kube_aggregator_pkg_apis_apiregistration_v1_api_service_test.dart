...
// tests for IoK8sKubeAggregatorPkgApisApiregistrationV1APIService
void main() {
  final instance = IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sKubeAggregatorPkgApisApiregistrationV1APIService, () {
