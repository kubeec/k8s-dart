...
void main() {
  // final instance = IoK8sApiPolicyV1PodDisruptionBudgetStatus();

  group('test IoK8sApiPolicyV1PodDisruptionBudgetStatus', () {
    ...
    // List<IoK8sApimachineryPkgApisMetaV1Condition> conditions (default value: const [])
    ...
    // Map<String, DateTime> disruptedPods (default value: const {})
