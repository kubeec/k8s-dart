...
// tests for IoK8sApiCoreV1FlexPersistentVolumeSource
void main() {
  final instance = IoK8sApiCoreV1FlexPersistentVolumeSourceBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiCoreV1FlexPersistentVolumeSource, () {
