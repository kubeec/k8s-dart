...
void main() {
  final instance = IoK8sApiCertificatesV1CertificateSigningRequestSpecBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiCertificatesV1CertificateSigningRequestSpec, () {
