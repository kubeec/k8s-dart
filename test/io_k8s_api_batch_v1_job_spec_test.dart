...
// tests for IoK8sApiBatchV1JobSpec
void main() {
  final instance = IoK8sApiBatchV1JobSpecBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiBatchV1JobSpec, () {
    ...
    // int backoffLimit
    test('to test the property `backoffLimit`', () async {
      // TODO
    });
    ...
    test('to test the property `completionMode`', () async {
      // TODO
    });
    ...
    // bool manualSelector
    test('to test the property `manualSelector`', () async {
      // TODO
    });
    ...
    test('to test the property `podFailurePolicy`', () async {
      // TODO
    });
    ...
    test('to test the property `ttlSecondsAfterFinished`', () async {
      // TODO
    });
