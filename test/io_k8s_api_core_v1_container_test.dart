...
void main() {
  ...
  group(IoK8sApiCoreV1Container, () {
    ...
    // BuiltList<IoK8sApiCoreV1ContainerPort> ports
    ...
    // BuiltList<IoK8sApiCoreV1VolumeDevice> volumeDevices
    test('to test the property `volumeDevices`', () async {
      // TODO
    });

    // Pod volumes to mount into the container's filesystem. Cannot be updated.
    // BuiltList<IoK8sApiCoreV1VolumeMount> volumeMounts
