...
// tests for IoK8sApiCoreV1ISCSIPersistentVolumeSource
void main() {
  // final instance = IoK8sApiCoreV1ISCSIPersistentVolumeSource();

  group('test IoK8sApiCoreV1ISCSIPersistentVolumeSource', () {
    ...
    // List<String> portals (default value: const [])
