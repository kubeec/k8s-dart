...
// tests for IoK8sApiFlowcontrolV1beta3PriorityLevelConfiguration
void main() {
  final instance = IoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiFlowcontrolV1beta3PriorityLevelConfiguration, () {
