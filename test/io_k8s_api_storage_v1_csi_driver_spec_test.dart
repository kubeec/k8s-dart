...
// tests for IoK8sApiStorageV1CSIDriverSpec
void main() {
  // final instance = IoK8sApiStorageV1CSIDriverSpec();

  group('test IoK8sApiStorageV1CSIDriverSpec', () {
    ...
    // bool attachRequired
    test('to test the property `attachRequired`', () async {
      // TODO
    });
    ...
    test('to test the property `fsGroupPolicy`', () async {
      // TODO
    });
    ...
    // bool podInfoOnMount
    test('to test the property `podInfoOnMount`', () async {
      // TODO
    });
    ...
    test('to test the property `requiresRepublish`', () async {
      // TODO
    });
    ...
    // bool seLinuxMount
    test('to test the property `seLinuxMount`', () async {
      // TODO
    });
    ...
    test('to test the property `storageCapacity`', () async {
      // TODO
    });
    ...
    // List<IoK8sApiStorageV1TokenRequest> tokenRequests (default value: const [])
    test('to test the property `tokenRequests`', () async {
      // TODO
    });
    ...
    // List<String> volumeLifecycleModes (default value: const [])
    test('to test the property `volumeLifecycleModes`', () async {
      // TODO
    });
