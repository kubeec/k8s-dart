...
// tests for IoK8sApiFlowcontrolV1beta3ResourcePolicyRule
void main() {
  final instance = IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiFlowcontrolV1beta3ResourcePolicyRule, () {
