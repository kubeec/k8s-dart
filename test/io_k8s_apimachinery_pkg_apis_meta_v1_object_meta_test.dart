...
void main() {
  final instance = IoK8sApimachineryPkgApisMetaV1ObjectMetaBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApimachineryPkgApisMetaV1ObjectMeta, () {
    // Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata. They are not queryable and should be preserved when modifying objects. More info: http://kubernetes.io/docs/user-guide/annotations
    // BuiltMap<String, String> annotations
    ...
    // BuiltList<IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry> managedFields
    ...
    // BuiltList<IoK8sApimachineryPkgApisMetaV1OwnerReference> ownerReferences
