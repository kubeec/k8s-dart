...
void main() {
  // final instance = IoK8sApiCoreV1PodStatus();

  group('test IoK8sApiCoreV1PodStatus', () {
    // Current service state of pod. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions
    // List<IoK8sApiCoreV1PodCondition> conditions (default value: const [])
    test('to test the property `conditions`', () async {
      // TODO
    });

    // The list has one entry per container in the manifest. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
    // List<IoK8sApiCoreV1ContainerStatus> containerStatuses (default value: const [])
    test('to test the property `containerStatuses`', () async {
      // TODO
    });

    // Status for any ephemeral containers that have run in this pod.
    // List<IoK8sApiCoreV1ContainerStatus> ephemeralContainerStatuses (default value: const [])
    ...
    // List<IoK8sApiCoreV1ContainerStatus> initContainerStatuses (default value: const [])
    ...
    // List<IoK8sApiCoreV1PodIP> podIPs (default value: const [])
