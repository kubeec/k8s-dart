...
void main() {
  // final instance = IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionNames();

  group('test IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionNames', () {
    ...
    // List<String> shortNames (default value: const [])
