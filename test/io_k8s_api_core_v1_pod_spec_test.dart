...
void main() {
  final instance = IoK8sApiCoreV1PodSpecBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiCoreV1PodSpec, () {
    ...
    // BuiltList<IoK8sApiCoreV1Container> containers
    ...
    // BuiltList<IoK8sApiCoreV1EphemeralContainer> ephemeralContainers
    test('to test the property `ephemeralContainers`', () async {
      // TODO
    });

    // HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified. This is only valid for non-hostNetwork pods.
    // BuiltList<IoK8sApiCoreV1HostAlias> hostAliases
    ...
    // BuiltList<IoK8sApiCoreV1Container> initContainers
    ...
    // BuiltMap<String, String> overhead
    ...
    // BuiltList<IoK8sApiCoreV1PodReadinessGate> readinessGates
    test('to test the property `readinessGates`', () async {
      // TODO
    });

    // ResourceClaims defines which ResourceClaims must be allocated and reserved before the Pod is allowed to start. The resources will be made available to those containers which consume them by name.  This is an alpha field and requires enabling the DynamicResourceAllocation feature gate.  This field is immutable.
    // BuiltList<IoK8sApiCoreV1PodResourceClaim> resourceClaims
    ...
    // BuiltList<IoK8sApiCoreV1PodSchedulingGate> schedulingGates
    ...
    // BuiltList<IoK8sApiCoreV1TopologySpreadConstraint> topologySpreadConstraints
    test('to test the property `topologySpreadConstraints`', () async {
      // TODO
    });

    // List of volumes that can be mounted by containers belonging to the pod. More info: https://kubernetes.io/docs/concepts/storage/volumes
    // BuiltList<IoK8sApiCoreV1Volume> volumes
