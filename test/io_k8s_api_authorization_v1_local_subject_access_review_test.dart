...
// tests for IoK8sApiAuthorizationV1LocalSubjectAccessReview
void main() {
  final instance = IoK8sApiAuthorizationV1LocalSubjectAccessReviewBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiAuthorizationV1LocalSubjectAccessReview, () {
