...
// tests for IoK8sApiAuthorizationV1SelfSubjectAccessReview
void main() {
  final instance = IoK8sApiAuthorizationV1SelfSubjectAccessReviewBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiAuthorizationV1SelfSubjectAccessReview, () {
