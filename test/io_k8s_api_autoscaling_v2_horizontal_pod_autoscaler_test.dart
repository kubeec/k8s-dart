...
// tests for IoK8sApiAutoscalingV2HorizontalPodAutoscaler
void main() {
  final instance = IoK8sApiAutoscalingV2HorizontalPodAutoscalerBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiAutoscalingV2HorizontalPodAutoscaler, () {
