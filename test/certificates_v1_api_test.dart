...
/// tests for CertificatesV1Api
void main() {
  final instance = K8s().getCertificatesV1Api();

  group(CertificatesV1Api, () {
    ...
    test('test createCertificatesV1CertificateSigningRequest', () async {
      // TODO
    });
    ...
    test('test deleteCertificatesV1CertificateSigningRequest', () async {
      // TODO
    });
    ...
    test('test deleteCertificatesV1CollectionCertificateSigningRequest', () async {
      // TODO
    });
    ...
    test('test getCertificatesV1APIResources', () async {
      // TODO
    });
    ...
    test('test listCertificatesV1CertificateSigningRequest', () async {
      // TODO
    });

    // partially update the specified CertificateSigningRequest
    //
    //Future<IoK8sApiCertificatesV1CertificateSigningRequest> patchCertificatesV1CertificateSigningRequest(String name, JsonObject body, { String pretty, String dryRun, String fieldManager, String fieldValidation, bool force }) async
    test('test patchCertificatesV1CertificateSigningRequest', () async {
      // TODO
    });

    // partially update approval of the specified CertificateSigningRequest
    //
    //Future<IoK8sApiCertificatesV1CertificateSigningRequest> patchCertificatesV1CertificateSigningRequestApproval(String name, JsonObject body, { String pretty, String dryRun, String fieldManager, String fieldValidation, bool force }) async
    test('test patchCertificatesV1CertificateSigningRequestApproval', () async {
      // TODO
    });

    // partially update status of the specified CertificateSigningRequest
    //
    //Future<IoK8sApiCertificatesV1CertificateSigningRequest> patchCertificatesV1CertificateSigningRequestStatus(String name, JsonObject body, { String pretty, String dryRun, String fieldManager, String fieldValidation, bool force }) async
    test('test patchCertificatesV1CertificateSigningRequestStatus', () async {
      // TODO
    });
    ...
    test('test readCertificatesV1CertificateSigningRequest', () async {
      // TODO
    });
    ...
    test('test readCertificatesV1CertificateSigningRequestApproval', () async {
      // TODO
    });
    ...
    test('test readCertificatesV1CertificateSigningRequestStatus', () async {
      // TODO
    });
    ...
    test('test replaceCertificatesV1CertificateSigningRequest', () async {
      // TODO
    });
    ...
    test('test replaceCertificatesV1CertificateSigningRequestApproval', () async {
      // TODO
    });
    ...
    test('test replaceCertificatesV1CertificateSigningRequestStatus', () async {
      // TODO
    });
    ...
    test('test watchCertificatesV1CertificateSigningRequest', () async {
      // TODO
    });
    ...
    test('test watchCertificatesV1CertificateSigningRequestList', () async {
      // TODO
    });
