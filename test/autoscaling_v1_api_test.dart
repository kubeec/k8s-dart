...
void main() {
  final instance = K8s().getAutoscalingV1Api();

  group(AutoscalingV1Api, () {
    ...
    //
    //Future<IoK8sApiAutoscalingV1HorizontalPodAutoscaler> patchAutoscalingV1NamespacedHorizontalPodAutoscaler(String name, String namespace, JsonObject body, { String pretty, String dryRun, String fieldManager, String fieldValidation, bool force }) async
    ...
    //
    //Future<IoK8sApiAutoscalingV1HorizontalPodAutoscaler> patchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus(String name, String namespace, JsonObject body, { String pretty, String dryRun, String fieldManager, String fieldValidation, bool force }) async
