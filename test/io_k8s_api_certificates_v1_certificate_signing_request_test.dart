...
// tests for IoK8sApiCertificatesV1CertificateSigningRequest
void main() {
  final instance = IoK8sApiCertificatesV1CertificateSigningRequestBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiCertificatesV1CertificateSigningRequest, () {
