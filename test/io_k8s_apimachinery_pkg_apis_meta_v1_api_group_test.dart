...
void main() {
  final instance = IoK8sApimachineryPkgApisMetaV1APIGroupBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApimachineryPkgApisMetaV1APIGroup, () {
    ...
    // BuiltList<IoK8sApimachineryPkgApisMetaV1GroupVersionForDiscovery> versions
