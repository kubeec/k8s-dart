...
// tests for IoK8sApiFlowcontrolV1beta3LimitedPriorityLevelConfiguration
void main() {
  final instance = IoK8sApiFlowcontrolV1beta3LimitedPriorityLevelConfigurationBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiFlowcontrolV1beta3LimitedPriorityLevelConfiguration, () {
    ...
    test('to test the property `nominalConcurrencyShares`', () async {
      // TODO
    });
