...
void main() {
  final instance = K8s().getAutoscalingV2Api();

  group(AutoscalingV2Api, () {
    ...
    //
    //Future<IoK8sApiAutoscalingV2HorizontalPodAutoscaler> patchAutoscalingV2NamespacedHorizontalPodAutoscaler(String name, String namespace, JsonObject body, { String pretty, String dryRun, String fieldManager, String fieldValidation, bool force }) async
    ...
    //
    //Future<IoK8sApiAutoscalingV2HorizontalPodAutoscaler> patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus(String name, String namespace, JsonObject body, { String pretty, String dryRun, String fieldManager, String fieldValidation, bool force }) async
