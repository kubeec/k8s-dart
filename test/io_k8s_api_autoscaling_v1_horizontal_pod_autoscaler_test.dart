...
// tests for IoK8sApiAutoscalingV1HorizontalPodAutoscaler
void main() {
  final instance = IoK8sApiAutoscalingV1HorizontalPodAutoscalerBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiAutoscalingV1HorizontalPodAutoscaler, () {
