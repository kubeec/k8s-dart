...
// tests for IoK8sApiFlowcontrolV1beta2NonResourcePolicyRule
void main() {
  final instance = IoK8sApiFlowcontrolV1beta2NonResourcePolicyRuleBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiFlowcontrolV1beta2NonResourcePolicyRule, () {
