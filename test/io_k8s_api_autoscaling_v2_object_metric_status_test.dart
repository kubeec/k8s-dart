...
// tests for IoK8sApiAutoscalingV2ObjectMetricStatus
void main() {
  // final instance = IoK8sApiAutoscalingV2ObjectMetricStatus();

  group('test IoK8sApiAutoscalingV2ObjectMetricStatus', () {
