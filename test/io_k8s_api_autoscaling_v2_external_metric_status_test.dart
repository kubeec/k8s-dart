...
// tests for IoK8sApiAutoscalingV2ExternalMetricStatus
void main() {
  // final instance = IoK8sApiAutoscalingV2ExternalMetricStatus();

  group('test IoK8sApiAutoscalingV2ExternalMetricStatus', () {
