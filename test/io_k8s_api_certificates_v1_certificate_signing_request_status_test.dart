...
void main() {
  final instance = IoK8sApiCertificatesV1CertificateSigningRequestStatusBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiCertificatesV1CertificateSigningRequestStatus, () {
    ...
    // BuiltList<IoK8sApiCertificatesV1CertificateSigningRequestCondition> conditions
