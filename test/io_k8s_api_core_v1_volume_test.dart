...
// tests for IoK8sApiCoreV1Volume
void main() {
  final instance = IoK8sApiCoreV1VolumeBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiCoreV1Volume, () {
    ...
    test('to test the property `configMap`', () async {
      // TODO
    });
    ...
    test('to test the property `downwardAPI`', () async {
      // TODO
    });

    // IoK8sApiCoreV1EmptyDirVolumeSource emptyDir
    test('to test the property `emptyDir`', () async {
      // TODO
    });
    ...
    test('to test the property `gitRepo`', () async {
      // TODO
    });
    ...
    test('to test the property `persistentVolumeClaim`', () async {
      // TODO
    });
    ...
    test('to test the property `projected`', () async {
      // TODO
    });
