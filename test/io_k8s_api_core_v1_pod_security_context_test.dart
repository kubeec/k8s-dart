...
void main() {
  final instance = IoK8sApiCoreV1PodSecurityContextBuilder();
  // TODO add properties to the builder and call build()

  group(IoK8sApiCoreV1PodSecurityContext, () {
