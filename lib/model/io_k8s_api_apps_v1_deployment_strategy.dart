...
class IoK8sApiAppsV1DeploymentStrategy {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1DeploymentStrategy &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1DeploymentStrategy[rollingUpdate=$rollingUpdate, type=$type]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1DeploymentStrategy[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1DeploymentStrategy[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiAppsV1DeploymentStrategy(
        rollingUpdate: IoK8sApiAppsV1RollingUpdateDeployment.fromJson(json[r'rollingUpdate']),
  ...
  static List<IoK8sApiAppsV1DeploymentStrategy>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAppsV1DeploymentStrategy> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiAppsV1DeploymentStrategy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1DeploymentStrategy>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1DeploymentStrategy.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
