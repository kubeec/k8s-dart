...
class IoK8sApiAuthenticationV1UserInfo {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAuthenticationV1UserInfo &&
     other.extra == extra &&
     other.groups == groups &&
     other.uid == uid &&
  ...
  @override
  String toString() => 'IoK8sApiAuthenticationV1UserInfo[extra=$extra, groups=$groups, uid=$uid, username=$username]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAuthenticationV1UserInfo[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAuthenticationV1UserInfo[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAuthenticationV1UserInfo>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAuthenticationV1UserInfo> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiAuthenticationV1UserInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAuthenticationV1UserInfo>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthenticationV1UserInfo.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
