...
class IoK8sApiCoreV1EphemeralContainer {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EphemeralContainer &&
     other.args == args &&
  ...
  int get hashCode =>
    ...
    (terminationMessagePolicy == null ? 0 : terminationMessagePolicy!.hashCode) +
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1EphemeralContainer[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1EphemeralContainer[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1EphemeralContainer(
        ...
        envFrom: IoK8sApiCoreV1EnvFromSource.listFromJson(json[r'envFrom']) ?? const [],
        ...
        ports: IoK8sApiCoreV1ContainerPort.listFromJson(json[r'ports']) ?? const [],
        readinessProbe: IoK8sApiCoreV1Probe.fromJson(json[r'readinessProbe']),
        resources: IoK8sApiCoreV1ResourceRequirements.fromJson(json[r'resources']),
        securityContext: IoK8sApiCoreV1SecurityContext.fromJson(json[r'securityContext']),
        ...
        targetContainerName: mapValueOfType<String>(json, r'targetContainerName'),
        terminationMessagePath: mapValueOfType<String>(json, r'terminationMessagePath'),
        terminationMessagePolicy: mapValueOfType<String>(json, r'terminationMessagePolicy'),
        tty: mapValueOfType<bool>(json, r'tty'),
        volumeDevices: IoK8sApiCoreV1VolumeDevice.listFromJson(json[r'volumeDevices']) ?? const [],
        volumeMounts: IoK8sApiCoreV1VolumeMount.listFromJson(json[r'volumeMounts']) ?? const [],
  ...
  static List<IoK8sApiCoreV1EphemeralContainer>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1EphemeralContainer> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1EphemeralContainer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1EphemeralContainer>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1EphemeralContainer.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
