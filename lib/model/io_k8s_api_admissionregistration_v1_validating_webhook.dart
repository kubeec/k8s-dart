...
class IoK8sApiAdmissionregistrationV1ValidatingWebhook {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAdmissionregistrationV1ValidatingWebhook &&
  ...
  static IoK8sApiAdmissionregistrationV1ValidatingWebhook? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAdmissionregistrationV1ValidatingWebhook[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAdmissionregistrationV1ValidatingWebhook[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAdmissionregistrationV1ValidatingWebhook(
        admissionReviewVersions: json[r'admissionReviewVersions'] is List
            ...
            : const [],
        clientConfig: IoK8sApiAdmissionregistrationV1WebhookClientConfig.fromJson(json[r'clientConfig'])!,
        ...
        rules: IoK8sApiAdmissionregistrationV1RuleWithOperations.listFromJson(json[r'rules']) ?? const [],
  ...
  static List<IoK8sApiAdmissionregistrationV1ValidatingWebhook>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApiAdmissionregistrationV1ValidatingWebhook>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiAdmissionregistrationV1ValidatingWebhook.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiAdmissionregistrationV1ValidatingWebhook> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAdmissionregistrationV1ValidatingWebhook>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAdmissionregistrationV1ValidatingWebhook.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAdmissionregistrationV1ValidatingWebhook>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAdmissionregistrationV1ValidatingWebhook>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAdmissionregistrationV1ValidatingWebhook.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
