...
class IoK8sApiCoreV1LimitRangeItem {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1LimitRangeItem &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1LimitRangeItem[default_=$default_, defaultRequest=$defaultRequest, max=$max, maxLimitRequestRatio=$maxLimitRequestRatio, min=$min, type=$type]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1LimitRangeItem[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1LimitRangeItem[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1LimitRangeItem(
        ...
        defaultRequest: mapCastOfType<String, String>(json, r'defaultRequest') ?? const {},
        max: mapCastOfType<String, String>(json, r'max') ?? const {},
        maxLimitRequestRatio: mapCastOfType<String, String>(json, r'maxLimitRequestRatio') ?? const {},
  ...
  static List<IoK8sApiCoreV1LimitRangeItem>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1LimitRangeItem>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1LimitRangeItem>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1LimitRangeItem.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
