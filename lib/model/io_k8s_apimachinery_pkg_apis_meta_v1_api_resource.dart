...
class IoK8sApimachineryPkgApisMetaV1APIResource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1APIResource &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgApisMetaV1APIResource[categories=$categories, group=$group, kind=$kind, name=$name, namespaced=$namespaced, shortNames=$shortNames, singularName=$singularName, storageVersionHash=$storageVersionHash, verbs=$verbs, version=$version]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1APIResource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1APIResource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApimachineryPkgApisMetaV1APIResource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1APIResource> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1APIResource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1APIResource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1APIResource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1APIResource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1APIResource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
