...
class IoK8sApiCoreV1DownwardAPIVolumeFile {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1DownwardAPIVolumeFile &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1DownwardAPIVolumeFile[fieldRef=$fieldRef, mode=$mode, path=$path, resourceFieldRef=$resourceFieldRef]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1DownwardAPIVolumeFile[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1DownwardAPIVolumeFile[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1DownwardAPIVolumeFile>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1DownwardAPIVolumeFile> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1DownwardAPIVolumeFile>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1DownwardAPIVolumeFile>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1DownwardAPIVolumeFile.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
