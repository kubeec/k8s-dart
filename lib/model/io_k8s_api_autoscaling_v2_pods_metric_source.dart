...
class IoK8sApiAutoscalingV2PodsMetricSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAutoscalingV2PodsMetricSource &&
     other.metric == metric &&
     other.target == target;
  ...
  @override
  String toString() => 'IoK8sApiAutoscalingV2PodsMetricSource[metric=$metric, target=$target]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAutoscalingV2PodsMetricSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAutoscalingV2PodsMetricSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAutoscalingV2PodsMetricSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAutoscalingV2PodsMetricSource> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAutoscalingV2PodsMetricSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV2PodsMetricSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAutoscalingV2PodsMetricSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAutoscalingV2PodsMetricSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV2PodsMetricSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
