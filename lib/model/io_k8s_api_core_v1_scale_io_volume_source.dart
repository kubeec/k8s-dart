...
class IoK8sApiCoreV1ScaleIOVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ScaleIOVolumeSource &&
     other.fsType == fsType &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ScaleIOVolumeSource[fsType=$fsType, gateway=$gateway, protectionDomain=$protectionDomain, readOnly=$readOnly, secretRef=$secretRef, sslEnabled=$sslEnabled, storageMode=$storageMode, storagePool=$storagePool, system=$system, volumeName=$volumeName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ScaleIOVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ScaleIOVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1ScaleIOVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1ScaleIOVolumeSource> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1ScaleIOVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ScaleIOVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ScaleIOVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
