...
class IoK8sApiAuthenticationV1TokenReviewStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAuthenticationV1TokenReviewStatus &&
  ...
  @override
  String toString() => 'IoK8sApiAuthenticationV1TokenReviewStatus[audiences=$audiences, authenticated=$authenticated, error=$error, user=$user]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAuthenticationV1TokenReviewStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAuthenticationV1TokenReviewStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAuthenticationV1TokenReviewStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAuthenticationV1TokenReviewStatus> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAuthenticationV1TokenReviewStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthenticationV1TokenReviewStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAuthenticationV1TokenReviewStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAuthenticationV1TokenReviewStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthenticationV1TokenReviewStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
