...
class IoK8sApiCoreV1EmptyDirVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EmptyDirVolumeSource &&
     other.medium == medium &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1EmptyDirVolumeSource[medium=$medium, sizeLimit=$sizeLimit]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.sizeLimit != null) {
      json[r'sizeLimit'] = this.sizeLimit;
    } else {
      json[r'sizeLimit'] = null;
    }
    return json;
  }
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1EmptyDirVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1EmptyDirVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1EmptyDirVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1EmptyDirVolumeSource> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1EmptyDirVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1EmptyDirVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1EmptyDirVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
