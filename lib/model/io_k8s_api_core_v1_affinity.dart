...
class IoK8sApiCoreV1Affinity {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1Affinity &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1Affinity[nodeAffinity=$nodeAffinity, podAffinity=$podAffinity, podAntiAffinity=$podAntiAffinity]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1Affinity[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1Affinity[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1Affinity(
        nodeAffinity: IoK8sApiCoreV1NodeAffinity.fromJson(json[r'nodeAffinity']),
        podAffinity: IoK8sApiCoreV1PodAffinity.fromJson(json[r'podAffinity']),
        podAntiAffinity: IoK8sApiCoreV1PodAntiAffinity.fromJson(json[r'podAntiAffinity']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1Affinity>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1Affinity>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1Affinity>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1Affinity.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
