...
class IoK8sApimachineryPkgApisMetaV1APIVersions {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1APIVersions &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgApisMetaV1APIVersions[apiVersion=$apiVersion, kind=$kind, serverAddressByClientCIDRs=$serverAddressByClientCIDRs, versions=$versions]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1APIVersions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1APIVersions[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApimachineryPkgApisMetaV1APIVersions(
        ...
        serverAddressByClientCIDRs: IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR.listFromJson(json[r'serverAddressByClientCIDRs'])!,
  ...
  static List<IoK8sApimachineryPkgApisMetaV1APIVersions>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1APIVersions> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1APIVersions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1APIVersions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1APIVersions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1APIVersions>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1APIVersions.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
