...
class IoK8sApiStorageV1VolumeAttachmentSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1VolumeAttachmentSource &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1VolumeAttachmentSource[inlineVolumeSpec=$inlineVolumeSpec, persistentVolumeName=$persistentVolumeName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1VolumeAttachmentSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1VolumeAttachmentSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiStorageV1VolumeAttachmentSource(
        inlineVolumeSpec: IoK8sApiCoreV1PersistentVolumeSpec.fromJson(json[r'inlineVolumeSpec']),
        persistentVolumeName: mapValueOfType<String>(json, r'persistentVolumeName'),
      );
    }
    return null;
  }

  static List<IoK8sApiStorageV1VolumeAttachmentSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiStorageV1VolumeAttachmentSource> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiStorageV1VolumeAttachmentSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1VolumeAttachmentSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiStorageV1VolumeAttachmentSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1VolumeAttachmentSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1VolumeAttachmentSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
