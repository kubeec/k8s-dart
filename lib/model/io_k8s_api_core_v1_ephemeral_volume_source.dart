...
class IoK8sApiCoreV1EphemeralVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EphemeralVolumeSource &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1EphemeralVolumeSource[volumeClaimTemplate=$volumeClaimTemplate]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.volumeClaimTemplate != null) {
      json[r'volumeClaimTemplate'] = this.volumeClaimTemplate;
    } else {
      json[r'volumeClaimTemplate'] = null;
    }
    return json;
  }
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1EphemeralVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1EphemeralVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1EphemeralVolumeSource(
        volumeClaimTemplate: IoK8sApiCoreV1PersistentVolumeClaimTemplate.fromJson(json[r'volumeClaimTemplate']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1EphemeralVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1EphemeralVolumeSource> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1EphemeralVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1EphemeralVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1EphemeralVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
