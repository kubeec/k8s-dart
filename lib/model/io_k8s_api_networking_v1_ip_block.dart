...
class IoK8sApiNetworkingV1IPBlock {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1IPBlock &&
     other.cidr == cidr &&
     other.except == except;
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1IPBlock[cidr=$cidr, except=$except]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'cidr'] = this.cidr;
      json[r'except'] = this.except;
    return json;
  }
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1IPBlock[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1IPBlock[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiNetworkingV1IPBlock>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiNetworkingV1IPBlock>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1IPBlock>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1IPBlock.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
