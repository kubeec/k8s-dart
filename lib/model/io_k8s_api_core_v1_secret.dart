...
class IoK8sApiCoreV1Secret {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1Secret &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1Secret[apiVersion=$apiVersion, data=$data, immutable=$immutable, kind=$kind, metadata=$metadata, stringData=$stringData, type=$type]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.metadata != null) {
      ...
      json[r'stringData'] = this.stringData;
    if (this.type != null) {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1Secret[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1Secret[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1Secret(
        ...
        stringData: mapCastOfType<String, String>(json, r'stringData') ?? const {},
  ...
  static List<IoK8sApiCoreV1Secret>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1Secret>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1Secret>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1Secret.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
