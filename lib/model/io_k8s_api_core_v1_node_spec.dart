...
class IoK8sApiCoreV1NodeSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeSpec &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1NodeSpec[configSource=$configSource, externalID=$externalID, podCIDR=$podCIDR, podCIDRs=$podCIDRs, providerID=$providerID, taints=$taints, unschedulable=$unschedulable]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1NodeSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1NodeSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1NodeSpec(
        configSource: IoK8sApiCoreV1NodeConfigSource.fromJson(json[r'configSource']),
  ...
  static List<IoK8sApiCoreV1NodeSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1NodeSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1NodeSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1NodeSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
