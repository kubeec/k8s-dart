...
class IoK8sApiStorageV1TokenRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1TokenRequest &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1TokenRequest[audience=$audience, expirationSeconds=$expirationSeconds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1TokenRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1TokenRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiStorageV1TokenRequest>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiStorageV1TokenRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1TokenRequest>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1TokenRequest.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
