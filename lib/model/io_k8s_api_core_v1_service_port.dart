...
class IoK8sApiCoreV1ServicePort {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ServicePort &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ServicePort[appProtocol=$appProtocol, name=$name, nodePort=$nodePort, port=$port, protocol=$protocol, targetPort=$targetPort]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ServicePort[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ServicePort[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1ServicePort(
        ...
        targetPort: mapValueOfType<String>(json, r'targetPort'),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1ServicePort>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1ServicePort>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ServicePort>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ServicePort.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
