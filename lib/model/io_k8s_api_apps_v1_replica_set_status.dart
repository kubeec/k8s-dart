...
class IoK8sApiAppsV1ReplicaSetStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1ReplicaSetStatus &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1ReplicaSetStatus[availableReplicas=$availableReplicas, conditions=$conditions, fullyLabeledReplicas=$fullyLabeledReplicas, observedGeneration=$observedGeneration, readyReplicas=$readyReplicas, replicas=$replicas]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1ReplicaSetStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1ReplicaSetStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAppsV1ReplicaSetStatus(
        ...
        conditions: IoK8sApiAppsV1ReplicaSetCondition.listFromJson(json[r'conditions']) ?? const [],
  ...
  static List<IoK8sApiAppsV1ReplicaSetStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiAppsV1ReplicaSetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1ReplicaSetStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1ReplicaSetStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
