...
class IoK8sApiDiscoveryV1EndpointSlice {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiDiscoveryV1EndpointSlice &&
  ...
  @override
  String toString() => 'IoK8sApiDiscoveryV1EndpointSlice[addressType=$addressType, apiVersion=$apiVersion, endpoints=$endpoints, kind=$kind, metadata=$metadata, ports=$ports]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiDiscoveryV1EndpointSlice[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiDiscoveryV1EndpointSlice[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiDiscoveryV1EndpointSlice(
        ...
        endpoints: IoK8sApiDiscoveryV1Endpoint.listFromJson(json[r'endpoints'])!,
        kind: mapValueOfType<String>(json, r'kind'),
        metadata: IoK8sApimachineryPkgApisMetaV1ObjectMeta.fromJson(json[r'metadata']),
        ports: IoK8sApiDiscoveryV1EndpointPort.listFromJson(json[r'ports']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiDiscoveryV1EndpointSlice>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiDiscoveryV1EndpointSlice> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiDiscoveryV1EndpointSlice>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiDiscoveryV1EndpointSlice>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiDiscoveryV1EndpointSlice.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
