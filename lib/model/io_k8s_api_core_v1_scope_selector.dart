...
class IoK8sApiCoreV1ScopeSelector {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ScopeSelector &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ScopeSelector[matchExpressions=$matchExpressions]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ScopeSelector[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ScopeSelector[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1ScopeSelector(
        matchExpressions: IoK8sApiCoreV1ScopedResourceSelectorRequirement.listFromJson(json[r'matchExpressions']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1ScopeSelector>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1ScopeSelector>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ScopeSelector>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ScopeSelector.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
