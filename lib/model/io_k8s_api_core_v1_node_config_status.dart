...
class IoK8sApiCoreV1NodeConfigStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeConfigStatus &&
     other.active == active &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1NodeConfigStatus[active=$active, assigned=$assigned, error=$error, lastKnownGood=$lastKnownGood]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1NodeConfigStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1NodeConfigStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1NodeConfigStatus(
        ...
        lastKnownGood: IoK8sApiCoreV1NodeConfigSource.fromJson(json[r'lastKnownGood']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1NodeConfigStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1NodeConfigStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1NodeConfigStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1NodeConfigStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
