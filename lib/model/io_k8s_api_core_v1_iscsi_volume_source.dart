...
class IoK8sApiCoreV1ISCSIVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ISCSIVolumeSource &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ISCSIVolumeSource[chapAuthDiscovery=$chapAuthDiscovery, chapAuthSession=$chapAuthSession, fsType=$fsType, initiatorName=$initiatorName, iqn=$iqn, iscsiInterface=$iscsiInterface, lun=$lun, portals=$portals, readOnly=$readOnly, secretRef=$secretRef, targetPortal=$targetPortal]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ISCSIVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ISCSIVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1ISCSIVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1ISCSIVolumeSource> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1ISCSIVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ISCSIVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ISCSIVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
