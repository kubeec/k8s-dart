...
class IoK8sApiCoreV1NodeStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeStatus &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1NodeStatus[addresses=$addresses, allocatable=$allocatable, capacity=$capacity, conditions=$conditions, config=$config, daemonEndpoints=$daemonEndpoints, images=$images, nodeInfo=$nodeInfo, phase=$phase, volumesAttached=$volumesAttached, volumesInUse=$volumesInUse]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1NodeStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1NodeStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1NodeStatus(
        addresses: IoK8sApiCoreV1NodeAddress.listFromJson(json[r'addresses']) ?? const [],
        allocatable: mapCastOfType<String, String>(json, r'allocatable') ?? const {},
        capacity: mapCastOfType<String, String>(json, r'capacity') ?? const {},
        conditions: IoK8sApiCoreV1NodeCondition.listFromJson(json[r'conditions']) ?? const [],
        config: IoK8sApiCoreV1NodeConfigStatus.fromJson(json[r'config']),
        daemonEndpoints: IoK8sApiCoreV1NodeDaemonEndpoints.fromJson(json[r'daemonEndpoints']),
        images: IoK8sApiCoreV1ContainerImage.listFromJson(json[r'images']) ?? const [],
        nodeInfo: IoK8sApiCoreV1NodeSystemInfo.fromJson(json[r'nodeInfo']),
        phase: mapValueOfType<String>(json, r'phase'),
        volumesAttached: IoK8sApiCoreV1AttachedVolume.listFromJson(json[r'volumesAttached']) ?? const [],
  ...
  static List<IoK8sApiCoreV1NodeStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1NodeStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1NodeStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1NodeStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
