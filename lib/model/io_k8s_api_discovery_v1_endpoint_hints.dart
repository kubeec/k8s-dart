...
class IoK8sApiDiscoveryV1EndpointHints {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiDiscoveryV1EndpointHints &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiDiscoveryV1EndpointHints[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiDiscoveryV1EndpointHints[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiDiscoveryV1EndpointHints(
        forZones: IoK8sApiDiscoveryV1ForZone.listFromJson(json[r'forZones']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiDiscoveryV1EndpointHints>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiDiscoveryV1EndpointHints> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiDiscoveryV1EndpointHints>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiDiscoveryV1EndpointHints>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiDiscoveryV1EndpointHints.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
