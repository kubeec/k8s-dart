...
class IoK8sApiBatchV1JobStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1JobStatus &&
     other.active == active &&
  ...
  @override
  String toString() => 'IoK8sApiBatchV1JobStatus[active=$active, completedIndexes=$completedIndexes, completionTime=$completionTime, conditions=$conditions, failed=$failed, ready=$ready, startTime=$startTime, succeeded=$succeeded, uncountedTerminatedPods=$uncountedTerminatedPods]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiBatchV1JobStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiBatchV1JobStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiBatchV1JobStatus(
        ...
        conditions: IoK8sApiBatchV1JobCondition.listFromJson(json[r'conditions']) ?? const [],
        ...
        uncountedTerminatedPods: IoK8sApiBatchV1UncountedTerminatedPods.fromJson(json[r'uncountedTerminatedPods']),
      );
    }
    return null;
  }

  static List<IoK8sApiBatchV1JobStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiBatchV1JobStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiBatchV1JobStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1JobStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
