...
class IoK8sApiCoreV1PersistentVolumeClaimSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PersistentVolumeClaimSpec &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1PersistentVolumeClaimSpec[accessModes=$accessModes, dataSource=$dataSource, dataSourceRef=$dataSourceRef, resources=$resources, selector=$selector, storageClassName=$storageClassName, volumeMode=$volumeMode, volumeName=$volumeName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PersistentVolumeClaimSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PersistentVolumeClaimSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1PersistentVolumeClaimSpec(
        accessModes: json[r'accessModes'] is List
            ...
            : const [],
        dataSource: IoK8sApiCoreV1TypedLocalObjectReference.fromJson(json[r'dataSource']),
        dataSourceRef: IoK8sApiCoreV1TypedObjectReference.fromJson(json[r'dataSourceRef']),
  ...
  static List<IoK8sApiCoreV1PersistentVolumeClaimSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1PersistentVolumeClaimSpec> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1PersistentVolumeClaimSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PersistentVolumeClaimSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1PersistentVolumeClaimSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PersistentVolumeClaimSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PersistentVolumeClaimSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
