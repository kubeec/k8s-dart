...
class IoK8sApiAppsV1DeploymentStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1DeploymentStatus &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1DeploymentStatus[availableReplicas=$availableReplicas, collisionCount=$collisionCount, conditions=$conditions, observedGeneration=$observedGeneration, readyReplicas=$readyReplicas, replicas=$replicas, unavailableReplicas=$unavailableReplicas, updatedReplicas=$updatedReplicas]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1DeploymentStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1DeploymentStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAppsV1DeploymentStatus(
        ...
        conditions: IoK8sApiAppsV1DeploymentCondition.listFromJson(json[r'conditions']) ?? const [],
  ...
  static List<IoK8sApiAppsV1DeploymentStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiAppsV1DeploymentStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1DeploymentStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1DeploymentStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
