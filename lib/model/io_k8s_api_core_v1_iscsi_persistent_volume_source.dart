...
class IoK8sApiCoreV1ISCSIPersistentVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ISCSIPersistentVolumeSource &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ISCSIPersistentVolumeSource[chapAuthDiscovery=$chapAuthDiscovery, chapAuthSession=$chapAuthSession, fsType=$fsType, initiatorName=$initiatorName, iqn=$iqn, iscsiInterface=$iscsiInterface, lun=$lun, portals=$portals, readOnly=$readOnly, secretRef=$secretRef, targetPortal=$targetPortal]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ISCSIPersistentVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ISCSIPersistentVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1ISCSIPersistentVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1ISCSIPersistentVolumeSource> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1ISCSIPersistentVolumeSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ISCSIPersistentVolumeSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1ISCSIPersistentVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ISCSIPersistentVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ISCSIPersistentVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
