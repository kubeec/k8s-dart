...
class IoK8sApiAuthenticationV1TokenRequestSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAuthenticationV1TokenRequestSpec &&
  ...
  @override
  String toString() => 'IoK8sApiAuthenticationV1TokenRequestSpec[audiences=$audiences, boundObjectRef=$boundObjectRef, expirationSeconds=$expirationSeconds]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAuthenticationV1TokenRequestSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAuthenticationV1TokenRequestSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAuthenticationV1TokenRequestSpec(
        audiences: json[r'audiences'] is List
            ...
            : const [],
        boundObjectRef: IoK8sApiAuthenticationV1BoundObjectReference.fromJson(json[r'boundObjectRef']),
  ...
  static List<IoK8sApiAuthenticationV1TokenRequestSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAuthenticationV1TokenRequestSpec> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAuthenticationV1TokenRequestSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthenticationV1TokenRequestSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAuthenticationV1TokenRequestSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAuthenticationV1TokenRequestSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthenticationV1TokenRequestSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
