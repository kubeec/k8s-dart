...
class IoK8sApiCoreV1HTTPGetAction {
  ...
  static IoK8sApiCoreV1HTTPGetAction? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiCoreV1HTTPGetAction(
        ...
        httpHeaders: IoK8sApiCoreV1HTTPHeader.listFromJson(json[r'httpHeaders']) ?? const [],
  ...
  static Map<String, List<IoK8sApiCoreV1HTTPGetAction>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1HTTPGetAction.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
