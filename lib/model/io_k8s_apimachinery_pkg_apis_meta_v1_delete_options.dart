...
class IoK8sApimachineryPkgApisMetaV1DeleteOptions {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1DeleteOptions &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgApisMetaV1DeleteOptions[apiVersion=$apiVersion, dryRun=$dryRun, gracePeriodSeconds=$gracePeriodSeconds, kind=$kind, orphanDependents=$orphanDependents, preconditions=$preconditions, propagationPolicy=$propagationPolicy]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1DeleteOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1DeleteOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApimachineryPkgApisMetaV1DeleteOptions(
        ...
        preconditions: IoK8sApimachineryPkgApisMetaV1Preconditions.fromJson(json[r'preconditions']),
  ...
  static List<IoK8sApimachineryPkgApisMetaV1DeleteOptions>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1DeleteOptions> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1DeleteOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1DeleteOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1DeleteOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1DeleteOptions>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1DeleteOptions.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
