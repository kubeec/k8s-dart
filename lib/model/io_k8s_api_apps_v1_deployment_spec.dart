...
class IoK8sApiAppsV1DeploymentSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1DeploymentSpec &&
  ...
  int get hashCode =>
    ...
    (progressDeadlineSeconds == null ? 0 : progressDeadlineSeconds!.hashCode) +
  ...
  @override
  String toString() => 'IoK8sApiAppsV1DeploymentSpec[minReadySeconds=$minReadySeconds, paused=$paused, progressDeadlineSeconds=$progressDeadlineSeconds, replicas=$replicas, revisionHistoryLimit=$revisionHistoryLimit, selector=$selector, strategy=$strategy, template=$template]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1DeploymentSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1DeploymentSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAppsV1DeploymentSpec(
        ...
        progressDeadlineSeconds: mapValueOfType<int>(json, r'progressDeadlineSeconds'),
  ...
  static List<IoK8sApiAppsV1DeploymentSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiAppsV1DeploymentSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1DeploymentSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1DeploymentSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
