...
class IoK8sApiCoreV1NodeCondition {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeCondition &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1NodeCondition[lastHeartbeatTime=$lastHeartbeatTime, lastTransitionTime=$lastTransitionTime, message=$message, reason=$reason, status=$status, type=$type]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.lastHeartbeatTime != null) {
      json[r'lastHeartbeatTime'] = this.lastHeartbeatTime!.toUtc().toIso8601String();
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1NodeCondition[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1NodeCondition[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1NodeCondition>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1NodeCondition>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1NodeCondition>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1NodeCondition.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
