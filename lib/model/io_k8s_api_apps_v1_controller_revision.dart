...
class IoK8sApiAppsV1ControllerRevision {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1ControllerRevision &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1ControllerRevision[apiVersion=$apiVersion, data=$data, kind=$kind, metadata=$metadata, revision=$revision]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1ControllerRevision[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1ControllerRevision[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAppsV1ControllerRevision>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAppsV1ControllerRevision> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiAppsV1ControllerRevision>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1ControllerRevision>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1ControllerRevision.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
