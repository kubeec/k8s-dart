...
class IoK8sApiBatchV1PodFailurePolicy {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1PodFailurePolicy &&
     other.rules == rules;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiBatchV1PodFailurePolicy[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiBatchV1PodFailurePolicy[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiBatchV1PodFailurePolicy(
        rules: IoK8sApiBatchV1PodFailurePolicyRule.listFromJson(json[r'rules'])!,
      );
    }
    return null;
  }

  static List<IoK8sApiBatchV1PodFailurePolicy>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiBatchV1PodFailurePolicy> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiBatchV1PodFailurePolicy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiBatchV1PodFailurePolicy>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1PodFailurePolicy.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
