...
class IoK8sApiNetworkingV1NetworkPolicyPeer {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1NetworkPolicyPeer &&
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1NetworkPolicyPeer[ipBlock=$ipBlock, namespaceSelector=$namespaceSelector, podSelector=$podSelector]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1NetworkPolicyPeer[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1NetworkPolicyPeer[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiNetworkingV1NetworkPolicyPeer>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiNetworkingV1NetworkPolicyPeer> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiNetworkingV1NetworkPolicyPeer>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1NetworkPolicyPeer.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiNetworkingV1NetworkPolicyPeer>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1NetworkPolicyPeer>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1NetworkPolicyPeer.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
