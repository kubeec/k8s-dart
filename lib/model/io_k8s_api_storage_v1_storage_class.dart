...
class IoK8sApiStorageV1StorageClass {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1StorageClass &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1StorageClass[allowVolumeExpansion=$allowVolumeExpansion, allowedTopologies=$allowedTopologies, apiVersion=$apiVersion, kind=$kind, metadata=$metadata, mountOptions=$mountOptions, parameters=$parameters, provisioner=$provisioner, reclaimPolicy=$reclaimPolicy, volumeBindingMode=$volumeBindingMode]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1StorageClass[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1StorageClass[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiStorageV1StorageClass(
        allowVolumeExpansion: mapValueOfType<bool>(json, r'allowVolumeExpansion'),
        allowedTopologies: IoK8sApiCoreV1TopologySelectorTerm.listFromJson(json[r'allowedTopologies']) ?? const [],
  ...
  static List<IoK8sApiStorageV1StorageClass>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiStorageV1StorageClass>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1StorageClass>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1StorageClass.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
