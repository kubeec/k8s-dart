...
class IoK8sApiCoreV1PersistentVolumeSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PersistentVolumeSpec &&
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.persistentVolumeReclaimPolicy != null) {
      json[r'persistentVolumeReclaimPolicy'] = this.persistentVolumeReclaimPolicy;
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PersistentVolumeSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PersistentVolumeSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1PersistentVolumeSpec(
        accessModes: json[r'accessModes'] is List
            ...
            : const [],
        awsElasticBlockStore: IoK8sApiCoreV1AWSElasticBlockStoreVolumeSource.fromJson(json[r'awsElasticBlockStore']),
        azureDisk: IoK8sApiCoreV1AzureDiskVolumeSource.fromJson(json[r'azureDisk']),
        azureFile: IoK8sApiCoreV1AzureFilePersistentVolumeSource.fromJson(json[r'azureFile']),
        capacity: mapCastOfType<String, String>(json, r'capacity') ?? const {},
        cephfs: IoK8sApiCoreV1CephFSPersistentVolumeSource.fromJson(json[r'cephfs']),
        cinder: IoK8sApiCoreV1CinderPersistentVolumeSource.fromJson(json[r'cinder']),
        ...
        flexVolume: IoK8sApiCoreV1FlexPersistentVolumeSource.fromJson(json[r'flexVolume']),
        flocker: IoK8sApiCoreV1FlockerVolumeSource.fromJson(json[r'flocker']),
        gcePersistentDisk: IoK8sApiCoreV1GCEPersistentDiskVolumeSource.fromJson(json[r'gcePersistentDisk']),
        glusterfs: IoK8sApiCoreV1GlusterfsPersistentVolumeSource.fromJson(json[r'glusterfs']),
        hostPath: IoK8sApiCoreV1HostPathVolumeSource.fromJson(json[r'hostPath']),
        iscsi: IoK8sApiCoreV1ISCSIPersistentVolumeSource.fromJson(json[r'iscsi']),
        ...
        nodeAffinity: IoK8sApiCoreV1VolumeNodeAffinity.fromJson(json[r'nodeAffinity']),
        persistentVolumeReclaimPolicy: mapValueOfType<String>(json, r'persistentVolumeReclaimPolicy'),
        photonPersistentDisk: IoK8sApiCoreV1PhotonPersistentDiskVolumeSource.fromJson(json[r'photonPersistentDisk']),
        portworxVolume: IoK8sApiCoreV1PortworxVolumeSource.fromJson(json[r'portworxVolume']),
        ...
        scaleIO: IoK8sApiCoreV1ScaleIOPersistentVolumeSource.fromJson(json[r'scaleIO']),
        storageClassName: mapValueOfType<String>(json, r'storageClassName'),
        storageos: IoK8sApiCoreV1StorageOSPersistentVolumeSource.fromJson(json[r'storageos']),
        volumeMode: mapValueOfType<String>(json, r'volumeMode'),
        vsphereVolume: IoK8sApiCoreV1VsphereVirtualDiskVolumeSource.fromJson(json[r'vsphereVolume']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1PersistentVolumeSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1PersistentVolumeSpec> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1PersistentVolumeSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PersistentVolumeSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PersistentVolumeSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
