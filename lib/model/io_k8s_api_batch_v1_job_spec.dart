...
class IoK8sApiBatchV1JobSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1JobSpec &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiBatchV1JobSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiBatchV1JobSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiBatchV1JobSpec(
        ...
        podFailurePolicy: IoK8sApiBatchV1PodFailurePolicy.fromJson(json[r'podFailurePolicy']),
        ...
        ttlSecondsAfterFinished: mapValueOfType<int>(json, r'ttlSecondsAfterFinished'),
      );
    }
    return null;
  }

  static List<IoK8sApiBatchV1JobSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiBatchV1JobSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiBatchV1JobSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1JobSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
