...
class IoK8sApiAppsV1DaemonSetStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1DaemonSetStatus &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1DaemonSetStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1DaemonSetStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAppsV1DaemonSetStatus(
        ...
        conditions: IoK8sApiAppsV1DaemonSetCondition.listFromJson(json[r'conditions']) ?? const [],
        currentNumberScheduled: mapValueOfType<int>(json, r'currentNumberScheduled')!,
        desiredNumberScheduled: mapValueOfType<int>(json, r'desiredNumberScheduled')!,
        ...
        updatedNumberScheduled: mapValueOfType<int>(json, r'updatedNumberScheduled'),
      );
    }
    return null;
  }

  static List<IoK8sApiAppsV1DaemonSetStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiAppsV1DaemonSetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1DaemonSetStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1DaemonSetStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
