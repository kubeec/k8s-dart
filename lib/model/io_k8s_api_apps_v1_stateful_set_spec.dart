...
class IoK8sApiAppsV1StatefulSetSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1StatefulSetSpec &&
  ...
  int get hashCode =>
    ...
    (ordinals == null ? 0 : ordinals!.hashCode) +
    (persistentVolumeClaimRetentionPolicy == null ? 0 : persistentVolumeClaimRetentionPolicy!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.ordinals != null) {
      json[r'ordinals'] = this.ordinals;
    } else {
      json[r'ordinals'] = null;
    }
    if (this.persistentVolumeClaimRetentionPolicy != null) {
      json[r'persistentVolumeClaimRetentionPolicy'] = this.persistentVolumeClaimRetentionPolicy;
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1StatefulSetSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1StatefulSetSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAppsV1StatefulSetSpec(
        ...
        ordinals: IoK8sApiAppsV1StatefulSetOrdinals.fromJson(json[r'ordinals']),
        persistentVolumeClaimRetentionPolicy: IoK8sApiAppsV1StatefulSetPersistentVolumeClaimRetentionPolicy.fromJson(json[r'persistentVolumeClaimRetentionPolicy']),
        podManagementPolicy: mapValueOfType<String>(json, r'podManagementPolicy'),
        replicas: mapValueOfType<int>(json, r'replicas'),
        revisionHistoryLimit: mapValueOfType<int>(json, r'revisionHistoryLimit'),
        ...
        updateStrategy: IoK8sApiAppsV1StatefulSetUpdateStrategy.fromJson(json[r'updateStrategy']),
        volumeClaimTemplates: IoK8sApiCoreV1PersistentVolumeClaim.listFromJson(json[r'volumeClaimTemplates']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiAppsV1StatefulSetSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiAppsV1StatefulSetSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1StatefulSetSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1StatefulSetSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
