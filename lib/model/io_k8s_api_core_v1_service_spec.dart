...
class IoK8sApiCoreV1ServiceSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ServiceSpec &&
  ...
  int get hashCode =>
    ...
    (allocateLoadBalancerNodePorts == null ? 0 : allocateLoadBalancerNodePorts!.hashCode) +
    ...
    (ports.hashCode) +
    (publishNotReadyAddresses == null ? 0 : publishNotReadyAddresses!.hashCode) +
    (selector.hashCode) +
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ServiceSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ServiceSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1ServiceSpec(
        allocateLoadBalancerNodePorts: mapValueOfType<bool>(json, r'allocateLoadBalancerNodePorts'),
        ...
        externalTrafficPolicy: mapValueOfType<String>(json, r'externalTrafficPolicy'),
        healthCheckNodePort: mapValueOfType<int>(json, r'healthCheckNodePort'),
        internalTrafficPolicy: mapValueOfType<String>(json, r'internalTrafficPolicy'),
        ...
        loadBalancerSourceRanges: json[r'loadBalancerSourceRanges'] is List
            ...
            : const [],
        ports: IoK8sApiCoreV1ServicePort.listFromJson(json[r'ports']) ?? const [],
        publishNotReadyAddresses: mapValueOfType<bool>(json, r'publishNotReadyAddresses'),
        selector: mapCastOfType<String, String>(json, r'selector') ?? const {},
        sessionAffinity: mapValueOfType<String>(json, r'sessionAffinity'),
        sessionAffinityConfig: IoK8sApiCoreV1SessionAffinityConfig.fromJson(json[r'sessionAffinityConfig']),
  ...
  static List<IoK8sApiCoreV1ServiceSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1ServiceSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ServiceSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ServiceSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
