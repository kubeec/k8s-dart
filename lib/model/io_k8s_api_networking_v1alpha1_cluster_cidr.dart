...
class IoK8sApiNetworkingV1alpha1ClusterCIDR {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1alpha1ClusterCIDR &&
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1alpha1ClusterCIDR[apiVersion=$apiVersion, kind=$kind, metadata=$metadata, spec=$spec]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1alpha1ClusterCIDR[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1alpha1ClusterCIDR[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiNetworkingV1alpha1ClusterCIDR>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiNetworkingV1alpha1ClusterCIDR> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiNetworkingV1alpha1ClusterCIDR>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1alpha1ClusterCIDR.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiNetworkingV1alpha1ClusterCIDR>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1alpha1ClusterCIDR>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1alpha1ClusterCIDR.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
