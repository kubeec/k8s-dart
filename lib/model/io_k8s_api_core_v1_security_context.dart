...
class IoK8sApiCoreV1SecurityContext {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1SecurityContext &&
  ...
  int get hashCode =>
    ...
    (allowPrivilegeEscalation == null ? 0 : allowPrivilegeEscalation!.hashCode) +
  ...
  @override
  String toString() => 'IoK8sApiCoreV1SecurityContext[allowPrivilegeEscalation=$allowPrivilegeEscalation, capabilities=$capabilities, privileged=$privileged, procMount=$procMount, readOnlyRootFilesystem=$readOnlyRootFilesystem, runAsGroup=$runAsGroup, runAsNonRoot=$runAsNonRoot, runAsUser=$runAsUser, seLinuxOptions=$seLinuxOptions, seccompProfile=$seccompProfile, windowsOptions=$windowsOptions]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1SecurityContext[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1SecurityContext[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1SecurityContext(
        allowPrivilegeEscalation: mapValueOfType<bool>(json, r'allowPrivilegeEscalation'),
        capabilities: IoK8sApiCoreV1Capabilities.fromJson(json[r'capabilities']),
        privileged: mapValueOfType<bool>(json, r'privileged'),
        procMount: mapValueOfType<String>(json, r'procMount'),
        readOnlyRootFilesystem: mapValueOfType<bool>(json, r'readOnlyRootFilesystem'),
        ...
        seLinuxOptions: IoK8sApiCoreV1SELinuxOptions.fromJson(json[r'seLinuxOptions']),
        seccompProfile: IoK8sApiCoreV1SeccompProfile.fromJson(json[r'seccompProfile']),
        windowsOptions: IoK8sApiCoreV1WindowsSecurityContextOptions.fromJson(json[r'windowsOptions']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1SecurityContext>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1SecurityContext>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1SecurityContext>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1SecurityContext.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
