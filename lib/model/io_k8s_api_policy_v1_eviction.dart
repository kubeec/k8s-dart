...
class IoK8sApiPolicyV1Eviction {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiPolicyV1Eviction &&
  ...
  @override
  String toString() => 'IoK8sApiPolicyV1Eviction[apiVersion=$apiVersion, deleteOptions=$deleteOptions, kind=$kind, metadata=$metadata]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.deleteOptions != null) {
      json[r'deleteOptions'] = this.deleteOptions;
    } else {
      json[r'deleteOptions'] = null;
    }
    if (this.kind != null) {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiPolicyV1Eviction[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiPolicyV1Eviction[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiPolicyV1Eviction(
        ...
        deleteOptions: IoK8sApimachineryPkgApisMetaV1DeleteOptions.fromJson(json[r'deleteOptions']),
  ...
  static List<IoK8sApiPolicyV1Eviction>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiPolicyV1Eviction>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiPolicyV1Eviction>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiPolicyV1Eviction.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
