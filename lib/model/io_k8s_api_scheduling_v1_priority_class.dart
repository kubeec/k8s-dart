...
class IoK8sApiSchedulingV1PriorityClass {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiSchedulingV1PriorityClass &&
  ...
  @override
  String toString() => 'IoK8sApiSchedulingV1PriorityClass[apiVersion=$apiVersion, description=$description, globalDefault=$globalDefault, kind=$kind, metadata=$metadata, preemptionPolicy=$preemptionPolicy, value=$value]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiSchedulingV1PriorityClass[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiSchedulingV1PriorityClass[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiSchedulingV1PriorityClass>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiSchedulingV1PriorityClass> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiSchedulingV1PriorityClass>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiSchedulingV1PriorityClass>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiSchedulingV1PriorityClass.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
