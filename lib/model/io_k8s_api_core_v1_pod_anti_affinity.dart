...
class IoK8sApiCoreV1PodAntiAffinity {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodAntiAffinity &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1PodAntiAffinity[preferredDuringSchedulingIgnoredDuringExecution=$preferredDuringSchedulingIgnoredDuringExecution, requiredDuringSchedulingIgnoredDuringExecution=$requiredDuringSchedulingIgnoredDuringExecution]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PodAntiAffinity[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PodAntiAffinity[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1PodAntiAffinity(
        preferredDuringSchedulingIgnoredDuringExecution: IoK8sApiCoreV1WeightedPodAffinityTerm.listFromJson(json[r'preferredDuringSchedulingIgnoredDuringExecution']) ?? const [],
        requiredDuringSchedulingIgnoredDuringExecution: IoK8sApiCoreV1PodAffinityTerm.listFromJson(json[r'requiredDuringSchedulingIgnoredDuringExecution']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1PodAntiAffinity>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1PodAntiAffinity>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PodAntiAffinity>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PodAntiAffinity.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
