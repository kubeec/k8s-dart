...
class IoK8sApiBatchV1CronJobSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1CronJobSpec &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiBatchV1CronJobSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiBatchV1CronJobSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiBatchV1CronJobSpec(
        ...
        failedJobsHistoryLimit: mapValueOfType<int>(json, r'failedJobsHistoryLimit'),
        jobTemplate: IoK8sApiBatchV1JobTemplateSpec.fromJson(json[r'jobTemplate'])!,
        schedule: mapValueOfType<String>(json, r'schedule')!,
        startingDeadlineSeconds: mapValueOfType<int>(json, r'startingDeadlineSeconds'),
        successfulJobsHistoryLimit: mapValueOfType<int>(json, r'successfulJobsHistoryLimit'),
  ...
  static List<IoK8sApiBatchV1CronJobSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiBatchV1CronJobSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiBatchV1CronJobSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1CronJobSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
