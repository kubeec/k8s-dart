...
class IoK8sApiCoreV1CSIVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1CSIVolumeSource &&
     other.driver == driver &&
     other.fsType == fsType &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1CSIVolumeSource[driver=$driver, fsType=$fsType, nodePublishSecretRef=$nodePublishSecretRef, readOnly=$readOnly, volumeAttributes=$volumeAttributes]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1CSIVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1CSIVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1CSIVolumeSource(
        ...
        nodePublishSecretRef: IoK8sApiCoreV1LocalObjectReference.fromJson(json[r'nodePublishSecretRef']),
  ...
  static List<IoK8sApiCoreV1CSIVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1CSIVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1CSIVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1CSIVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
