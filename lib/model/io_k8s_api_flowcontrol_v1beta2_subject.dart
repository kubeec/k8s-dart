...
class IoK8sApiFlowcontrolV1beta2Subject {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiFlowcontrolV1beta2Subject &&
     other.group == group &&
     other.kind == kind &&
  ...
  @override
  String toString() => 'IoK8sApiFlowcontrolV1beta2Subject[group=$group, kind=$kind, serviceAccount=$serviceAccount, user=$user]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiFlowcontrolV1beta2Subject[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiFlowcontrolV1beta2Subject[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiFlowcontrolV1beta2Subject(
        ...
        serviceAccount: IoK8sApiFlowcontrolV1beta2ServiceAccountSubject.fromJson(json[r'serviceAccount']),
  ...
  static List<IoK8sApiFlowcontrolV1beta2Subject>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiFlowcontrolV1beta2Subject> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiFlowcontrolV1beta2Subject>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiFlowcontrolV1beta2Subject>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiFlowcontrolV1beta2Subject.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
