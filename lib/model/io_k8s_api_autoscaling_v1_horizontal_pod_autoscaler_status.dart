...
class IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus &&
  ...
  int get hashCode =>
    ...
    (currentCPUUtilizationPercentage == null ? 0 : currentCPUUtilizationPercentage!.hashCode) +
  ...
  @override
  String toString() => 'IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus[currentCPUUtilizationPercentage=$currentCPUUtilizationPercentage, currentReplicas=$currentReplicas, desiredReplicas=$desiredReplicas, lastScaleTime=$lastScaleTime, observedGeneration=$observedGeneration]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
    if (this.currentCPUUtilizationPercentage != null) {
      json[r'currentCPUUtilizationPercentage'] = this.currentCPUUtilizationPercentage;
    } else {
      json[r'currentCPUUtilizationPercentage'] = null;
    }
  ...
  static IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus(
        currentCPUUtilizationPercentage: mapValueOfType<int>(json, r'currentCPUUtilizationPercentage'),
  ...
  static List<IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
