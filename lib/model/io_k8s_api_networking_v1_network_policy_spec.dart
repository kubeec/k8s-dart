...
class IoK8sApiNetworkingV1NetworkPolicySpec {
  ...
  static IoK8sApiNetworkingV1NetworkPolicySpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return IoK8sApiNetworkingV1NetworkPolicySpec(
        egress: IoK8sApiNetworkingV1NetworkPolicyEgressRule.listFromJson(json[r'egress']) ?? const [],
        ingress: IoK8sApiNetworkingV1NetworkPolicyIngressRule.listFromJson(json[r'ingress']) ?? const [],
  ...
  static Map<String, List<IoK8sApiNetworkingV1NetworkPolicySpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1NetworkPolicySpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
