...
class IoK8sApiNetworkingV1IngressTLS {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1IngressTLS &&
     other.hosts == hosts &&
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1IngressTLS[hosts=$hosts, secretName=$secretName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1IngressTLS[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1IngressTLS[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiNetworkingV1IngressTLS>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiNetworkingV1IngressTLS>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1IngressTLS>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1IngressTLS.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
