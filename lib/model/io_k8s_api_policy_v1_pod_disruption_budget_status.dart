...
class IoK8sApiPolicyV1PodDisruptionBudgetStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiPolicyV1PodDisruptionBudgetStatus &&
  ...
  @override
  String toString() => 'IoK8sApiPolicyV1PodDisruptionBudgetStatus[conditions=$conditions, currentHealthy=$currentHealthy, desiredHealthy=$desiredHealthy, disruptedPods=$disruptedPods, disruptionsAllowed=$disruptionsAllowed, expectedPods=$expectedPods, observedGeneration=$observedGeneration]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiPolicyV1PodDisruptionBudgetStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiPolicyV1PodDisruptionBudgetStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiPolicyV1PodDisruptionBudgetStatus(
        conditions: IoK8sApimachineryPkgApisMetaV1Condition.listFromJson(json[r'conditions']) ?? const [],
        currentHealthy: mapValueOfType<int>(json, r'currentHealthy')!,
        desiredHealthy: mapValueOfType<int>(json, r'desiredHealthy')!,
        disruptedPods: DateTime.mapFromJson(json[r'disruptedPods']) ?? const {},
  ...
  static List<IoK8sApiPolicyV1PodDisruptionBudgetStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiPolicyV1PodDisruptionBudgetStatus> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiPolicyV1PodDisruptionBudgetStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiPolicyV1PodDisruptionBudgetStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiPolicyV1PodDisruptionBudgetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiPolicyV1PodDisruptionBudgetStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiPolicyV1PodDisruptionBudgetStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
