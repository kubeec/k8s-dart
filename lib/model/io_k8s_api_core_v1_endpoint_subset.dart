...
class IoK8sApiCoreV1EndpointSubset {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EndpointSubset &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1EndpointSubset[addresses=$addresses, notReadyAddresses=$notReadyAddresses, ports=$ports]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1EndpointSubset[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1EndpointSubset[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1EndpointSubset(
        addresses: IoK8sApiCoreV1EndpointAddress.listFromJson(json[r'addresses']) ?? const [],
        notReadyAddresses: IoK8sApiCoreV1EndpointAddress.listFromJson(json[r'notReadyAddresses']) ?? const [],
        ports: IoK8sApiCoreV1EndpointPort.listFromJson(json[r'ports']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1EndpointSubset>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1EndpointSubset>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1EndpointSubset>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1EndpointSubset.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
