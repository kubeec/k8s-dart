...
class IoK8sApiAppsV1DeploymentCondition {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1DeploymentCondition &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1DeploymentCondition[lastTransitionTime=$lastTransitionTime, lastUpdateTime=$lastUpdateTime, message=$message, reason=$reason, status=$status, type=$type]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1DeploymentCondition[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1DeploymentCondition[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAppsV1DeploymentCondition>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAppsV1DeploymentCondition> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiAppsV1DeploymentCondition>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1DeploymentCondition>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1DeploymentCondition.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
