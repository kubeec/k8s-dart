...
class IoK8sApiEventsV1Event {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiEventsV1Event &&
     other.action == action &&
  ...
  int get hashCode =>
    ...
    (deprecatedFirstTimestamp == null ? 0 : deprecatedFirstTimestamp!.hashCode) +
    (deprecatedLastTimestamp == null ? 0 : deprecatedLastTimestamp!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.deprecatedFirstTimestamp != null) {
      json[r'deprecatedFirstTimestamp'] = this.deprecatedFirstTimestamp!.toUtc().toIso8601String();
    } else {
      json[r'deprecatedFirstTimestamp'] = null;
    }
    if (this.deprecatedLastTimestamp != null) {
      json[r'deprecatedLastTimestamp'] = this.deprecatedLastTimestamp!.toUtc().toIso8601String();
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiEventsV1Event[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiEventsV1Event[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiEventsV1Event(
        ...
        deprecatedFirstTimestamp: mapDateTime(json, r'deprecatedFirstTimestamp', ''),
        deprecatedLastTimestamp: mapDateTime(json, r'deprecatedLastTimestamp', ''),
        deprecatedSource: IoK8sApiCoreV1EventSource.fromJson(json[r'deprecatedSource']),
        ...
        reportingController: mapValueOfType<String>(json, r'reportingController'),
  ...
  static List<IoK8sApiEventsV1Event>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiEventsV1Event>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiEventsV1Event>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiEventsV1Event.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
