...
class IoK8sApimachineryPkgApisMetaV1ListMeta {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1ListMeta &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgApisMetaV1ListMeta[continue_=$continue_, remainingItemCount=$remainingItemCount, resourceVersion=$resourceVersion, selfLink=$selfLink]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1ListMeta[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1ListMeta[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApimachineryPkgApisMetaV1ListMeta>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1ListMeta> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1ListMeta>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1ListMeta.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1ListMeta>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1ListMeta>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1ListMeta.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
