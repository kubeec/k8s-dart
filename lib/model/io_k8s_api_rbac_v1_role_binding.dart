...
class IoK8sApiRbacV1RoleBinding {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiRbacV1RoleBinding &&
  ...
  @override
  String toString() => 'IoK8sApiRbacV1RoleBinding[apiVersion=$apiVersion, kind=$kind, metadata=$metadata, roleRef=$roleRef, subjects=$subjects]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiRbacV1RoleBinding[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiRbacV1RoleBinding[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiRbacV1RoleBinding>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiRbacV1RoleBinding>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiRbacV1RoleBinding>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiRbacV1RoleBinding.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
