...
class IoK8sApiCoreV1LoadBalancerIngress {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1LoadBalancerIngress &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1LoadBalancerIngress[hostname=$hostname, ip=$ip, ports=$ports]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1LoadBalancerIngress[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1LoadBalancerIngress[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1LoadBalancerIngress(
        ...
        ports: IoK8sApiCoreV1PortStatus.listFromJson(json[r'ports']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1LoadBalancerIngress>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1LoadBalancerIngress> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1LoadBalancerIngress>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1LoadBalancerIngress>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1LoadBalancerIngress.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
