...
class IoK8sApiNetworkingV1HTTPIngressPath {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1HTTPIngressPath &&
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1HTTPIngressPath[backend=$backend, path=$path, pathType=$pathType]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1HTTPIngressPath[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1HTTPIngressPath[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiNetworkingV1HTTPIngressPath>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiNetworkingV1HTTPIngressPath> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiNetworkingV1HTTPIngressPath>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1HTTPIngressPath>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1HTTPIngressPath.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
