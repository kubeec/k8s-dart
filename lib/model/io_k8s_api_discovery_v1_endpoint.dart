...
class IoK8sApiDiscoveryV1Endpoint {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiDiscoveryV1Endpoint &&
  ...
  @override
  String toString() => 'IoK8sApiDiscoveryV1Endpoint[addresses=$addresses, conditions=$conditions, deprecatedTopology=$deprecatedTopology, hints=$hints, hostname=$hostname, nodeName=$nodeName, targetRef=$targetRef, zone=$zone]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiDiscoveryV1Endpoint[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiDiscoveryV1Endpoint[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiDiscoveryV1Endpoint(
        addresses: json[r'addresses'] is List
            ...
            : const [],
        conditions: IoK8sApiDiscoveryV1EndpointConditions.fromJson(json[r'conditions']),
        deprecatedTopology: mapCastOfType<String, String>(json, r'deprecatedTopology') ?? const {},
  ...
  static List<IoK8sApiDiscoveryV1Endpoint>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiDiscoveryV1Endpoint>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiDiscoveryV1Endpoint>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiDiscoveryV1Endpoint.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
