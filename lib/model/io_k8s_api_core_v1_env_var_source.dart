...
class IoK8sApiCoreV1EnvVarSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EnvVarSource &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1EnvVarSource[configMapKeyRef=$configMapKeyRef, fieldRef=$fieldRef, resourceFieldRef=$resourceFieldRef, secretKeyRef=$secretKeyRef]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1EnvVarSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1EnvVarSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1EnvVarSource(
        configMapKeyRef: IoK8sApiCoreV1ConfigMapKeySelector.fromJson(json[r'configMapKeyRef']),
        fieldRef: IoK8sApiCoreV1ObjectFieldSelector.fromJson(json[r'fieldRef']),
        resourceFieldRef: IoK8sApiCoreV1ResourceFieldSelector.fromJson(json[r'resourceFieldRef']),
        secretKeyRef: IoK8sApiCoreV1SecretKeySelector.fromJson(json[r'secretKeyRef']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1EnvVarSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1EnvVarSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1EnvVarSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1EnvVarSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
