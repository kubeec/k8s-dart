...
class IoK8sApiCoreV1ResourceRequirements {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ResourceRequirements &&
     other.claims == claims &&
     other.limits == limits &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ResourceRequirements[claims=$claims, limits=$limits, requests=$requests]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ResourceRequirements[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ResourceRequirements[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1ResourceRequirements(
        claims: IoK8sApiCoreV1ResourceClaim.listFromJson(json[r'claims']) ?? const [],
  ...
  static List<IoK8sApiCoreV1ResourceRequirements>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1ResourceRequirements> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1ResourceRequirements>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ResourceRequirements>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ResourceRequirements.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
