...
class IoK8sApiBatchV1PodFailurePolicyRule {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1PodFailurePolicyRule &&
     other.action == action &&
  ...
  @override
  String toString() => 'IoK8sApiBatchV1PodFailurePolicyRule[action=$action, onExitCodes=$onExitCodes, onPodConditions=$onPodConditions]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiBatchV1PodFailurePolicyRule[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiBatchV1PodFailurePolicyRule[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiBatchV1PodFailurePolicyRule(
        ...
        onExitCodes: IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirement.fromJson(json[r'onExitCodes']),
        onPodConditions: IoK8sApiBatchV1PodFailurePolicyOnPodConditionsPattern.listFromJson(json[r'onPodConditions'])!,
      );
    }
    return null;
  }

  static List<IoK8sApiBatchV1PodFailurePolicyRule>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiBatchV1PodFailurePolicyRule> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiBatchV1PodFailurePolicyRule>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiBatchV1PodFailurePolicyRule>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1PodFailurePolicyRule.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
