...
class IoK8sApiRbacV1PolicyRule {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiRbacV1PolicyRule &&
  ...
  @override
  String toString() => 'IoK8sApiRbacV1PolicyRule[apiGroups=$apiGroups, nonResourceURLs=$nonResourceURLs, resourceNames=$resourceNames, resources=$resources, verbs=$verbs]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiRbacV1PolicyRule[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiRbacV1PolicyRule[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiRbacV1PolicyRule>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiRbacV1PolicyRule>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiRbacV1PolicyRule>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiRbacV1PolicyRule.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
