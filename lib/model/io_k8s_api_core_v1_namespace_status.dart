...
class IoK8sApiCoreV1NamespaceStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NamespaceStatus &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1NamespaceStatus[conditions=$conditions, phase=$phase]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1NamespaceStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1NamespaceStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1NamespaceStatus(
        conditions: IoK8sApiCoreV1NamespaceCondition.listFromJson(json[r'conditions']) ?? const [],
  ...
  static List<IoK8sApiCoreV1NamespaceStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1NamespaceStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1NamespaceStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1NamespaceStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
