...
class IoK8sApiCoreV1NodeSelectorTerm {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1NodeSelectorTerm &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1NodeSelectorTerm[matchExpressions=$matchExpressions, matchFields=$matchFields]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1NodeSelectorTerm[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1NodeSelectorTerm[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1NodeSelectorTerm(
        matchExpressions: IoK8sApiCoreV1NodeSelectorRequirement.listFromJson(json[r'matchExpressions']) ?? const [],
        matchFields: IoK8sApiCoreV1NodeSelectorRequirement.listFromJson(json[r'matchFields']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1NodeSelectorTerm>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1NodeSelectorTerm>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1NodeSelectorTerm>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1NodeSelectorTerm.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
