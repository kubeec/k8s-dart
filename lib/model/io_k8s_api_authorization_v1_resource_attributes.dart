...
class IoK8sApiAuthorizationV1ResourceAttributes {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAuthorizationV1ResourceAttributes &&
     other.group == group &&
     other.name == name &&
  ...
  @override
  String toString() => 'IoK8sApiAuthorizationV1ResourceAttributes[group=$group, name=$name, namespace=$namespace, resource=$resource, subresource=$subresource, verb=$verb, version=$version]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAuthorizationV1ResourceAttributes[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAuthorizationV1ResourceAttributes[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAuthorizationV1ResourceAttributes>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAuthorizationV1ResourceAttributes> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAuthorizationV1ResourceAttributes>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthorizationV1ResourceAttributes.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAuthorizationV1ResourceAttributes>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAuthorizationV1ResourceAttributes>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthorizationV1ResourceAttributes.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
