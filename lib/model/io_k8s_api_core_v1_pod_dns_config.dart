...
class IoK8sApiCoreV1PodDNSConfig {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodDNSConfig &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1PodDNSConfig[nameservers=$nameservers, options=$options, searches=$searches]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PodDNSConfig[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PodDNSConfig[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1PodDNSConfig(
        nameservers: json[r'nameservers'] is List
            ...
            : const [],
        options: IoK8sApiCoreV1PodDNSConfigOption.listFromJson(json[r'options']) ?? const [],
  ...
  static List<IoK8sApiCoreV1PodDNSConfig>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1PodDNSConfig>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PodDNSConfig>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PodDNSConfig.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
