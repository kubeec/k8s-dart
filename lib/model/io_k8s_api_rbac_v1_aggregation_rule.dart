...
class IoK8sApiRbacV1AggregationRule {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiRbacV1AggregationRule &&
  ...
  @override
  String toString() => 'IoK8sApiRbacV1AggregationRule[clusterRoleSelectors=$clusterRoleSelectors]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'clusterRoleSelectors'] = this.clusterRoleSelectors;
    return json;
  }
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiRbacV1AggregationRule[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiRbacV1AggregationRule[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiRbacV1AggregationRule(
        clusterRoleSelectors: IoK8sApimachineryPkgApisMetaV1LabelSelector.listFromJson(json[r'clusterRoleSelectors']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiRbacV1AggregationRule>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiRbacV1AggregationRule>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiRbacV1AggregationRule>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiRbacV1AggregationRule.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
