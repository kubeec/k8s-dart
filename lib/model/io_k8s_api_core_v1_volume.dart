...
class IoK8sApiCoreV1Volume {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1Volume &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1Volume[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1Volume[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1Volume(
        ...
        azureFile: IoK8sApiCoreV1AzureFileVolumeSource.fromJson(json[r'azureFile']),
        ...
        configMap: IoK8sApiCoreV1ConfigMapVolumeSource.fromJson(json[r'configMap']),
        csi: IoK8sApiCoreV1CSIVolumeSource.fromJson(json[r'csi']),
        downwardAPI: IoK8sApiCoreV1DownwardAPIVolumeSource.fromJson(json[r'downwardAPI']),
        emptyDir: IoK8sApiCoreV1EmptyDirVolumeSource.fromJson(json[r'emptyDir']),
        ephemeral: IoK8sApiCoreV1EphemeralVolumeSource.fromJson(json[r'ephemeral']),
        fc: IoK8sApiCoreV1FCVolumeSource.fromJson(json[r'fc']),
        flexVolume: IoK8sApiCoreV1FlexVolumeSource.fromJson(json[r'flexVolume']),
        ...
        glusterfs: IoK8sApiCoreV1GlusterfsVolumeSource.fromJson(json[r'glusterfs']),
        ...
        persistentVolumeClaim: IoK8sApiCoreV1PersistentVolumeClaimVolumeSource.fromJson(json[r'persistentVolumeClaim']),
        ...
        projected: IoK8sApiCoreV1ProjectedVolumeSource.fromJson(json[r'projected']),
        ...
        storageos: IoK8sApiCoreV1StorageOSVolumeSource.fromJson(json[r'storageos']),
  ...
  static List<IoK8sApiCoreV1Volume>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1Volume>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1Volume>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1Volume.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
