...
class IoK8sApiStorageV1VolumeAttachmentStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1VolumeAttachmentStatus &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1VolumeAttachmentStatus[attachError=$attachError, attached=$attached, attachmentMetadata=$attachmentMetadata, detachError=$detachError]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1VolumeAttachmentStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1VolumeAttachmentStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiStorageV1VolumeAttachmentStatus(
        attachError: IoK8sApiStorageV1VolumeError.fromJson(json[r'attachError']),
        attached: mapValueOfType<bool>(json, r'attached')!,
        attachmentMetadata: mapCastOfType<String, String>(json, r'attachmentMetadata') ?? const {},
        detachError: IoK8sApiStorageV1VolumeError.fromJson(json[r'detachError']),
      );
    }
    return null;
  }

  static List<IoK8sApiStorageV1VolumeAttachmentStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiStorageV1VolumeAttachmentStatus> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiStorageV1VolumeAttachmentStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1VolumeAttachmentStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiStorageV1VolumeAttachmentStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1VolumeAttachmentStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1VolumeAttachmentStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
