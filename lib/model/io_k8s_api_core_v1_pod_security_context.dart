...
class IoK8sApiCoreV1PodSecurityContext {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodSecurityContext &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PodSecurityContext[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PodSecurityContext[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1PodSecurityContext(
        ...
        fsGroupChangePolicy: mapValueOfType<String>(json, r'fsGroupChangePolicy'),
        ...
        supplementalGroups: json[r'supplementalGroups'] is List
            ...
            : const [],
        sysctls: IoK8sApiCoreV1Sysctl.listFromJson(json[r'sysctls']) ?? const [],
  ...
  static List<IoK8sApiCoreV1PodSecurityContext>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1PodSecurityContext> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1PodSecurityContext>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PodSecurityContext>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PodSecurityContext.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
