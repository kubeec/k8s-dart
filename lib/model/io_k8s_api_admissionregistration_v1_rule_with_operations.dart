...
class IoK8sApiAdmissionregistrationV1RuleWithOperations {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAdmissionregistrationV1RuleWithOperations &&
  ...
  @override
  String toString() => 'IoK8sApiAdmissionregistrationV1RuleWithOperations[apiGroups=$apiGroups, apiVersions=$apiVersions, operations=$operations, resources=$resources, scope=$scope]';
  ...
  static IoK8sApiAdmissionregistrationV1RuleWithOperations? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAdmissionregistrationV1RuleWithOperations[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAdmissionregistrationV1RuleWithOperations[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAdmissionregistrationV1RuleWithOperations>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApiAdmissionregistrationV1RuleWithOperations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiAdmissionregistrationV1RuleWithOperations.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiAdmissionregistrationV1RuleWithOperations> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAdmissionregistrationV1RuleWithOperations>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAdmissionregistrationV1RuleWithOperations.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAdmissionregistrationV1RuleWithOperations>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAdmissionregistrationV1RuleWithOperations>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAdmissionregistrationV1RuleWithOperations.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
