...
class IoK8sApiStorageV1beta1CSIStorageCapacity {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1beta1CSIStorageCapacity &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1beta1CSIStorageCapacity[apiVersion=$apiVersion, capacity=$capacity, kind=$kind, maximumVolumeSize=$maximumVolumeSize, metadata=$metadata, nodeTopology=$nodeTopology, storageClassName=$storageClassName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1beta1CSIStorageCapacity[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1beta1CSIStorageCapacity[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiStorageV1beta1CSIStorageCapacity>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiStorageV1beta1CSIStorageCapacity> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiStorageV1beta1CSIStorageCapacity>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1beta1CSIStorageCapacity.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiStorageV1beta1CSIStorageCapacity>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1beta1CSIStorageCapacity>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1beta1CSIStorageCapacity.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
