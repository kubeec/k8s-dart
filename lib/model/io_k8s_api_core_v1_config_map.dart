...
class IoK8sApiCoreV1ConfigMap {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ConfigMap &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ConfigMap[apiVersion=$apiVersion, binaryData=$binaryData, data=$data, immutable=$immutable, kind=$kind, metadata=$metadata]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.apiVersion != null) {
      ...
      json[r'binaryData'] = this.binaryData;
      json[r'data'] = this.data;
    if (this.immutable != null) {
      json[r'immutable'] = this.immutable;
    } else {
      json[r'immutable'] = null;
    }
    if (this.kind != null) {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ConfigMap[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ConfigMap[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1ConfigMap(
        ...
        binaryData: mapCastOfType<String, String>(json, r'binaryData') ?? const {},
  ...
  static List<IoK8sApiCoreV1ConfigMap>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1ConfigMap>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ConfigMap>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ConfigMap.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
