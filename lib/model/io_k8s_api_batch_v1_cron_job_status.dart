...
class IoK8sApiBatchV1CronJobStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1CronJobStatus &&
     other.active == active &&
  ...
  @override
  String toString() => 'IoK8sApiBatchV1CronJobStatus[active=$active, lastScheduleTime=$lastScheduleTime, lastSuccessfulTime=$lastSuccessfulTime]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'active'] = this.active;
    if (this.lastScheduleTime != null) {
      json[r'lastScheduleTime'] = this.lastScheduleTime!.toUtc().toIso8601String();
    } else {
      json[r'lastScheduleTime'] = null;
    }
    if (this.lastSuccessfulTime != null) {
      json[r'lastSuccessfulTime'] = this.lastSuccessfulTime!.toUtc().toIso8601String();
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiBatchV1CronJobStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiBatchV1CronJobStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiBatchV1CronJobStatus(
        active: IoK8sApiCoreV1ObjectReference.listFromJson(json[r'active']) ?? const [],
  ...
  static List<IoK8sApiBatchV1CronJobStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiBatchV1CronJobStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiBatchV1CronJobStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1CronJobStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
