...
class IoK8sApiAppsV1StatefulSetStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1StatefulSetStatus &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1StatefulSetStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1StatefulSetStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAppsV1StatefulSetStatus(
        ...
        conditions: IoK8sApiAppsV1StatefulSetCondition.listFromJson(json[r'conditions']) ?? const [],
  ...
  static List<IoK8sApiAppsV1StatefulSetStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAppsV1StatefulSetStatus> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiAppsV1StatefulSetStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1StatefulSetStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1StatefulSetStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
