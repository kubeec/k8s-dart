...
class IoK8sApiCoreV1EnvFromSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1EnvFromSource &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1EnvFromSource[configMapRef=$configMapRef, prefix=$prefix, secretRef=$secretRef]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1EnvFromSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1EnvFromSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1EnvFromSource(
        configMapRef: IoK8sApiCoreV1ConfigMapEnvSource.fromJson(json[r'configMapRef']),
  ...
  static List<IoK8sApiCoreV1EnvFromSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1EnvFromSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1EnvFromSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1EnvFromSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
