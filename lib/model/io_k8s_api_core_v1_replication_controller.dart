...
class IoK8sApiCoreV1ReplicationController {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ReplicationController &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ReplicationController[apiVersion=$apiVersion, kind=$kind, metadata=$metadata, spec=$spec, status=$status]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ReplicationController[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ReplicationController[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1ReplicationController(
        ...
        status: IoK8sApiCoreV1ReplicationControllerStatus.fromJson(json[r'status']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1ReplicationController>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1ReplicationController> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1ReplicationController>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ReplicationController>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ReplicationController.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
