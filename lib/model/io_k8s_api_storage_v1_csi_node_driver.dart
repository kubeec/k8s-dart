...
class IoK8sApiStorageV1CSINodeDriver {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1CSINodeDriver &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1CSINodeDriver[allocatable=$allocatable, name=$name, nodeID=$nodeID, topologyKeys=$topologyKeys]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1CSINodeDriver[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1CSINodeDriver[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiStorageV1CSINodeDriver(
        allocatable: IoK8sApiStorageV1VolumeNodeResources.fromJson(json[r'allocatable']),
  ...
  static List<IoK8sApiStorageV1CSINodeDriver>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiStorageV1CSINodeDriver>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1CSINodeDriver>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1CSINodeDriver.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
