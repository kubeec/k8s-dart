...
class IoK8sApiCoreV1PodStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodStatus &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1PodStatus[conditions=$conditions, containerStatuses=$containerStatuses, ephemeralContainerStatuses=$ephemeralContainerStatuses, hostIP=$hostIP, initContainerStatuses=$initContainerStatuses, message=$message, nominatedNodeName=$nominatedNodeName, phase=$phase, podIP=$podIP, podIPs=$podIPs, qosClass=$qosClass, reason=$reason, startTime=$startTime]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PodStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PodStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1PodStatus(
        conditions: IoK8sApiCoreV1PodCondition.listFromJson(json[r'conditions']) ?? const [],
        containerStatuses: IoK8sApiCoreV1ContainerStatus.listFromJson(json[r'containerStatuses']) ?? const [],
        ephemeralContainerStatuses: IoK8sApiCoreV1ContainerStatus.listFromJson(json[r'ephemeralContainerStatuses']) ?? const [],
        hostIP: mapValueOfType<String>(json, r'hostIP'),
        initContainerStatuses: IoK8sApiCoreV1ContainerStatus.listFromJson(json[r'initContainerStatuses']) ?? const [],
  ...
  static List<IoK8sApiCoreV1PodStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1PodStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PodStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PodStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
