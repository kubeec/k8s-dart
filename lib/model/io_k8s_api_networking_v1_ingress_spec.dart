...
class IoK8sApiNetworkingV1IngressSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1IngressSpec &&
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1IngressSpec[defaultBackend=$defaultBackend, ingressClassName=$ingressClassName, rules=$rules, tls=$tls]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1IngressSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1IngressSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiNetworkingV1IngressSpec(
        defaultBackend: IoK8sApiNetworkingV1IngressBackend.fromJson(json[r'defaultBackend']),
        ingressClassName: mapValueOfType<String>(json, r'ingressClassName'),
        rules: IoK8sApiNetworkingV1IngressRule.listFromJson(json[r'rules']) ?? const [],
        tls: IoK8sApiNetworkingV1IngressTLS.listFromJson(json[r'tls']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiNetworkingV1IngressSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiNetworkingV1IngressSpec> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiNetworkingV1IngressSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1IngressSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1IngressSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
