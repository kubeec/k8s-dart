...
class IoK8sApiCoreV1TypedLocalObjectReference {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1TypedLocalObjectReference &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1TypedLocalObjectReference[apiGroup=$apiGroup, kind=$kind, name=$name]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1TypedLocalObjectReference[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1TypedLocalObjectReference[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1TypedLocalObjectReference>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1TypedLocalObjectReference> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1TypedLocalObjectReference>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1TypedLocalObjectReference.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1TypedLocalObjectReference>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1TypedLocalObjectReference>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1TypedLocalObjectReference.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
