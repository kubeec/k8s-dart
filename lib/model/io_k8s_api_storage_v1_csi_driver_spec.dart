...
class IoK8sApiStorageV1CSIDriverSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1CSIDriverSpec &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1CSIDriverSpec[attachRequired=$attachRequired, fsGroupPolicy=$fsGroupPolicy, podInfoOnMount=$podInfoOnMount, requiresRepublish=$requiresRepublish, seLinuxMount=$seLinuxMount, storageCapacity=$storageCapacity, tokenRequests=$tokenRequests, volumeLifecycleModes=$volumeLifecycleModes]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1CSIDriverSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1CSIDriverSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiStorageV1CSIDriverSpec(
        ...
        tokenRequests: IoK8sApiStorageV1TokenRequest.listFromJson(json[r'tokenRequests']) ?? const [],
  ...
  static List<IoK8sApiStorageV1CSIDriverSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiStorageV1CSIDriverSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1CSIDriverSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1CSIDriverSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
