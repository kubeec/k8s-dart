...
class IoK8sApiRbacV1RoleRef {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiRbacV1RoleRef &&
  ...
  @override
  String toString() => 'IoK8sApiRbacV1RoleRef[apiGroup=$apiGroup, kind=$kind, name=$name]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiRbacV1RoleRef[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiRbacV1RoleRef[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiRbacV1RoleRef>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiRbacV1RoleRef>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiRbacV1RoleRef>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiRbacV1RoleRef.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
