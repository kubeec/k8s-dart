...
class IoK8sApiCoreV1WindowsSecurityContextOptions {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1WindowsSecurityContextOptions &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1WindowsSecurityContextOptions[gmsaCredentialSpec=$gmsaCredentialSpec, gmsaCredentialSpecName=$gmsaCredentialSpecName, hostProcess=$hostProcess, runAsUserName=$runAsUserName]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1WindowsSecurityContextOptions[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1WindowsSecurityContextOptions[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1WindowsSecurityContextOptions(
        ...
        gmsaCredentialSpecName: mapValueOfType<String>(json, r'gmsaCredentialSpecName'),
  ...
  static List<IoK8sApiCoreV1WindowsSecurityContextOptions>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1WindowsSecurityContextOptions> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1WindowsSecurityContextOptions>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1WindowsSecurityContextOptions.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1WindowsSecurityContextOptions>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1WindowsSecurityContextOptions>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1WindowsSecurityContextOptions.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
