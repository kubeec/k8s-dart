...
class IoK8sApimachineryPkgApisMetaV1StatusDetails {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1StatusDetails &&
     other.causes == causes &&
     other.group == group &&
     other.kind == kind &&
     other.name == name &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgApisMetaV1StatusDetails[causes=$causes, group=$group, kind=$kind, name=$name, retryAfterSeconds=$retryAfterSeconds, uid=$uid]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1StatusDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1StatusDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApimachineryPkgApisMetaV1StatusDetails(
        causes: IoK8sApimachineryPkgApisMetaV1StatusCause.listFromJson(json[r'causes']) ?? const [],
  ...
  static List<IoK8sApimachineryPkgApisMetaV1StatusDetails>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1StatusDetails> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1StatusDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1StatusDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1StatusDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1StatusDetails>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1StatusDetails.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
