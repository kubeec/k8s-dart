...
class IoK8sApiNetworkingV1alpha1ClusterCIDRSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1alpha1ClusterCIDRSpec &&
     other.ipv4 == ipv4 &&
     other.ipv6 == ipv6 &&
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1alpha1ClusterCIDRSpec[ipv4=$ipv4, ipv6=$ipv6, nodeSelector=$nodeSelector, perNodeHostBits=$perNodeHostBits]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1alpha1ClusterCIDRSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1alpha1ClusterCIDRSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiNetworkingV1alpha1ClusterCIDRSpec(
        ...
        nodeSelector: IoK8sApiCoreV1NodeSelector.fromJson(json[r'nodeSelector']),
  ...
  static List<IoK8sApiNetworkingV1alpha1ClusterCIDRSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiNetworkingV1alpha1ClusterCIDRSpec> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiNetworkingV1alpha1ClusterCIDRSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1alpha1ClusterCIDRSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiNetworkingV1alpha1ClusterCIDRSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1alpha1ClusterCIDRSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1alpha1ClusterCIDRSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
