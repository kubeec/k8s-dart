...
class IoK8sApiStorageV1VolumeAttachmentSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiStorageV1VolumeAttachmentSpec &&
  ...
  @override
  String toString() => 'IoK8sApiStorageV1VolumeAttachmentSpec[attacher=$attacher, nodeName=$nodeName, source_=$source_]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiStorageV1VolumeAttachmentSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiStorageV1VolumeAttachmentSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiStorageV1VolumeAttachmentSpec(
        ...
        source_: IoK8sApiStorageV1VolumeAttachmentSource.fromJson(json[r'source'])!,
      );
    }
    return null;
  }

  static List<IoK8sApiStorageV1VolumeAttachmentSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiStorageV1VolumeAttachmentSpec> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiStorageV1VolumeAttachmentSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1VolumeAttachmentSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiStorageV1VolumeAttachmentSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiStorageV1VolumeAttachmentSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiStorageV1VolumeAttachmentSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
