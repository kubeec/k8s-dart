...
class IoK8sApiFlowcontrolV1beta2FlowSchemaSpec {
  ...
  IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationReference priorityLevelConfiguration;

  /// `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
  List<IoK8sApiFlowcontrolV1beta2PolicyRulesWithSubjects> rules;

  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiFlowcontrolV1beta2FlowSchemaSpec &&
  ...
  @override
  String toString() => 'IoK8sApiFlowcontrolV1beta2FlowSchemaSpec[distinguisherMethod=$distinguisherMethod, matchingPrecedence=$matchingPrecedence, priorityLevelConfiguration=$priorityLevelConfiguration, rules=$rules]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiFlowcontrolV1beta2FlowSchemaSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiFlowcontrolV1beta2FlowSchemaSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiFlowcontrolV1beta2FlowSchemaSpec(
        distinguisherMethod: IoK8sApiFlowcontrolV1beta2FlowDistinguisherMethod.fromJson(json[r'distinguisherMethod']),
        matchingPrecedence: mapValueOfType<int>(json, r'matchingPrecedence'),
        priorityLevelConfiguration: IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationReference.fromJson(json[r'priorityLevelConfiguration'])!,
        rules: IoK8sApiFlowcontrolV1beta2PolicyRulesWithSubjects.listFromJson(json[r'rules']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiFlowcontrolV1beta2FlowSchemaSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiFlowcontrolV1beta2FlowSchemaSpec> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiFlowcontrolV1beta2FlowSchemaSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiFlowcontrolV1beta2FlowSchemaSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiFlowcontrolV1beta2FlowSchemaSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiFlowcontrolV1beta2FlowSchemaSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiFlowcontrolV1beta2FlowSchemaSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
