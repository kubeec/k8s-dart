...
class IoK8sApiAppsV1DaemonSetSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1DaemonSetSpec &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1DaemonSetSpec[minReadySeconds=$minReadySeconds, revisionHistoryLimit=$revisionHistoryLimit, selector=$selector, template=$template, updateStrategy=$updateStrategy]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1DaemonSetSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1DaemonSetSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAppsV1DaemonSetSpec(
        ...
        updateStrategy: IoK8sApiAppsV1DaemonSetUpdateStrategy.fromJson(json[r'updateStrategy']),
      );
    }
    return null;
  }

  static List<IoK8sApiAppsV1DaemonSetSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiAppsV1DaemonSetSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1DaemonSetSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1DaemonSetSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
