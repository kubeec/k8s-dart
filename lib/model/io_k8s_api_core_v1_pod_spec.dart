...
class IoK8sApiCoreV1PodSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PodSpec &&
  ...
  int get hashCode =>
    ...
    (terminationGracePeriodSeconds == null ? 0 : terminationGracePeriodSeconds!.hashCode) +
    (tolerations.hashCode) +
    (topologySpreadConstraints.hashCode) +
    (volumes.hashCode);

  @override
  String toString() => 'IoK8sApiCoreV1PodSpec[activeDeadlineSeconds=$activeDeadlineSeconds, affinity=$affinity, automountServiceAccountToken=$automountServiceAccountToken, containers=$containers, dnsConfig=$dnsConfig, dnsPolicy=$dnsPolicy, enableServiceLinks=$enableServiceLinks, ephemeralContainers=$ephemeralContainers, hostAliases=$hostAliases, hostIPC=$hostIPC, hostNetwork=$hostNetwork, hostPID=$hostPID, hostUsers=$hostUsers, hostname=$hostname, imagePullSecrets=$imagePullSecrets, initContainers=$initContainers, nodeName=$nodeName, nodeSelector=$nodeSelector, os=$os, overhead=$overhead, preemptionPolicy=$preemptionPolicy, priority=$priority, priorityClassName=$priorityClassName, readinessGates=$readinessGates, resourceClaims=$resourceClaims, restartPolicy=$restartPolicy, runtimeClassName=$runtimeClassName, schedulerName=$schedulerName, schedulingGates=$schedulingGates, securityContext=$securityContext, serviceAccount=$serviceAccount, serviceAccountName=$serviceAccountName, setHostnameAsFQDN=$setHostnameAsFQDN, shareProcessNamespace=$shareProcessNamespace, subdomain=$subdomain, terminationGracePeriodSeconds=$terminationGracePeriodSeconds, tolerations=$tolerations, topologySpreadConstraints=$topologySpreadConstraints, volumes=$volumes]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.schedulerName != null) {
      ...
      json[r'schedulingGates'] = this.schedulingGates;
    ...
    if (this.terminationGracePeriodSeconds != null) {
      json[r'terminationGracePeriodSeconds'] = this.terminationGracePeriodSeconds;
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PodSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PodSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1PodSpec(
        activeDeadlineSeconds: mapValueOfType<int>(json, r'activeDeadlineSeconds'),
        ...
        ephemeralContainers: IoK8sApiCoreV1EphemeralContainer.listFromJson(json[r'ephemeralContainers']) ?? const [],
        hostAliases: IoK8sApiCoreV1HostAlias.listFromJson(json[r'hostAliases']) ?? const [],
        ...
        imagePullSecrets: IoK8sApiCoreV1LocalObjectReference.listFromJson(json[r'imagePullSecrets']) ?? const [],
        initContainers: IoK8sApiCoreV1Container.listFromJson(json[r'initContainers']) ?? const [],
        nodeName: mapValueOfType<String>(json, r'nodeName'),
        nodeSelector: mapCastOfType<String, String>(json, r'nodeSelector') ?? const {},
        ...
        readinessGates: IoK8sApiCoreV1PodReadinessGate.listFromJson(json[r'readinessGates']) ?? const [],
        resourceClaims: IoK8sApiCoreV1PodResourceClaim.listFromJson(json[r'resourceClaims']) ?? const [],
        ...
        schedulingGates: IoK8sApiCoreV1PodSchedulingGate.listFromJson(json[r'schedulingGates']) ?? const [],
        securityContext: IoK8sApiCoreV1PodSecurityContext.fromJson(json[r'securityContext']),
        ...
        shareProcessNamespace: mapValueOfType<bool>(json, r'shareProcessNamespace'),
        subdomain: mapValueOfType<String>(json, r'subdomain'),
        terminationGracePeriodSeconds: mapValueOfType<int>(json, r'terminationGracePeriodSeconds'),
        tolerations: IoK8sApiCoreV1Toleration.listFromJson(json[r'tolerations']) ?? const [],
        topologySpreadConstraints: IoK8sApiCoreV1TopologySpreadConstraint.listFromJson(json[r'topologySpreadConstraints']) ?? const [],
        volumes: IoK8sApiCoreV1Volume.listFromJson(json[r'volumes']) ?? const [],
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1PodSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1PodSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PodSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PodSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
