...
class IoK8sApiNodeV1RuntimeClass {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNodeV1RuntimeClass &&
  ...
  @override
  String toString() => 'IoK8sApiNodeV1RuntimeClass[apiVersion=$apiVersion, handler=$handler, kind=$kind, metadata=$metadata, overhead=$overhead, scheduling=$scheduling]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNodeV1RuntimeClass[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNodeV1RuntimeClass[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiNodeV1RuntimeClass>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiNodeV1RuntimeClass>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNodeV1RuntimeClass>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNodeV1RuntimeClass.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
