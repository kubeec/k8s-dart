...
class IoK8sApiBatchV1UncountedTerminatedPods {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiBatchV1UncountedTerminatedPods &&
     other.failed == failed &&
  ...
  @override
  String toString() => 'IoK8sApiBatchV1UncountedTerminatedPods[failed=$failed, succeeded=$succeeded]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiBatchV1UncountedTerminatedPods[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiBatchV1UncountedTerminatedPods[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiBatchV1UncountedTerminatedPods>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiBatchV1UncountedTerminatedPods> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiBatchV1UncountedTerminatedPods>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1UncountedTerminatedPods.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiBatchV1UncountedTerminatedPods>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiBatchV1UncountedTerminatedPods>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1UncountedTerminatedPods.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
