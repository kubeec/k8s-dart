...
class IoK8sApiAutoscalingV1ScaleStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAutoscalingV1ScaleStatus &&
  ...
  @override
  String toString() => 'IoK8sApiAutoscalingV1ScaleStatus[replicas=$replicas, selector=$selector]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAutoscalingV1ScaleStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAutoscalingV1ScaleStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAutoscalingV1ScaleStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAutoscalingV1ScaleStatus> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiAutoscalingV1ScaleStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAutoscalingV1ScaleStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV1ScaleStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
