...
class IoK8sApiCoreV1CSIPersistentVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1CSIPersistentVolumeSource &&
  ...
  int get hashCode =>
    ...
    (controllerExpandSecretRef == null ? 0 : controllerExpandSecretRef!.hashCode) +
    (controllerPublishSecretRef == null ? 0 : controllerPublishSecretRef!.hashCode) +
    (driver.hashCode) +
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1CSIPersistentVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1CSIPersistentVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1CSIPersistentVolumeSource(
        controllerExpandSecretRef: IoK8sApiCoreV1SecretReference.fromJson(json[r'controllerExpandSecretRef']),
        controllerPublishSecretRef: IoK8sApiCoreV1SecretReference.fromJson(json[r'controllerPublishSecretRef']),
        driver: mapValueOfType<String>(json, r'driver')!,
        fsType: mapValueOfType<String>(json, r'fsType'),
        nodeExpandSecretRef: IoK8sApiCoreV1SecretReference.fromJson(json[r'nodeExpandSecretRef']),
        nodePublishSecretRef: IoK8sApiCoreV1SecretReference.fromJson(json[r'nodePublishSecretRef']),
        nodeStageSecretRef: IoK8sApiCoreV1SecretReference.fromJson(json[r'nodeStageSecretRef']),
        readOnly: mapValueOfType<bool>(json, r'readOnly'),
        volumeAttributes: mapCastOfType<String, String>(json, r'volumeAttributes') ?? const {},
  ...
  static List<IoK8sApiCoreV1CSIPersistentVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1CSIPersistentVolumeSource> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1CSIPersistentVolumeSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1CSIPersistentVolumeSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1CSIPersistentVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1CSIPersistentVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1CSIPersistentVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
