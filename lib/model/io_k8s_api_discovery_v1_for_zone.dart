...
class IoK8sApiDiscoveryV1ForZone {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiDiscoveryV1ForZone &&
     other.name == name;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiDiscoveryV1ForZone[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiDiscoveryV1ForZone[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiDiscoveryV1ForZone>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiDiscoveryV1ForZone>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiDiscoveryV1ForZone>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiDiscoveryV1ForZone.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
