...
class IoK8sApiCoreV1ResourceQuotaSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1ResourceQuotaSpec &&
     other.hard == hard &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1ResourceQuotaSpec[hard=$hard, scopeSelector=$scopeSelector, scopes=$scopes]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1ResourceQuotaSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1ResourceQuotaSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1ResourceQuotaSpec(
        ...
        scopeSelector: IoK8sApiCoreV1ScopeSelector.fromJson(json[r'scopeSelector']),
  ...
  static List<IoK8sApiCoreV1ResourceQuotaSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1ResourceQuotaSpec> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1ResourceQuotaSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1ResourceQuotaSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1ResourceQuotaSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
