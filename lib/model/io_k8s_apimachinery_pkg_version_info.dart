...
class IoK8sApimachineryPkgVersionInfo {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgVersionInfo &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgVersionInfo[buildDate=$buildDate, compiler=$compiler, gitCommit=$gitCommit, gitTreeState=$gitTreeState, gitVersion=$gitVersion, goVersion=$goVersion, major=$major, minor=$minor, platform=$platform]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgVersionInfo[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgVersionInfo[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApimachineryPkgVersionInfo>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApimachineryPkgVersionInfo> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApimachineryPkgVersionInfo>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgVersionInfo>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgVersionInfo.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
