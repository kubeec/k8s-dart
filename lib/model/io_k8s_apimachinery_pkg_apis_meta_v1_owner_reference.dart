...
class IoK8sApimachineryPkgApisMetaV1OwnerReference {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1OwnerReference &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgApisMetaV1OwnerReference[apiVersion=$apiVersion, blockOwnerDeletion=$blockOwnerDeletion, controller=$controller, kind=$kind, name=$name, uid=$uid]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1OwnerReference[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1OwnerReference[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApimachineryPkgApisMetaV1OwnerReference>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApimachineryPkgApisMetaV1OwnerReference>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApimachineryPkgApisMetaV1OwnerReference.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1OwnerReference> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1OwnerReference>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1OwnerReference.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1OwnerReference>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1OwnerReference>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1OwnerReference.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
