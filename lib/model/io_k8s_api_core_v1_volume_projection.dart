...
class IoK8sApiCoreV1VolumeProjection {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1VolumeProjection &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1VolumeProjection[configMap=$configMap, downwardAPI=$downwardAPI, secret=$secret, serviceAccountToken=$serviceAccountToken]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1VolumeProjection[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1VolumeProjection[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1VolumeProjection(
        configMap: IoK8sApiCoreV1ConfigMapProjection.fromJson(json[r'configMap']),
        downwardAPI: IoK8sApiCoreV1DownwardAPIProjection.fromJson(json[r'downwardAPI']),
        secret: IoK8sApiCoreV1SecretProjection.fromJson(json[r'secret']),
        serviceAccountToken: IoK8sApiCoreV1ServiceAccountTokenProjection.fromJson(json[r'serviceAccountToken']),
      );
    }
    return null;
  }

  static List<IoK8sApiCoreV1VolumeProjection>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiCoreV1VolumeProjection>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1VolumeProjection>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1VolumeProjection.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
