...
class IoK8sApiCertificatesV1CertificateSigningRequestSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCertificatesV1CertificateSigningRequestSpec &&
  ...
  @override
  String toString() => 'IoK8sApiCertificatesV1CertificateSigningRequestSpec[expirationSeconds=$expirationSeconds, extra=$extra, groups=$groups, request=$request, signerName=$signerName, uid=$uid, usages=$usages, username=$username]';
  ...
  static IoK8sApiCertificatesV1CertificateSigningRequestSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCertificatesV1CertificateSigningRequestSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCertificatesV1CertificateSigningRequestSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCertificatesV1CertificateSigningRequestSpec>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApiCertificatesV1CertificateSigningRequestSpec>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiCertificatesV1CertificateSigningRequestSpec.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiCertificatesV1CertificateSigningRequestSpec> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCertificatesV1CertificateSigningRequestSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCertificatesV1CertificateSigningRequestSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCertificatesV1CertificateSigningRequestSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCertificatesV1CertificateSigningRequestSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCertificatesV1CertificateSigningRequestSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
