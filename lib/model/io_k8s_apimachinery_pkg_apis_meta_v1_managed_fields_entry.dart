...
class IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry &&
  ...
  @override
  String toString() => 'IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry[apiVersion=$apiVersion, fieldsType=$fieldsType, fieldsV1=$fieldsV1, manager=$manager, operation=$operation, subresource=$subresource, time=$time]';
  ...
  static IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
