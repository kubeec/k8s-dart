...
class IoK8sApiCoreV1StorageOSPersistentVolumeSource {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1StorageOSPersistentVolumeSource &&
     other.fsType == fsType &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1StorageOSPersistentVolumeSource[fsType=$fsType, readOnly=$readOnly, secretRef=$secretRef, volumeName=$volumeName, volumeNamespace=$volumeNamespace]';
  ...
  static IoK8sApiCoreV1StorageOSPersistentVolumeSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1StorageOSPersistentVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1StorageOSPersistentVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1StorageOSPersistentVolumeSource>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApiCoreV1StorageOSPersistentVolumeSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiCoreV1StorageOSPersistentVolumeSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiCoreV1StorageOSPersistentVolumeSource> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1StorageOSPersistentVolumeSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1StorageOSPersistentVolumeSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1StorageOSPersistentVolumeSource>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1StorageOSPersistentVolumeSource>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1StorageOSPersistentVolumeSource.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
