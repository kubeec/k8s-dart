...
class IoK8sApiRbacV1Subject {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiRbacV1Subject &&
  ...
  @override
  String toString() => 'IoK8sApiRbacV1Subject[apiGroup=$apiGroup, kind=$kind, name=$name, namespace=$namespace]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiRbacV1Subject[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiRbacV1Subject[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiRbacV1Subject>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiRbacV1Subject>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiRbacV1Subject>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiRbacV1Subject.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
