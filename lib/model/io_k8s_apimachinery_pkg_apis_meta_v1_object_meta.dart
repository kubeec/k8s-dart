...
class IoK8sApimachineryPkgApisMetaV1ObjectMeta {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApimachineryPkgApisMetaV1ObjectMeta &&
  ...
  int get hashCode =>
    ...
    (deletionGracePeriodSeconds == null ? 0 : deletionGracePeriodSeconds!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.deletionTimestamp != null) {
      json[r'deletionTimestamp'] = this.deletionTimestamp!.toUtc().toIso8601String();
    } else {
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApimachineryPkgApisMetaV1ObjectMeta[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApimachineryPkgApisMetaV1ObjectMeta[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApimachineryPkgApisMetaV1ObjectMeta(
        ...
        deletionGracePeriodSeconds: mapValueOfType<int>(json, r'deletionGracePeriodSeconds'),
        ...
        managedFields: IoK8sApimachineryPkgApisMetaV1ManagedFieldsEntry.listFromJson(json[r'managedFields']) ?? const [],
        name: mapValueOfType<String>(json, r'name'),
        namespace: mapValueOfType<String>(json, r'namespace'),
        ownerReferences: IoK8sApimachineryPkgApisMetaV1OwnerReference.listFromJson(json[r'ownerReferences']) ?? const [],
  ...
  static List<IoK8sApimachineryPkgApisMetaV1ObjectMeta>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1ObjectMeta> mapFromJson(dynamic json) {
    final map = <String, IoK8sApimachineryPkgApisMetaV1ObjectMeta>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1ObjectMeta.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1ObjectMeta>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApimachineryPkgApisMetaV1ObjectMeta>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1ObjectMeta.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
