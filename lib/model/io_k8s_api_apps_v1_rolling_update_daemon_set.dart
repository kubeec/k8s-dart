...
class IoK8sApiAppsV1RollingUpdateDaemonSet {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1RollingUpdateDaemonSet &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1RollingUpdateDaemonSet[maxSurge=$maxSurge, maxUnavailable=$maxUnavailable]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1RollingUpdateDaemonSet[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1RollingUpdateDaemonSet[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAppsV1RollingUpdateDaemonSet>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiAppsV1RollingUpdateDaemonSet> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAppsV1RollingUpdateDaemonSet>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1RollingUpdateDaemonSet.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAppsV1RollingUpdateDaemonSet>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1RollingUpdateDaemonSet>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1RollingUpdateDaemonSet.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
