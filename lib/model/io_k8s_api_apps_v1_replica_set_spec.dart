...
class IoK8sApiAppsV1ReplicaSetSpec {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAppsV1ReplicaSetSpec &&
  ...
  @override
  String toString() => 'IoK8sApiAppsV1ReplicaSetSpec[minReadySeconds=$minReadySeconds, replicas=$replicas, selector=$selector, template=$template]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAppsV1ReplicaSetSpec[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAppsV1ReplicaSetSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAppsV1ReplicaSetSpec>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<IoK8sApiAppsV1ReplicaSetSpec>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAppsV1ReplicaSetSpec>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1ReplicaSetSpec.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
