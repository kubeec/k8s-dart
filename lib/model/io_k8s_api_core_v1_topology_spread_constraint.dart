...
class IoK8sApiCoreV1TopologySpreadConstraint {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1TopologySpreadConstraint &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1TopologySpreadConstraint[labelSelector=$labelSelector, matchLabelKeys=$matchLabelKeys, maxSkew=$maxSkew, minDomains=$minDomains, nodeAffinityPolicy=$nodeAffinityPolicy, nodeTaintsPolicy=$nodeTaintsPolicy, topologyKey=$topologyKey, whenUnsatisfiable=$whenUnsatisfiable]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1TopologySpreadConstraint[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1TopologySpreadConstraint[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiCoreV1TopologySpreadConstraint(
        labelSelector: IoK8sApimachineryPkgApisMetaV1LabelSelector.fromJson(json[r'labelSelector']),
  ...
  static List<IoK8sApiCoreV1TopologySpreadConstraint>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1TopologySpreadConstraint> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1TopologySpreadConstraint>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1TopologySpreadConstraint.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1TopologySpreadConstraint>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1TopologySpreadConstraint>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1TopologySpreadConstraint.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
