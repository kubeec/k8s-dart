...
class IoK8sApiDiscoveryV1EndpointPort {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiDiscoveryV1EndpointPort &&
  ...
  @override
  String toString() => 'IoK8sApiDiscoveryV1EndpointPort[appProtocol=$appProtocol, name=$name, port=$port, protocol=$protocol]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiDiscoveryV1EndpointPort[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiDiscoveryV1EndpointPort[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiDiscoveryV1EndpointPort>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiDiscoveryV1EndpointPort> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiDiscoveryV1EndpointPort>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiDiscoveryV1EndpointPort>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiDiscoveryV1EndpointPort.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
