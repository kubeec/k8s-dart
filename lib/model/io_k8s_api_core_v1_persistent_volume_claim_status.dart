...
class IoK8sApiCoreV1PersistentVolumeClaimStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiCoreV1PersistentVolumeClaimStatus &&
  ...
  @override
  String toString() => 'IoK8sApiCoreV1PersistentVolumeClaimStatus[accessModes=$accessModes, allocatedResources=$allocatedResources, capacity=$capacity, conditions=$conditions, phase=$phase, resizeStatus=$resizeStatus]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiCoreV1PersistentVolumeClaimStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiCoreV1PersistentVolumeClaimStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiCoreV1PersistentVolumeClaimStatus(
        accessModes: json[r'accessModes'] is List
            ...
            : const [],
        allocatedResources: mapCastOfType<String, String>(json, r'allocatedResources') ?? const {},
        capacity: mapCastOfType<String, String>(json, r'capacity') ?? const {},
        conditions: IoK8sApiCoreV1PersistentVolumeClaimCondition.listFromJson(json[r'conditions']) ?? const [],
  ...
  static List<IoK8sApiCoreV1PersistentVolumeClaimStatus>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiCoreV1PersistentVolumeClaimStatus> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiCoreV1PersistentVolumeClaimStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PersistentVolumeClaimStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiCoreV1PersistentVolumeClaimStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiCoreV1PersistentVolumeClaimStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1PersistentVolumeClaimStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
