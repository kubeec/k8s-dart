...
class IoK8sApiNetworkingV1NetworkPolicy {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiNetworkingV1NetworkPolicy &&
  ...
  @override
  String toString() => 'IoK8sApiNetworkingV1NetworkPolicy[apiVersion=$apiVersion, kind=$kind, metadata=$metadata, spec=$spec, status=$status]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiNetworkingV1NetworkPolicy[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiNetworkingV1NetworkPolicy[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiNetworkingV1NetworkPolicy(
        ...
        status: IoK8sApiNetworkingV1NetworkPolicyStatus.fromJson(json[r'status']),
      );
    }
    return null;
  }

  static List<IoK8sApiNetworkingV1NetworkPolicy>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, IoK8sApiNetworkingV1NetworkPolicy> mapFromJson(dynamic json) {
  ...
  static Map<String, List<IoK8sApiNetworkingV1NetworkPolicy>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiNetworkingV1NetworkPolicy>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiNetworkingV1NetworkPolicy.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
