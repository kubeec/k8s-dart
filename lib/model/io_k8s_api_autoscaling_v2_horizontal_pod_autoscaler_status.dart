...
class IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus &&
  ...
  @override
  String toString() => 'IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus[conditions=$conditions, currentMetrics=$currentMetrics, currentReplicas=$currentReplicas, desiredReplicas=$desiredReplicas, lastScaleTime=$lastScaleTime, observedGeneration=$observedGeneration]';
  ...
  static IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus(
        conditions: IoK8sApiAutoscalingV2HorizontalPodAutoscalerCondition.listFromJson(json[r'conditions']) ?? const [],
        currentMetrics: IoK8sApiAutoscalingV2MetricStatus.listFromJson(json[r'currentMetrics']) ?? const [],
  ...
  static List<IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus>? listFromJson(dynamic json, {bool growable = false,}) {
    final result = <IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
