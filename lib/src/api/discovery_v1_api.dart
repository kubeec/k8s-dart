...
class DiscoveryV1Api {
  ...
  const DiscoveryV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1EndpointSlice>> createNamespacedEndpointSlice({ 
    required String namespace,
    required V1EndpointSlice body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1EndpointSlice _responseData;

    try {
_responseData = deserialize<V1EndpointSlice, V1EndpointSlice>(_response.data!, 'V1EndpointSlice', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1EndpointSlice>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionNamespacedEndpointSlice({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteNamespacedEndpointSlice({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1EndpointSliceList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1EndpointSliceList>> listEndpointSliceForAllNamespaces({ 
    ...
    V1EndpointSliceList _responseData;

    try {
_responseData = deserialize<V1EndpointSliceList, V1EndpointSliceList>(_response.data!, 'V1EndpointSliceList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1EndpointSliceList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1EndpointSliceList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1EndpointSliceList>> listNamespacedEndpointSlice({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
...
_responseData = deserialize<V1EndpointSliceList, V1EndpointSliceList>(_response.data!, 'V1EndpointSliceList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1EndpointSlice>> patchNamespacedEndpointSlice({ 
    required String name,
    required String namespace,
...
_responseData = deserialize<V1EndpointSlice, V1EndpointSlice>(_response.data!, 'V1EndpointSlice', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1EndpointSlice>> readNamespacedEndpointSlice({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1EndpointSlice, V1EndpointSlice>(_response.data!, 'V1EndpointSlice', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1EndpointSlice>> replaceNamespacedEndpointSlice({ 
    required String name,
    required String namespace,
    required V1EndpointSlice body,
    String? pretty,
