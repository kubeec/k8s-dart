...
class DiscoveryV1Api {
  ...
  const DiscoveryV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiDiscoveryV1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiDiscoveryV1EndpointSlice>> createDiscoveryV1NamespacedEndpointSlice({ 
    required String namespace,
    required IoK8sApiDiscoveryV1EndpointSlice body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices'.replaceAll('{' r'namespace' '}', namespace.toString());
    ...
    try {
      const _type = FullType(IoK8sApiDiscoveryV1EndpointSlice);
    ...
    IoK8sApiDiscoveryV1EndpointSlice _responseData;

    try {
      const _responseType = FullType(IoK8sApiDiscoveryV1EndpointSlice);
    ...
    return Response<IoK8sApiDiscoveryV1EndpointSlice>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteDiscoveryV1CollectionNamespacedEndpointSlice({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteDiscoveryV1NamespacedEndpointSlice({ 
    ...
    final _path = r'/apis/discovery.k8s.io/v1/namespaces/{namespace}/endpointslices/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getDiscoveryV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/discovery.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiDiscoveryV1EndpointSliceList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiDiscoveryV1EndpointSliceList>> listDiscoveryV1EndpointSliceForAllNamespaces({ 
    ...
    final _path = r'/apis/discovery.k8s.io/v1/endpointslices';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    IoK8sApiDiscoveryV1EndpointSliceList _responseData;

    try {
      const _responseType = FullType(IoK8sApiDiscoveryV1EndpointSliceList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiDiscoveryV1EndpointSliceList;
    ...
    return Response<IoK8sApiDiscoveryV1EndpointSliceList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiDiscoveryV1EndpointSliceList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiDiscoveryV1EndpointSliceList>> listDiscoveryV1NamespacedEndpointSlice({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiDiscoveryV1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiDiscoveryV1EndpointSlice>> patchDiscoveryV1NamespacedEndpointSlice({ 
    required String name,
    required String namespace,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiDiscoveryV1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiDiscoveryV1EndpointSlice>> readDiscoveryV1NamespacedEndpointSlice({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiDiscoveryV1EndpointSlice] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiDiscoveryV1EndpointSlice>> replaceDiscoveryV1NamespacedEndpointSlice({ 
    required String name,
    required String namespace,
    required IoK8sApiDiscoveryV1EndpointSlice body,
    String? pretty,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchDiscoveryV1EndpointSliceListForAllNamespaces({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/discovery.k8s.io/v1/watch/endpointslices';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchDiscoveryV1NamespacedEndpointSlice({ 
    required String name,
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    ...
    final _path = r'/apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchDiscoveryV1NamespacedEndpointSliceList({ 
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/discovery.k8s.io/v1/watch/namespaces/{namespace}/endpointslices'.replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
