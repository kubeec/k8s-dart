...
class CertificatesV1alpha1Api {
  ...
  const CertificatesV1alpha1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1alpha1ClusterTrustBundle] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1ClusterTrustBundle>> createClusterTrustBundle({ 
    required V1alpha1ClusterTrustBundle body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/certificates.k8s.io/v1alpha1/clustertrustbundles';
...
_bodyData=jsonEncode(body);
    ...
    V1alpha1ClusterTrustBundle _responseData;

    try {
_responseData = deserialize<V1alpha1ClusterTrustBundle, V1alpha1ClusterTrustBundle>(_response.data!, 'V1alpha1ClusterTrustBundle', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1alpha1ClusterTrustBundle>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteClusterTrustBundle({ 
    ...
    final _path = r'/apis/certificates.k8s.io/v1alpha1/clustertrustbundles/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionClusterTrustBundle({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  Future<Response<V1APIResourceList>> getAPIResources({ 
    ...
    final _path = r'/apis/certificates.k8s.io/v1alpha1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1alpha1ClusterTrustBundleList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1ClusterTrustBundleList>> listClusterTrustBundle({ 
    String? pretty,
    ...
    V1alpha1ClusterTrustBundleList _responseData;

    try {
_responseData = deserialize<V1alpha1ClusterTrustBundleList, V1alpha1ClusterTrustBundleList>(_response.data!, 'V1alpha1ClusterTrustBundleList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1alpha1ClusterTrustBundleList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1ClusterTrustBundle] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1ClusterTrustBundle>> patchClusterTrustBundle({ 
    required String name,
...
_responseData = deserialize<V1alpha1ClusterTrustBundle, V1alpha1ClusterTrustBundle>(_response.data!, 'V1alpha1ClusterTrustBundle', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1ClusterTrustBundle] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1ClusterTrustBundle>> readClusterTrustBundle({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1alpha1ClusterTrustBundle, V1alpha1ClusterTrustBundle>(_response.data!, 'V1alpha1ClusterTrustBundle', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1ClusterTrustBundle] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1ClusterTrustBundle>> replaceClusterTrustBundle({ 
    required String name,
    required V1alpha1ClusterTrustBundle body,
    String? pretty,
    String? dryRun,
