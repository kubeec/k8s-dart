...
class NetworkingV1alpha1Api {
  ...
  const NetworkingV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNetworkingV1alpha1ClusterCIDR] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNetworkingV1alpha1ClusterCIDR>> createNetworkingV1alpha1ClusterCIDR({ 
    required IoK8sApiNetworkingV1alpha1ClusterCIDR body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    try {
      const _type = FullType(IoK8sApiNetworkingV1alpha1ClusterCIDR);
    ...
    IoK8sApiNetworkingV1alpha1ClusterCIDR _responseData;

    try {
      const _responseType = FullType(IoK8sApiNetworkingV1alpha1ClusterCIDR);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiNetworkingV1alpha1ClusterCIDR;
    ...
    return Response<IoK8sApiNetworkingV1alpha1ClusterCIDR>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteNetworkingV1alpha1ClusterCIDR({ 
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteNetworkingV1alpha1CollectionClusterCIDR({ 
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getNetworkingV1alpha1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNetworkingV1alpha1ClusterCIDRList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNetworkingV1alpha1ClusterCIDRList>> listNetworkingV1alpha1ClusterCIDR({ 
    String? pretty,
    ...
    IoK8sApiNetworkingV1alpha1ClusterCIDRList _responseData;

    try {
      const _responseType = FullType(IoK8sApiNetworkingV1alpha1ClusterCIDRList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiNetworkingV1alpha1ClusterCIDRList;
    ...
    return Response<IoK8sApiNetworkingV1alpha1ClusterCIDRList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNetworkingV1alpha1ClusterCIDR] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNetworkingV1alpha1ClusterCIDR>> patchNetworkingV1alpha1ClusterCIDR({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNetworkingV1alpha1ClusterCIDR] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNetworkingV1alpha1ClusterCIDR>> readNetworkingV1alpha1ClusterCIDR({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNetworkingV1alpha1ClusterCIDR] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNetworkingV1alpha1ClusterCIDR>> replaceNetworkingV1alpha1ClusterCIDR({ 
    required String name,
    required IoK8sApiNetworkingV1alpha1ClusterCIDR body,
    String? pretty,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchNetworkingV1alpha1ClusterCIDR({ 
    required String name,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/networking.k8s.io/v1alpha1/watch/clustercidrs/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchNetworkingV1alpha1ClusterCIDRList({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/networking.k8s.io/v1alpha1/watch/clustercidrs';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
