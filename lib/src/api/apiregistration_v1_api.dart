...
class ApiregistrationV1Api {
  ...
  const ApiregistrationV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIService>> createAPIService({ 
    required V1APIService body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1APIService _responseData;

    try {
_responseData = deserialize<V1APIService, V1APIService>(_response.data!, 'V1APIService', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteAPIService({ 
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionAPIService({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1APIServiceList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIServiceList>> listAPIService({ 
    String? pretty,
    ...
    V1APIServiceList _responseData;

    try {
_responseData = deserialize<V1APIServiceList, V1APIServiceList>(_response.data!, 'V1APIServiceList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1APIServiceList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIService>> patchAPIService({ 
    required String name,
...
_responseData = deserialize<V1APIService, V1APIService>(_response.data!, 'V1APIService', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIService>> patchAPIServiceStatus({ 
    required String name,
    required Object body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1APIService, V1APIService>(_response.data!, 'V1APIService', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIService>> readAPIService({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1APIService, V1APIService>(_response.data!, 'V1APIService', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIService>> readAPIServiceStatus({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1APIService, V1APIService>(_response.data!, 'V1APIService', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIService>> replaceAPIService({ 
    required String name,
    required V1APIService body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1APIService, V1APIService>(_response.data!, 'V1APIService', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1APIService>> replaceAPIServiceStatus({ 
    required String name,
    required V1APIService body,
    String? pretty,
    String? dryRun,
