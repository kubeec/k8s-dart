...
class ApiregistrationV1Api {
  ...
  const ApiregistrationV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>> createApiregistrationV1APIService({ 
    required IoK8sKubeAggregatorPkgApisApiregistrationV1APIService body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/apiregistration.k8s.io/v1/apiservices';
    ...
    try {
      const _type = FullType(IoK8sKubeAggregatorPkgApisApiregistrationV1APIService);
    ...
    IoK8sKubeAggregatorPkgApisApiregistrationV1APIService _responseData;

    try {
      const _responseType = FullType(IoK8sKubeAggregatorPkgApisApiregistrationV1APIService);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sKubeAggregatorPkgApisApiregistrationV1APIService;
    ...
    return Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteApiregistrationV1APIService({ 
    ...
    final _path = r'/apis/apiregistration.k8s.io/v1/apiservices/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteApiregistrationV1CollectionAPIService({ 
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getApiregistrationV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/apiregistration.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceList>> listApiregistrationV1APIService({ 
    String? pretty,
    ...
    IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceList _responseData;

    try {
      const _responseType = FullType(IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceList;
    ...
    return Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>> patchApiregistrationV1APIService({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>> patchApiregistrationV1APIServiceStatus({ 
    required String name,
    required JsonObject body,
    String? pretty,
    String? dryRun,
    ...
    final _path = r'/apis/apiregistration.k8s.io/v1/apiservices/{name}/status'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>> readApiregistrationV1APIService({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>> readApiregistrationV1APIServiceStatus({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>> replaceApiregistrationV1APIService({ 
    required String name,
    required IoK8sKubeAggregatorPkgApisApiregistrationV1APIService body,
    String? pretty,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sKubeAggregatorPkgApisApiregistrationV1APIService] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sKubeAggregatorPkgApisApiregistrationV1APIService>> replaceApiregistrationV1APIServiceStatus({ 
    required String name,
    required IoK8sKubeAggregatorPkgApisApiregistrationV1APIService body,
    String? pretty,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchApiregistrationV1APIService({ 
    required String name,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/apiregistration.k8s.io/v1/watch/apiservices/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchApiregistrationV1APIServiceList({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/apiregistration.k8s.io/v1/watch/apiservices';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
