...
class AuthenticationV1Api {
  ...
  const AuthenticationV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAuthenticationV1TokenReview] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAuthenticationV1TokenReview>> createAuthenticationV1TokenReview({ 
    required IoK8sApiAuthenticationV1TokenReview body,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/authentication.k8s.io/v1/tokenreviews';
    ...
    try {
      const _type = FullType(IoK8sApiAuthenticationV1TokenReview);
    ...
    IoK8sApiAuthenticationV1TokenReview _responseData;

    try {
      const _responseType = FullType(IoK8sApiAuthenticationV1TokenReview);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiAuthenticationV1TokenReview;
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getAuthenticationV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/authentication.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
