...
class AuthenticationV1Api {
  ...
  const AuthenticationV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1TokenReview] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1TokenReview>> createTokenReview({ 
    required V1TokenReview body,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1TokenReview _responseData;

    try {
_responseData = deserialize<V1TokenReview, V1TokenReview>(_response.data!, 'V1TokenReview', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
