...
class NodeV1Api {
  ...
  const NodeV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNodeV1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNodeV1RuntimeClass>> createNodeV1RuntimeClass({ 
    required IoK8sApiNodeV1RuntimeClass body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/node.k8s.io/v1/runtimeclasses';
    ...
    try {
      const _type = FullType(IoK8sApiNodeV1RuntimeClass);
    ...
    IoK8sApiNodeV1RuntimeClass _responseData;

    try {
      const _responseType = FullType(IoK8sApiNodeV1RuntimeClass);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiNodeV1RuntimeClass;
    ...
    return Response<IoK8sApiNodeV1RuntimeClass>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteNodeV1CollectionRuntimeClass({ 
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteNodeV1RuntimeClass({ 
    ...
    final _path = r'/apis/node.k8s.io/v1/runtimeclasses/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getNodeV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/node.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNodeV1RuntimeClassList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNodeV1RuntimeClassList>> listNodeV1RuntimeClass({ 
    String? pretty,
    ...
    IoK8sApiNodeV1RuntimeClassList _responseData;

    try {
      const _responseType = FullType(IoK8sApiNodeV1RuntimeClassList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiNodeV1RuntimeClassList;
    ...
    return Response<IoK8sApiNodeV1RuntimeClassList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNodeV1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNodeV1RuntimeClass>> patchNodeV1RuntimeClass({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNodeV1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNodeV1RuntimeClass>> readNodeV1RuntimeClass({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiNodeV1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiNodeV1RuntimeClass>> replaceNodeV1RuntimeClass({ 
    required String name,
    required IoK8sApiNodeV1RuntimeClass body,
    String? pretty,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchNodeV1RuntimeClass({ 
    required String name,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/node.k8s.io/v1/watch/runtimeclasses/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchNodeV1RuntimeClassList({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/node.k8s.io/v1/watch/runtimeclasses';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
