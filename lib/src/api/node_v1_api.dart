...
class NodeV1Api {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1RuntimeClass>> createRuntimeClass({ 
    required V1RuntimeClass body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1RuntimeClass _responseData;

    try {
_responseData = deserialize<V1RuntimeClass, V1RuntimeClass>(_response.data!, 'V1RuntimeClass', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1RuntimeClass>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionRuntimeClass({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteRuntimeClass({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1RuntimeClassList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1RuntimeClassList>> listRuntimeClass({ 
    String? pretty,
    ...
    V1RuntimeClassList _responseData;

    try {
_responseData = deserialize<V1RuntimeClassList, V1RuntimeClassList>(_response.data!, 'V1RuntimeClassList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1RuntimeClassList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1RuntimeClass>> patchRuntimeClass({ 
    required String name,
...
_responseData = deserialize<V1RuntimeClass, V1RuntimeClass>(_response.data!, 'V1RuntimeClass', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1RuntimeClass>> readRuntimeClass({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1RuntimeClass, V1RuntimeClass>(_response.data!, 'V1RuntimeClass', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1RuntimeClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1RuntimeClass>> replaceRuntimeClass({ 
    required String name,
    required V1RuntimeClass body,
    String? pretty,
    String? dryRun,
