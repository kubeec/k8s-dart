...
class ApiextensionsV1Api {
  ...
  const ApiextensionsV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinition>> createCustomResourceDefinition({ 
    required V1CustomResourceDefinition body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1CustomResourceDefinition _responseData;

    try {
_responseData = deserialize<V1CustomResourceDefinition, V1CustomResourceDefinition>(_response.data!, 'V1CustomResourceDefinition', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1CustomResourceDefinition>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionCustomResourceDefinition({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCustomResourceDefinition({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinitionList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinitionList>> listCustomResourceDefinition({ 
    String? pretty,
    ...
    V1CustomResourceDefinitionList _responseData;

    try {
_responseData = deserialize<V1CustomResourceDefinitionList, V1CustomResourceDefinitionList>(_response.data!, 'V1CustomResourceDefinitionList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1CustomResourceDefinitionList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinition>> patchCustomResourceDefinition({ 
    required String name,
...
_responseData = deserialize<V1CustomResourceDefinition, V1CustomResourceDefinition>(_response.data!, 'V1CustomResourceDefinition', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinition>> patchCustomResourceDefinitionStatus({ 
    required String name,
    required Object body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1CustomResourceDefinition, V1CustomResourceDefinition>(_response.data!, 'V1CustomResourceDefinition', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinition>> readCustomResourceDefinition({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1CustomResourceDefinition, V1CustomResourceDefinition>(_response.data!, 'V1CustomResourceDefinition', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinition>> readCustomResourceDefinitionStatus({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1CustomResourceDefinition, V1CustomResourceDefinition>(_response.data!, 'V1CustomResourceDefinition', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinition>> replaceCustomResourceDefinition({ 
    required String name,
    required V1CustomResourceDefinition body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1CustomResourceDefinition, V1CustomResourceDefinition>(_response.data!, 'V1CustomResourceDefinition', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CustomResourceDefinition>> replaceCustomResourceDefinitionStatus({ 
    required String name,
    required V1CustomResourceDefinition body,
    String? pretty,
    String? dryRun,
