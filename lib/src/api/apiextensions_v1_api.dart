...
class ApiextensionsV1Api {
  ...
  const ApiextensionsV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>> createApiextensionsV1CustomResourceDefinition({ 
    required IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/apiextensions.k8s.io/v1/customresourcedefinitions';
    ...
    try {
      const _type = FullType(IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition);
    ...
    IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition _responseData;

    try {
      const _responseType = FullType(IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition);
    ...
    return Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteApiextensionsV1CollectionCustomResourceDefinition({ 
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteApiextensionsV1CustomResourceDefinition({ 
    ...
    final _path = r'/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getApiextensionsV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/apiextensions.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList>> listApiextensionsV1CustomResourceDefinition({ 
    String? pretty,
    ...
    IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList _responseData;

    try {
      const _responseType = FullType(IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinitionList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>> patchApiextensionsV1CustomResourceDefinition({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>> patchApiextensionsV1CustomResourceDefinitionStatus({ 
    required String name,
    required JsonObject body,
    String? pretty,
    String? dryRun,
    ...
    final _path = r'/apis/apiextensions.k8s.io/v1/customresourcedefinitions/{name}/status'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>> readApiextensionsV1CustomResourceDefinition({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>> readApiextensionsV1CustomResourceDefinitionStatus({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>> replaceApiextensionsV1CustomResourceDefinition({ 
    required String name,
    required IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition body,
    String? pretty,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition>> replaceApiextensionsV1CustomResourceDefinitionStatus({ 
    required String name,
    required IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition body,
    String? pretty,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchApiextensionsV1CustomResourceDefinition({ 
    required String name,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchApiextensionsV1CustomResourceDefinitionList({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/apiextensions.k8s.io/v1/watch/customresourcedefinitions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
