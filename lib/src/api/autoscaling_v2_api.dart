...
class AutoscalingV2Api {
  ...
  const AutoscalingV2Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>> createAutoscalingV2NamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    required IoK8sApiAutoscalingV2HorizontalPodAutoscaler body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers'.replaceAll('{' r'namespace' '}', namespace.toString());
    ...
    try {
      const _type = FullType(IoK8sApiAutoscalingV2HorizontalPodAutoscaler);
    ...
    IoK8sApiAutoscalingV2HorizontalPodAutoscaler _responseData;

    try {
      const _responseType = FullType(IoK8sApiAutoscalingV2HorizontalPodAutoscaler);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiAutoscalingV2HorizontalPodAutoscaler;
    ...
    return Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteAutoscalingV2CollectionNamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteAutoscalingV2NamespacedHorizontalPodAutoscaler({ 
    ...
    final _path = r'/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getAutoscalingV2APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/autoscaling/v2/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscalerList>> listAutoscalingV2HorizontalPodAutoscalerForAllNamespaces({ 
    ...
    final _path = r'/apis/autoscaling/v2/horizontalpodautoscalers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    IoK8sApiAutoscalingV2HorizontalPodAutoscalerList _responseData;

    try {
      const _responseType = FullType(IoK8sApiAutoscalingV2HorizontalPodAutoscalerList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiAutoscalingV2HorizontalPodAutoscalerList;
    ...
    return Response<IoK8sApiAutoscalingV2HorizontalPodAutoscalerList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscalerList>> listAutoscalingV2NamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>> patchAutoscalingV2NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>> patchAutoscalingV2NamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required JsonObject body,
    String? pretty,
    ...
    final _path = r'/apis/autoscaling/v2/namespaces/{namespace}/horizontalpodautoscalers/{name}/status'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>> readAutoscalingV2NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>> readAutoscalingV2NamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>> replaceAutoscalingV2NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    required IoK8sApiAutoscalingV2HorizontalPodAutoscaler body,
    String? pretty,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV2HorizontalPodAutoscaler>> replaceAutoscalingV2NamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required IoK8sApiAutoscalingV2HorizontalPodAutoscaler body,
    String? pretty,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchAutoscalingV2HorizontalPodAutoscalerListForAllNamespaces({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/autoscaling/v2/watch/horizontalpodautoscalers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchAutoscalingV2NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    ...
    final _path = r'/apis/autoscaling/v2/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchAutoscalingV2NamespacedHorizontalPodAutoscalerList({ 
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/autoscaling/v2/watch/namespaces/{namespace}/horizontalpodautoscalers'.replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
