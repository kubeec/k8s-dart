...
class AutoscalingV2Api {
  ...
  const AutoscalingV2Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscaler>> createNamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    required V2HorizontalPodAutoscaler body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V2HorizontalPodAutoscaler _responseData;

    try {
_responseData = deserialize<V2HorizontalPodAutoscaler, V2HorizontalPodAutoscaler>(_response.data!, 'V2HorizontalPodAutoscaler', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V2HorizontalPodAutoscaler>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionNamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteNamespacedHorizontalPodAutoscaler({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscalerList>> listHorizontalPodAutoscalerForAllNamespaces({ 
    ...
    V2HorizontalPodAutoscalerList _responseData;

    try {
_responseData = deserialize<V2HorizontalPodAutoscalerList, V2HorizontalPodAutoscalerList>(_response.data!, 'V2HorizontalPodAutoscalerList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V2HorizontalPodAutoscalerList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscalerList>> listNamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
...
_responseData = deserialize<V2HorizontalPodAutoscalerList, V2HorizontalPodAutoscalerList>(_response.data!, 'V2HorizontalPodAutoscalerList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscaler>> patchNamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
...
_responseData = deserialize<V2HorizontalPodAutoscaler, V2HorizontalPodAutoscaler>(_response.data!, 'V2HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscaler>> patchNamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required Object body,
    String? pretty,
...
_responseData = deserialize<V2HorizontalPodAutoscaler, V2HorizontalPodAutoscaler>(_response.data!, 'V2HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscaler>> readNamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V2HorizontalPodAutoscaler, V2HorizontalPodAutoscaler>(_response.data!, 'V2HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscaler>> readNamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V2HorizontalPodAutoscaler, V2HorizontalPodAutoscaler>(_response.data!, 'V2HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscaler>> replaceNamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    required V2HorizontalPodAutoscaler body,
    String? pretty,
...
_responseData = deserialize<V2HorizontalPodAutoscaler, V2HorizontalPodAutoscaler>(_response.data!, 'V2HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V2HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V2HorizontalPodAutoscaler>> replaceNamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required V2HorizontalPodAutoscaler body,
    String? pretty,
