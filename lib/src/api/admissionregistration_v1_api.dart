...
class AdmissionregistrationV1Api {
  ...
  const AdmissionregistrationV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1MutatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1MutatingWebhookConfiguration>> createMutatingWebhookConfiguration({ 
    required V1MutatingWebhookConfiguration body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1MutatingWebhookConfiguration _responseData;

    try {
_responseData = deserialize<V1MutatingWebhookConfiguration, V1MutatingWebhookConfiguration>(_response.data!, 'V1MutatingWebhookConfiguration', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1MutatingWebhookConfiguration>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1ValidatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1ValidatingWebhookConfiguration>> createValidatingWebhookConfiguration({ 
    required V1ValidatingWebhookConfiguration body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    String? fieldValidation,
...
_bodyData=jsonEncode(body);
    ...
    V1ValidatingWebhookConfiguration _responseData;

    try {
_responseData = deserialize<V1ValidatingWebhookConfiguration, V1ValidatingWebhookConfiguration>(_response.data!, 'V1ValidatingWebhookConfiguration', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1ValidatingWebhookConfiguration>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionMutatingWebhookConfiguration({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionValidatingWebhookConfiguration({ 
    String? pretty,
    String? continue_,
    String? dryRun,
    String? fieldSelector,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteMutatingWebhookConfiguration({ 
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteValidatingWebhookConfiguration({ 
    required String name,
    String? pretty,
    String? dryRun,
    int? gracePeriodSeconds,
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1MutatingWebhookConfigurationList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1MutatingWebhookConfigurationList>> listMutatingWebhookConfiguration({ 
    String? pretty,
    ...
    V1MutatingWebhookConfigurationList _responseData;

    try {
_responseData = deserialize<V1MutatingWebhookConfigurationList, V1MutatingWebhookConfigurationList>(_response.data!, 'V1MutatingWebhookConfigurationList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1MutatingWebhookConfigurationList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1ValidatingWebhookConfigurationList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1ValidatingWebhookConfigurationList>> listValidatingWebhookConfiguration({ 
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    V1ValidatingWebhookConfigurationList _responseData;

    try {
_responseData = deserialize<V1ValidatingWebhookConfigurationList, V1ValidatingWebhookConfigurationList>(_response.data!, 'V1ValidatingWebhookConfigurationList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1ValidatingWebhookConfigurationList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1MutatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1MutatingWebhookConfiguration>> patchMutatingWebhookConfiguration({ 
    required String name,
...
_responseData = deserialize<V1MutatingWebhookConfiguration, V1MutatingWebhookConfiguration>(_response.data!, 'V1MutatingWebhookConfiguration', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1ValidatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1ValidatingWebhookConfiguration>> patchValidatingWebhookConfiguration({ 
    required String name,
    required Object body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1ValidatingWebhookConfiguration, V1ValidatingWebhookConfiguration>(_response.data!, 'V1ValidatingWebhookConfiguration', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1MutatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1MutatingWebhookConfiguration>> readMutatingWebhookConfiguration({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1MutatingWebhookConfiguration, V1MutatingWebhookConfiguration>(_response.data!, 'V1MutatingWebhookConfiguration', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1ValidatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1ValidatingWebhookConfiguration>> readValidatingWebhookConfiguration({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1ValidatingWebhookConfiguration, V1ValidatingWebhookConfiguration>(_response.data!, 'V1ValidatingWebhookConfiguration', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1MutatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1MutatingWebhookConfiguration>> replaceMutatingWebhookConfiguration({ 
    required String name,
    required V1MutatingWebhookConfiguration body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1MutatingWebhookConfiguration, V1MutatingWebhookConfiguration>(_response.data!, 'V1MutatingWebhookConfiguration', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1ValidatingWebhookConfiguration] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1ValidatingWebhookConfiguration>> replaceValidatingWebhookConfiguration({ 
    required String name,
    required V1ValidatingWebhookConfiguration body,
    String? pretty,
    String? dryRun,
