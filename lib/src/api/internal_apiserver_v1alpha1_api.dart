...
class InternalApiserverV1alpha1Api {
  ...
  const InternalApiserverV1alpha1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersion>> createStorageVersion({ 
    required V1alpha1StorageVersion body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1alpha1StorageVersion _responseData;

    try {
_responseData = deserialize<V1alpha1StorageVersion, V1alpha1StorageVersion>(_response.data!, 'V1alpha1StorageVersion', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1alpha1StorageVersion>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionStorageVersion({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteStorageVersion({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersionList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersionList>> listStorageVersion({ 
    String? pretty,
    ...
    V1alpha1StorageVersionList _responseData;

    try {
_responseData = deserialize<V1alpha1StorageVersionList, V1alpha1StorageVersionList>(_response.data!, 'V1alpha1StorageVersionList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1alpha1StorageVersionList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersion>> patchStorageVersion({ 
    required String name,
...
_responseData = deserialize<V1alpha1StorageVersion, V1alpha1StorageVersion>(_response.data!, 'V1alpha1StorageVersion', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersion>> patchStorageVersionStatus({ 
    required String name,
    required Object body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1alpha1StorageVersion, V1alpha1StorageVersion>(_response.data!, 'V1alpha1StorageVersion', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersion>> readStorageVersion({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1alpha1StorageVersion, V1alpha1StorageVersion>(_response.data!, 'V1alpha1StorageVersion', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersion>> readStorageVersionStatus({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1alpha1StorageVersion, V1alpha1StorageVersion>(_response.data!, 'V1alpha1StorageVersion', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersion>> replaceStorageVersion({ 
    required String name,
    required V1alpha1StorageVersion body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1alpha1StorageVersion, V1alpha1StorageVersion>(_response.data!, 'V1alpha1StorageVersion', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1StorageVersion>> replaceStorageVersionStatus({ 
    required String name,
    required V1alpha1StorageVersion body,
    String? pretty,
    String? dryRun,
