...
class InternalApiserverV1alpha1Api {
  ...
  const InternalApiserverV1alpha1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>> createInternalApiserverV1alpha1StorageVersion({ 
    required IoK8sApiApiserverinternalV1alpha1StorageVersion body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/internal.apiserver.k8s.io/v1alpha1/storageversions';
    ...
    try {
      const _type = FullType(IoK8sApiApiserverinternalV1alpha1StorageVersion);
    ...
    IoK8sApiApiserverinternalV1alpha1StorageVersion _responseData;

    try {
      const _responseType = FullType(IoK8sApiApiserverinternalV1alpha1StorageVersion);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiApiserverinternalV1alpha1StorageVersion;
    ...
    return Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteInternalApiserverV1alpha1CollectionStorageVersion({ 
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteInternalApiserverV1alpha1StorageVersion({ 
    ...
    final _path = r'/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getInternalApiserverV1alpha1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/internal.apiserver.k8s.io/v1alpha1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersionList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersionList>> listInternalApiserverV1alpha1StorageVersion({ 
    String? pretty,
    ...
    IoK8sApiApiserverinternalV1alpha1StorageVersionList _responseData;

    try {
      const _responseType = FullType(IoK8sApiApiserverinternalV1alpha1StorageVersionList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiApiserverinternalV1alpha1StorageVersionList;
    ...
    return Response<IoK8sApiApiserverinternalV1alpha1StorageVersionList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>> patchInternalApiserverV1alpha1StorageVersion({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>> patchInternalApiserverV1alpha1StorageVersionStatus({ 
    required String name,
    required JsonObject body,
    String? pretty,
    String? dryRun,
    ...
    final _path = r'/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>> readInternalApiserverV1alpha1StorageVersion({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>> readInternalApiserverV1alpha1StorageVersionStatus({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>> replaceInternalApiserverV1alpha1StorageVersion({ 
    required String name,
    required IoK8sApiApiserverinternalV1alpha1StorageVersion body,
    String? pretty,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiApiserverinternalV1alpha1StorageVersion] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiApiserverinternalV1alpha1StorageVersion>> replaceInternalApiserverV1alpha1StorageVersionStatus({ 
    required String name,
    required IoK8sApiApiserverinternalV1alpha1StorageVersion body,
    String? pretty,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchInternalApiserverV1alpha1StorageVersion({ 
    required String name,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchInternalApiserverV1alpha1StorageVersionList({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/internal.apiserver.k8s.io/v1alpha1/watch/storageversions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
