...
class AutoscalingV1Api {
  ...
  const AutoscalingV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>> createAutoscalingV1NamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    required IoK8sApiAutoscalingV1HorizontalPodAutoscaler body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers'.replaceAll('{' r'namespace' '}', namespace.toString());
    ...
    try {
      const _type = FullType(IoK8sApiAutoscalingV1HorizontalPodAutoscaler);
    ...
    IoK8sApiAutoscalingV1HorizontalPodAutoscaler _responseData;

    try {
      const _responseType = FullType(IoK8sApiAutoscalingV1HorizontalPodAutoscaler);
    ...
    return Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteAutoscalingV1CollectionNamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteAutoscalingV1NamespacedHorizontalPodAutoscaler({ 
    ...
    final _path = r'/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getAutoscalingV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/autoscaling/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscalerList>> listAutoscalingV1HorizontalPodAutoscalerForAllNamespaces({ 
    ...
    final _path = r'/apis/autoscaling/v1/horizontalpodautoscalers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    IoK8sApiAutoscalingV1HorizontalPodAutoscalerList _responseData;

    try {
      const _responseType = FullType(IoK8sApiAutoscalingV1HorizontalPodAutoscalerList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<IoK8sApiAutoscalingV1HorizontalPodAutoscalerList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscalerList>> listAutoscalingV1NamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>> patchAutoscalingV1NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>> patchAutoscalingV1NamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required JsonObject body,
    String? pretty,
    ...
    final _path = r'/apis/autoscaling/v1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>> readAutoscalingV1NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>> readAutoscalingV1NamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>> replaceAutoscalingV1NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    required IoK8sApiAutoscalingV1HorizontalPodAutoscaler body,
    String? pretty,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiAutoscalingV1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiAutoscalingV1HorizontalPodAutoscaler>> replaceAutoscalingV1NamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required IoK8sApiAutoscalingV1HorizontalPodAutoscaler body,
    String? pretty,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchAutoscalingV1HorizontalPodAutoscalerListForAllNamespaces({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/autoscaling/v1/watch/horizontalpodautoscalers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchAutoscalingV1NamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    ...
    final _path = r'/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchAutoscalingV1NamespacedHorizontalPodAutoscalerList({ 
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/autoscaling/v1/watch/namespaces/{namespace}/horizontalpodautoscalers'.replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
