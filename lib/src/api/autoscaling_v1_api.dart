...
class AutoscalingV1Api {
  ...
  const AutoscalingV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscaler>> createNamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    required V1HorizontalPodAutoscaler body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1HorizontalPodAutoscaler _responseData;

    try {
_responseData = deserialize<V1HorizontalPodAutoscaler, V1HorizontalPodAutoscaler>(_response.data!, 'V1HorizontalPodAutoscaler', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1HorizontalPodAutoscaler>(
      data: _responseData,
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscalerList>> listHorizontalPodAutoscalerForAllNamespaces({ 
    ...
    V1HorizontalPodAutoscalerList _responseData;

    try {
_responseData = deserialize<V1HorizontalPodAutoscalerList, V1HorizontalPodAutoscalerList>(_response.data!, 'V1HorizontalPodAutoscalerList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1HorizontalPodAutoscalerList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscalerList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscalerList>> listNamespacedHorizontalPodAutoscaler({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
...
_responseData = deserialize<V1HorizontalPodAutoscalerList, V1HorizontalPodAutoscalerList>(_response.data!, 'V1HorizontalPodAutoscalerList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscaler>> patchNamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
...
_responseData = deserialize<V1HorizontalPodAutoscaler, V1HorizontalPodAutoscaler>(_response.data!, 'V1HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscaler>> patchNamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required Object body,
    String? pretty,
...
_responseData = deserialize<V1HorizontalPodAutoscaler, V1HorizontalPodAutoscaler>(_response.data!, 'V1HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscaler>> readNamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1HorizontalPodAutoscaler, V1HorizontalPodAutoscaler>(_response.data!, 'V1HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscaler>> readNamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1HorizontalPodAutoscaler, V1HorizontalPodAutoscaler>(_response.data!, 'V1HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscaler>> replaceNamespacedHorizontalPodAutoscaler({ 
    required String name,
    required String namespace,
    required V1HorizontalPodAutoscaler body,
    String? pretty,
...
_responseData = deserialize<V1HorizontalPodAutoscaler, V1HorizontalPodAutoscaler>(_response.data!, 'V1HorizontalPodAutoscaler', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1HorizontalPodAutoscaler] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1HorizontalPodAutoscaler>> replaceNamespacedHorizontalPodAutoscalerStatus({ 
    required String name,
    required String namespace,
    required V1HorizontalPodAutoscaler body,
    String? pretty,
