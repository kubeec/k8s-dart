...
class AuthenticationV1alpha1Api {
  ...
  const AuthenticationV1alpha1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1alpha1SelfSubjectReview] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1alpha1SelfSubjectReview>> createSelfSubjectReview({ 
    required V1alpha1SelfSubjectReview body,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1alpha1SelfSubjectReview _responseData;

    try {
_responseData = deserialize<V1alpha1SelfSubjectReview, V1alpha1SelfSubjectReview>(_response.data!, 'V1alpha1SelfSubjectReview', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1alpha1SelfSubjectReview>(
      data: _responseData,
