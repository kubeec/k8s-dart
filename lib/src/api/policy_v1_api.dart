...
class PolicyV1Api {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudget] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudget>> createNamespacedPodDisruptionBudget({ 
    required String namespace,
    required V1PodDisruptionBudget body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1PodDisruptionBudget _responseData;

    try {
_responseData = deserialize<V1PodDisruptionBudget, V1PodDisruptionBudget>(_response.data!, 'V1PodDisruptionBudget', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1PodDisruptionBudget>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionNamespacedPodDisruptionBudget({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteNamespacedPodDisruptionBudget({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudgetList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudgetList>> listNamespacedPodDisruptionBudget({ 
    required String namespace,
    String? pretty,
    ...
    V1PodDisruptionBudgetList _responseData;

    try {
_responseData = deserialize<V1PodDisruptionBudgetList, V1PodDisruptionBudgetList>(_response.data!, 'V1PodDisruptionBudgetList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1PodDisruptionBudgetList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudgetList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudgetList>> listPodDisruptionBudgetForAllNamespaces({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
...
_responseData = deserialize<V1PodDisruptionBudgetList, V1PodDisruptionBudgetList>(_response.data!, 'V1PodDisruptionBudgetList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudget] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudget>> patchNamespacedPodDisruptionBudget({ 
    required String name,
    required String namespace,
...
_responseData = deserialize<V1PodDisruptionBudget, V1PodDisruptionBudget>(_response.data!, 'V1PodDisruptionBudget', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudget] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudget>> patchNamespacedPodDisruptionBudgetStatus({ 
    required String name,
    required String namespace,
    required Object body,
    String? pretty,
...
_responseData = deserialize<V1PodDisruptionBudget, V1PodDisruptionBudget>(_response.data!, 'V1PodDisruptionBudget', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudget] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudget>> readNamespacedPodDisruptionBudget({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1PodDisruptionBudget, V1PodDisruptionBudget>(_response.data!, 'V1PodDisruptionBudget', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudget] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudget>> readNamespacedPodDisruptionBudgetStatus({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1PodDisruptionBudget, V1PodDisruptionBudget>(_response.data!, 'V1PodDisruptionBudget', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudget] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudget>> replaceNamespacedPodDisruptionBudget({ 
    required String name,
    required String namespace,
    required V1PodDisruptionBudget body,
    String? pretty,
...
_responseData = deserialize<V1PodDisruptionBudget, V1PodDisruptionBudget>(_response.data!, 'V1PodDisruptionBudget', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PodDisruptionBudget] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PodDisruptionBudget>> replaceNamespacedPodDisruptionBudgetStatus({ 
    required String name,
    required String namespace,
    required V1PodDisruptionBudget body,
    String? pretty,
