...
class BatchV1Api {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1CronJob] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJob>> createNamespacedCronJob({ 
    required String namespace,
    required V1CronJob body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1CronJob _responseData;

    try {
_responseData = deserialize<V1CronJob, V1CronJob>(_response.data!, 'V1CronJob', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1Job] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Job>> createNamespacedJob({ 
    required String namespace,
    required V1Job body,
    String? pretty,
    String? dryRun,
...
_bodyData=jsonEncode(body);
    ...
    try {
_responseData = deserialize<V1Job, V1Job>(_response.data!, 'V1Job', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionNamespacedCronJob({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionNamespacedJob({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteNamespacedCronJob({ 
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteNamespacedJob({ 
    required String name,
    required String namespace,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1CronJobList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJobList>> listCronJobForAllNamespaces({ 
    ...
    V1CronJobList _responseData;

    try {
_responseData = deserialize<V1CronJobList, V1CronJobList>(_response.data!, 'V1CronJobList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1JobList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1JobList>> listJobForAllNamespaces({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    V1JobList _responseData;

    try {
_responseData = deserialize<V1JobList, V1JobList>(_response.data!, 'V1JobList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [V1CronJobList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJobList>> listNamespacedCronJob({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
...
_responseData = deserialize<V1CronJobList, V1CronJobList>(_response.data!, 'V1CronJobList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1JobList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1JobList>> listNamespacedJob({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
...
_responseData = deserialize<V1JobList, V1JobList>(_response.data!, 'V1JobList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CronJob] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJob>> patchNamespacedCronJob({ 
    required String name,
    required String namespace,
...
_responseData = deserialize<V1CronJob, V1CronJob>(_response.data!, 'V1CronJob', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CronJob] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJob>> patchNamespacedCronJobStatus({ 
    required String name,
    required String namespace,
    required Object body,
    String? pretty,
...
_responseData = deserialize<V1CronJob, V1CronJob>(_response.data!, 'V1CronJob', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Job] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Job>> patchNamespacedJob({ 
    required String name,
    required String namespace,
    required Object body,
    String? pretty,
...
_responseData = deserialize<V1Job, V1Job>(_response.data!, 'V1Job', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Job] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Job>> patchNamespacedJobStatus({ 
    required String name,
    required String namespace,
    required Object body,
    String? pretty,
...
_responseData = deserialize<V1Job, V1Job>(_response.data!, 'V1Job', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CronJob] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJob>> readNamespacedCronJob({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1CronJob, V1CronJob>(_response.data!, 'V1CronJob', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CronJob] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJob>> readNamespacedCronJobStatus({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1CronJob, V1CronJob>(_response.data!, 'V1CronJob', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Job] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Job>> readNamespacedJob({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1Job, V1Job>(_response.data!, 'V1Job', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Job] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Job>> readNamespacedJobStatus({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1Job, V1Job>(_response.data!, 'V1Job', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CronJob] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJob>> replaceNamespacedCronJob({ 
    required String name,
    required String namespace,
    required V1CronJob body,
    String? pretty,
...
_responseData = deserialize<V1CronJob, V1CronJob>(_response.data!, 'V1CronJob', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CronJob] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CronJob>> replaceNamespacedCronJobStatus({ 
    required String name,
    required String namespace,
    required V1CronJob body,
    String? pretty,
...
_responseData = deserialize<V1CronJob, V1CronJob>(_response.data!, 'V1CronJob', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Job] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Job>> replaceNamespacedJob({ 
    required String name,
    required String namespace,
    required V1Job body,
    String? pretty,
...
_responseData = deserialize<V1Job, V1Job>(_response.data!, 'V1Job', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Job] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Job>> replaceNamespacedJobStatus({ 
    required String name,
    required String namespace,
    required V1Job body,
    String? pretty,
