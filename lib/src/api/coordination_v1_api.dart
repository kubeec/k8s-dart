...
class CoordinationV1Api {
  ...
  const CoordinationV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Lease>> createNamespacedLease({ 
    required String namespace,
    required V1Lease body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1Lease _responseData;

    try {
_responseData = deserialize<V1Lease, V1Lease>(_response.data!, 'V1Lease', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionNamespacedLease({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteNamespacedLease({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1LeaseList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1LeaseList>> listLeaseForAllNamespaces({ 
    ...
    V1LeaseList _responseData;

    try {
_responseData = deserialize<V1LeaseList, V1LeaseList>(_response.data!, 'V1LeaseList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [V1LeaseList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1LeaseList>> listNamespacedLease({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
...
_responseData = deserialize<V1LeaseList, V1LeaseList>(_response.data!, 'V1LeaseList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Lease>> patchNamespacedLease({ 
    required String name,
    required String namespace,
...
_responseData = deserialize<V1Lease, V1Lease>(_response.data!, 'V1Lease', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Lease>> readNamespacedLease({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<V1Lease, V1Lease>(_response.data!, 'V1Lease', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Lease>> replaceNamespacedLease({ 
    required String name,
    required String namespace,
    required V1Lease body,
    String? pretty,
