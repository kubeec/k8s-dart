...
class CoordinationV1Api {
  ...
  const CoordinationV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiCoordinationV1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiCoordinationV1Lease>> createCoordinationV1NamespacedLease({ 
    required String namespace,
    required IoK8sApiCoordinationV1Lease body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases'.replaceAll('{' r'namespace' '}', namespace.toString());
    ...
    try {
      const _type = FullType(IoK8sApiCoordinationV1Lease);
    ...
    IoK8sApiCoordinationV1Lease _responseData;

    try {
      const _responseType = FullType(IoK8sApiCoordinationV1Lease);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiCoordinationV1Lease;
    ...
    return Response<IoK8sApiCoordinationV1Lease>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteCoordinationV1CollectionNamespacedLease({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteCoordinationV1NamespacedLease({ 
    ...
    final _path = r'/apis/coordination.k8s.io/v1/namespaces/{namespace}/leases/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getCoordinationV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/coordination.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiCoordinationV1LeaseList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiCoordinationV1LeaseList>> listCoordinationV1LeaseForAllNamespaces({ 
    ...
    final _path = r'/apis/coordination.k8s.io/v1/leases';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    IoK8sApiCoordinationV1LeaseList _responseData;

    try {
      const _responseType = FullType(IoK8sApiCoordinationV1LeaseList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiCoordinationV1LeaseList;
    ...
    return Response<IoK8sApiCoordinationV1LeaseList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiCoordinationV1LeaseList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiCoordinationV1LeaseList>> listCoordinationV1NamespacedLease({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiCoordinationV1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiCoordinationV1Lease>> patchCoordinationV1NamespacedLease({ 
    required String name,
    required String namespace,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiCoordinationV1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiCoordinationV1Lease>> readCoordinationV1NamespacedLease({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiCoordinationV1Lease] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiCoordinationV1Lease>> replaceCoordinationV1NamespacedLease({ 
    required String name,
    required String namespace,
    required IoK8sApiCoordinationV1Lease body,
    String? pretty,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchCoordinationV1LeaseListForAllNamespaces({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/coordination.k8s.io/v1/watch/leases';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchCoordinationV1NamespacedLease({ 
    required String name,
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    ...
    final _path = r'/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchCoordinationV1NamespacedLeaseList({ 
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/coordination.k8s.io/v1/watch/namespaces/{namespace}/leases'.replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
