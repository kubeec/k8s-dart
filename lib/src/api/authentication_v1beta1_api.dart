...
class AuthenticationV1beta1Api {
  ...
  const AuthenticationV1beta1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1beta1SelfSubjectReview] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1beta1SelfSubjectReview>> createSelfSubjectReview({ 
    required V1beta1SelfSubjectReview body,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/authentication.k8s.io/v1beta1/selfsubjectreviews';
...
_bodyData=jsonEncode(body);
    ...
    V1beta1SelfSubjectReview _responseData;

    try {
_responseData = deserialize<V1beta1SelfSubjectReview, V1beta1SelfSubjectReview>(_response.data!, 'V1beta1SelfSubjectReview', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1beta1SelfSubjectReview>(
      data: _responseData,
  ...
  Future<Response<V1APIResourceList>> getAPIResources({ 
    ...
    final _path = r'/apis/authentication.k8s.io/v1beta1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
