...
class SchedulingV1Api {
  ...
  const SchedulingV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PriorityClass>> createPriorityClass({ 
    required V1PriorityClass body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1PriorityClass _responseData;

    try {
_responseData = deserialize<V1PriorityClass, V1PriorityClass>(_response.data!, 'V1PriorityClass', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1PriorityClass>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionPriorityClass({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deletePriorityClass({ 
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1PriorityClassList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PriorityClassList>> listPriorityClass({ 
    String? pretty,
    ...
    V1PriorityClassList _responseData;

    try {
_responseData = deserialize<V1PriorityClassList, V1PriorityClassList>(_response.data!, 'V1PriorityClassList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1PriorityClassList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PriorityClass>> patchPriorityClass({ 
    required String name,
...
_responseData = deserialize<V1PriorityClass, V1PriorityClass>(_response.data!, 'V1PriorityClass', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PriorityClass>> readPriorityClass({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1PriorityClass, V1PriorityClass>(_response.data!, 'V1PriorityClass', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1PriorityClass>> replacePriorityClass({ 
    required String name,
    required V1PriorityClass body,
    String? pretty,
    String? dryRun,
