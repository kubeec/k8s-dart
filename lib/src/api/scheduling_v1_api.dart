...
class SchedulingV1Api {
  ...
  const SchedulingV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiSchedulingV1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiSchedulingV1PriorityClass>> createSchedulingV1PriorityClass({ 
    required IoK8sApiSchedulingV1PriorityClass body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/scheduling.k8s.io/v1/priorityclasses';
    ...
    try {
      const _type = FullType(IoK8sApiSchedulingV1PriorityClass);
    ...
    IoK8sApiSchedulingV1PriorityClass _responseData;

    try {
      const _responseType = FullType(IoK8sApiSchedulingV1PriorityClass);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiSchedulingV1PriorityClass;
    ...
    return Response<IoK8sApiSchedulingV1PriorityClass>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteSchedulingV1CollectionPriorityClass({ 
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteSchedulingV1PriorityClass({ 
    ...
    final _path = r'/apis/scheduling.k8s.io/v1/priorityclasses/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getSchedulingV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/scheduling.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiSchedulingV1PriorityClassList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiSchedulingV1PriorityClassList>> listSchedulingV1PriorityClass({ 
    String? pretty,
    ...
    IoK8sApiSchedulingV1PriorityClassList _responseData;

    try {
      const _responseType = FullType(IoK8sApiSchedulingV1PriorityClassList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as IoK8sApiSchedulingV1PriorityClassList;
    ...
    return Response<IoK8sApiSchedulingV1PriorityClassList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiSchedulingV1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiSchedulingV1PriorityClass>> patchSchedulingV1PriorityClass({ 
    required String name,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiSchedulingV1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiSchedulingV1PriorityClass>> readSchedulingV1PriorityClass({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiSchedulingV1PriorityClass] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiSchedulingV1PriorityClass>> replaceSchedulingV1PriorityClass({ 
    required String name,
    required IoK8sApiSchedulingV1PriorityClass body,
    String? pretty,
    String? dryRun,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchSchedulingV1PriorityClass({ 
    required String name,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/scheduling.k8s.io/v1/watch/priorityclasses/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchSchedulingV1PriorityClassList({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/scheduling.k8s.io/v1/watch/priorityclasses';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
