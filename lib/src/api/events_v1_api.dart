...
class EventsV1Api {
  ...
  const EventsV1Api(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiEventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiEventsV1Event>> createEventsV1NamespacedEvent({ 
    required String namespace,
    required IoK8sApiEventsV1Event body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
    ...
    final _path = r'/apis/events.k8s.io/v1/namespaces/{namespace}/events'.replaceAll('{' r'namespace' '}', namespace.toString());
    ...
    try {
      const _type = FullType(IoK8sApiEventsV1Event);
    ...
    IoK8sApiEventsV1Event _responseData;

    try {
      const _responseType = FullType(IoK8sApiEventsV1Event);
    ...
    return Response<IoK8sApiEventsV1Event>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteEventsV1CollectionNamespacedEvent({ 
    required String namespace,
    String? pretty,
    String? continue_,
    String? dryRun,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1Status>> deleteEventsV1NamespacedEvent({ 
    ...
    final _path = r'/apis/events.k8s.io/v1/namespaces/{namespace}/events/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1APIResourceList>> getEventsV1APIResources({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/apis/events.k8s.io/v1/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IoK8sApiEventsV1EventList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiEventsV1EventList>> listEventsV1EventForAllNamespaces({ 
    ...
    final _path = r'/apis/events.k8s.io/v1/events';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    IoK8sApiEventsV1EventList _responseData;

    try {
      const _responseType = FullType(IoK8sApiEventsV1EventList);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<IoK8sApiEventsV1EventList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiEventsV1EventList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiEventsV1EventList>> listEventsV1NamespacedEvent({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiEventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiEventsV1Event>> patchEventsV1NamespacedEvent({ 
    required String name,
    required String namespace,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiEventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiEventsV1Event>> readEventsV1NamespacedEvent({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApiEventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApiEventsV1Event>> replaceEventsV1NamespacedEvent({ 
    required String name,
    required String namespace,
    required IoK8sApiEventsV1Event body,
    String? pretty,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchEventsV1EventListForAllNamespaces({ 
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    String? labelSelector,
    ...
    final _path = r'/apis/events.k8s.io/v1/watch/events';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchEventsV1NamespacedEvent({ 
    required String name,
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    ...
    final _path = r'/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events/{name}'.replaceAll('{' r'name' '}', name.toString()).replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [IoK8sApimachineryPkgApisMetaV1WatchEvent] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<IoK8sApimachineryPkgApisMetaV1WatchEvent>> watchEventsV1NamespacedEventList({ 
    required String namespace,
    bool? allowWatchBookmarks,
    String? continue_,
    String? fieldSelector,
    ...
    final _path = r'/apis/events.k8s.io/v1/watch/namespaces/{namespace}/events'.replaceAll('{' r'namespace' '}', namespace.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
