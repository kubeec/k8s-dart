...
class EventsV1Api {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [EventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventsV1Event>> createNamespacedEvent({ 
    required String namespace,
    required EventsV1Event body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    EventsV1Event _responseData;

    try {
_responseData = deserialize<EventsV1Event, EventsV1Event>(_response.data!, 'EventsV1Event', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [EventsV1EventList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventsV1EventList>> listEventForAllNamespaces({ 
    ...
    EventsV1EventList _responseData;

    try {
_responseData = deserialize<EventsV1EventList, EventsV1EventList>(_response.data!, 'EventsV1EventList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<EventsV1EventList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [EventsV1EventList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventsV1EventList>> listNamespacedEvent({ 
    required String namespace,
    String? pretty,
    bool? allowWatchBookmarks,
    String? continue_,
...
_responseData = deserialize<EventsV1EventList, EventsV1EventList>(_response.data!, 'EventsV1EventList', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [EventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventsV1Event>> patchNamespacedEvent({ 
    required String name,
    required String namespace,
...
_responseData = deserialize<EventsV1Event, EventsV1Event>(_response.data!, 'EventsV1Event', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [EventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventsV1Event>> readNamespacedEvent({ 
    required String name,
    required String namespace,
    String? pretty,
    CancelToken? cancelToken,
...
_responseData = deserialize<EventsV1Event, EventsV1Event>(_response.data!, 'EventsV1Event', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [EventsV1Event] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<EventsV1Event>> replaceNamespacedEvent({ 
    required String name,
    required String namespace,
    required EventsV1Event body,
    String? pretty,
