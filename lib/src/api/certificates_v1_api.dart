...
class CertificatesV1Api {
  ...
  const CertificatesV1Api(this._dio);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> createCertificateSigningRequest({ 
    required V1CertificateSigningRequest body,
    String? pretty,
    String? dryRun,
    String? fieldManager,
...
_bodyData=jsonEncode(body);
    ...
    V1CertificateSigningRequest _responseData;

    try {
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
    ...
    return Response<V1CertificateSigningRequest>(
      data: _responseData,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCertificateSigningRequest({ 
...
_responseData = deserialize<V1Status, V1Status>(_response.data!, 'V1Status', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1Status] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1Status>> deleteCollectionCertificateSigningRequest({ 
    String? pretty,
    String? continue_,
    String? dryRun,
...
_responseData = deserialize<V1APIResourceList, V1APIResourceList>(_response.data!, 'V1APIResourceList', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequestList] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequestList>> listCertificateSigningRequest({ 
    String? pretty,
    ...
    V1CertificateSigningRequestList _responseData;

    try {
_responseData = deserialize<V1CertificateSigningRequestList, V1CertificateSigningRequestList>(_response.data!, 'V1CertificateSigningRequestList', growable: true);
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1CertificateSigningRequestList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> patchCertificateSigningRequest({ 
    required String name,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> patchCertificateSigningRequestApproval({ 
    required String name,
    required Object body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> patchCertificateSigningRequestStatus({ 
    required String name,
    required Object body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> readCertificateSigningRequest({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> readCertificateSigningRequestApproval({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> readCertificateSigningRequestStatus({ 
    required String name,
    String? pretty,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> replaceCertificateSigningRequest({ 
    required String name,
    required V1CertificateSigningRequest body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> replaceCertificateSigningRequestApproval({ 
    required String name,
    required V1CertificateSigningRequest body,
    String? pretty,
    String? dryRun,
...
_responseData = deserialize<V1CertificateSigningRequest, V1CertificateSigningRequest>(_response.data!, 'V1CertificateSigningRequest', growable: true);
  ...
  /// Returns a [Future] containing a [Response] with a [V1CertificateSigningRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<V1CertificateSigningRequest>> replaceCertificateSigningRequestStatus({ 
    required String name,
    required V1CertificateSigningRequest body,
    String? pretty,
    String? dryRun,
