...
part 'v1_iscsi_volume_source.g.dart';
...
class V1ISCSIVolumeSource {
  /// Returns a new [V1ISCSIVolumeSource] instance.
  V1ISCSIVolumeSource({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1ISCSIVolumeSource &&
  ...
  factory V1ISCSIVolumeSource.fromJson(Map<String, dynamic> json) => _$V1ISCSIVolumeSourceFromJson(json);

  Map<String, dynamic> toJson() => _$V1ISCSIVolumeSourceToJson(this);
