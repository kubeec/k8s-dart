...
abstract class IoK8sApiCoreV1PersistentVolumeList implements Built<IoK8sApiCoreV1PersistentVolumeList, IoK8sApiCoreV1PersistentVolumeListBuilder> {
  ...
  factory IoK8sApiCoreV1PersistentVolumeList([void updates(IoK8sApiCoreV1PersistentVolumeListBuilder b)]) = _$IoK8sApiCoreV1PersistentVolumeList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1PersistentVolumeListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1PersistentVolumeList> get serializer => _$IoK8sApiCoreV1PersistentVolumeListSerializer();
}

class _$IoK8sApiCoreV1PersistentVolumeListSerializer implements PrimitiveSerializer<IoK8sApiCoreV1PersistentVolumeList> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1PersistentVolumeList, _$IoK8sApiCoreV1PersistentVolumeList];

  @override
  final String wireName = r'IoK8sApiCoreV1PersistentVolumeList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1PersistentVolumeList object, {
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1PersistentVolume)]),
    );
    if (object.kind != null) {
      yield r'kind';
      yield serializers.serialize(
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1PersistentVolumeListBuilder result,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1PersistentVolume)]),
          ) as BuiltList<IoK8sApiCoreV1PersistentVolume>;
  ...
  @override
  IoK8sApiCoreV1PersistentVolumeList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1PersistentVolumeListBuilder();
