...
abstract class IoK8sApiBatchV1JobList implements Built<IoK8sApiBatchV1JobList, IoK8sApiBatchV1JobListBuilder> {
  ...
  factory IoK8sApiBatchV1JobList([void updates(IoK8sApiBatchV1JobListBuilder b)]) = _$IoK8sApiBatchV1JobList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiBatchV1JobListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiBatchV1JobList> get serializer => _$IoK8sApiBatchV1JobListSerializer();
}

class _$IoK8sApiBatchV1JobListSerializer implements PrimitiveSerializer<IoK8sApiBatchV1JobList> {
  @override
  final Iterable<Type> types = const [IoK8sApiBatchV1JobList, _$IoK8sApiBatchV1JobList];

  @override
  final String wireName = r'IoK8sApiBatchV1JobList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiBatchV1JobList object, {
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(IoK8sApiBatchV1Job)]),
    );
    if (object.kind != null) {
      yield r'kind';
      yield serializers.serialize(
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiBatchV1JobListBuilder result,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(IoK8sApiBatchV1Job)]),
          ) as BuiltList<IoK8sApiBatchV1Job>;
  ...
  @override
  IoK8sApiBatchV1JobList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiBatchV1JobListBuilder();
