...
part of 'v1_container.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

V1Container _$V1ContainerFromJson(Map<String, dynamic> json) => $checkedCreate(
      'V1Container',
      json,
      ($checkedConvert) {
        $checkKeys(
...
Map<String, dynamic> _$V1ContainerToJson(V1Container instance) {
