...
part 'v1_mutating_webhook.g.dart';
...
class V1MutatingWebhook {
  /// Returns a new [V1MutatingWebhook] instance.
  V1MutatingWebhook({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1MutatingWebhook &&
  ...
  int get hashCode =>
    ...
    reinvocationPolicy.hashCode +
    rules.hashCode +
    sideEffects.hashCode +
    timeoutSeconds.hashCode;

  factory V1MutatingWebhook.fromJson(Map<String, dynamic> json) => _$V1MutatingWebhookFromJson(json);

  Map<String, dynamic> toJson() => _$V1MutatingWebhookToJson(this);
