...
abstract class IoK8sApiCoreV1PodAntiAffinity implements Built<IoK8sApiCoreV1PodAntiAffinity, IoK8sApiCoreV1PodAntiAffinityBuilder> {
  ...
  factory IoK8sApiCoreV1PodAntiAffinity([void updates(IoK8sApiCoreV1PodAntiAffinityBuilder b)]) = _$IoK8sApiCoreV1PodAntiAffinity;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1PodAntiAffinityBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1PodAntiAffinity> get serializer => _$IoK8sApiCoreV1PodAntiAffinitySerializer();
}

class _$IoK8sApiCoreV1PodAntiAffinitySerializer implements PrimitiveSerializer<IoK8sApiCoreV1PodAntiAffinity> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1PodAntiAffinity, _$IoK8sApiCoreV1PodAntiAffinity];

  @override
  final String wireName = r'IoK8sApiCoreV1PodAntiAffinity';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1PodAntiAffinity object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1PodAntiAffinityBuilder result,
  ...
  @override
  IoK8sApiCoreV1PodAntiAffinity deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1PodAntiAffinityBuilder();
