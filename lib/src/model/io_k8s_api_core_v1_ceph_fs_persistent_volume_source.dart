...
abstract class IoK8sApiCoreV1CephFSPersistentVolumeSource implements Built<IoK8sApiCoreV1CephFSPersistentVolumeSource, IoK8sApiCoreV1CephFSPersistentVolumeSourceBuilder> {
  ...
  factory IoK8sApiCoreV1CephFSPersistentVolumeSource([void updates(IoK8sApiCoreV1CephFSPersistentVolumeSourceBuilder b)]) = _$IoK8sApiCoreV1CephFSPersistentVolumeSource;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1CephFSPersistentVolumeSourceBuilder b) => b;
...
class _$IoK8sApiCoreV1CephFSPersistentVolumeSourceSerializer implements PrimitiveSerializer<IoK8sApiCoreV1CephFSPersistentVolumeSource> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1CephFSPersistentVolumeSource, _$IoK8sApiCoreV1CephFSPersistentVolumeSource];

  @override
  final String wireName = r'IoK8sApiCoreV1CephFSPersistentVolumeSource';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1CephFSPersistentVolumeSource object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1CephFSPersistentVolumeSourceBuilder result,
  ...
  @override
  IoK8sApiCoreV1CephFSPersistentVolumeSource deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1CephFSPersistentVolumeSourceBuilder();
