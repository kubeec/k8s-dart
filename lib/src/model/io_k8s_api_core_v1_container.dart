...
abstract class IoK8sApiCoreV1Container implements Built<IoK8sApiCoreV1Container, IoK8sApiCoreV1ContainerBuilder> {
  ...
  factory IoK8sApiCoreV1Container([void updates(IoK8sApiCoreV1ContainerBuilder b)]) = _$IoK8sApiCoreV1Container;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1ContainerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1Container> get serializer => _$IoK8sApiCoreV1ContainerSerializer();
}

class _$IoK8sApiCoreV1ContainerSerializer implements PrimitiveSerializer<IoK8sApiCoreV1Container> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1Container, _$IoK8sApiCoreV1Container];

  @override
  final String wireName = r'IoK8sApiCoreV1Container';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1Container object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1ContainerBuilder result,
  ...
  @override
  IoK8sApiCoreV1Container deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1ContainerBuilder();
