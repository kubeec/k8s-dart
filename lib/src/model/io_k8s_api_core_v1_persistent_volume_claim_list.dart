...
abstract class IoK8sApiCoreV1PersistentVolumeClaimList implements Built<IoK8sApiCoreV1PersistentVolumeClaimList, IoK8sApiCoreV1PersistentVolumeClaimListBuilder> {
  ...
  factory IoK8sApiCoreV1PersistentVolumeClaimList([void updates(IoK8sApiCoreV1PersistentVolumeClaimListBuilder b)]) = _$IoK8sApiCoreV1PersistentVolumeClaimList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1PersistentVolumeClaimListBuilder b) => b;
...
class _$IoK8sApiCoreV1PersistentVolumeClaimListSerializer implements PrimitiveSerializer<IoK8sApiCoreV1PersistentVolumeClaimList> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1PersistentVolumeClaimList, _$IoK8sApiCoreV1PersistentVolumeClaimList];

  @override
  final String wireName = r'IoK8sApiCoreV1PersistentVolumeClaimList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1PersistentVolumeClaimList object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1PersistentVolumeClaimListBuilder result,
  ...
  @override
  IoK8sApiCoreV1PersistentVolumeClaimList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1PersistentVolumeClaimListBuilder();
