...
abstract class IoK8sApiRbacV1Role implements Built<IoK8sApiRbacV1Role, IoK8sApiRbacV1RoleBuilder> {
  ...
  factory IoK8sApiRbacV1Role([void updates(IoK8sApiRbacV1RoleBuilder b)]) = _$IoK8sApiRbacV1Role;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiRbacV1RoleBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiRbacV1Role> get serializer => _$IoK8sApiRbacV1RoleSerializer();
}

class _$IoK8sApiRbacV1RoleSerializer implements PrimitiveSerializer<IoK8sApiRbacV1Role> {
  @override
  final Iterable<Type> types = const [IoK8sApiRbacV1Role, _$IoK8sApiRbacV1Role];

  @override
  final String wireName = r'IoK8sApiRbacV1Role';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiRbacV1Role object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiRbacV1RoleBuilder result,
  ...
  @override
  IoK8sApiRbacV1Role deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiRbacV1RoleBuilder();
