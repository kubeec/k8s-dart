...
class V1Node {
  ...
  factory V1Node.fromJson(Map<String, dynamic> json) => _$V1NodeFromJson(json);

  Map<String, dynamic> toJson() => _$V1NodeToJson(this);
