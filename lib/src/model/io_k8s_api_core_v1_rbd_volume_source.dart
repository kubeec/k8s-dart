...
abstract class IoK8sApiCoreV1RBDVolumeSource implements Built<IoK8sApiCoreV1RBDVolumeSource, IoK8sApiCoreV1RBDVolumeSourceBuilder> {
  ...
  factory IoK8sApiCoreV1RBDVolumeSource([void updates(IoK8sApiCoreV1RBDVolumeSourceBuilder b)]) = _$IoK8sApiCoreV1RBDVolumeSource;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1RBDVolumeSourceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1RBDVolumeSource> get serializer => _$IoK8sApiCoreV1RBDVolumeSourceSerializer();
}

class _$IoK8sApiCoreV1RBDVolumeSourceSerializer implements PrimitiveSerializer<IoK8sApiCoreV1RBDVolumeSource> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1RBDVolumeSource, _$IoK8sApiCoreV1RBDVolumeSource];

  @override
  final String wireName = r'IoK8sApiCoreV1RBDVolumeSource';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1RBDVolumeSource object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1RBDVolumeSourceBuilder result,
  ...
  @override
  IoK8sApiCoreV1RBDVolumeSource deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1RBDVolumeSourceBuilder();
