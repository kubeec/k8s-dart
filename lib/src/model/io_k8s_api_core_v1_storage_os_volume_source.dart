...
abstract class IoK8sApiCoreV1StorageOSVolumeSource implements Built<IoK8sApiCoreV1StorageOSVolumeSource, IoK8sApiCoreV1StorageOSVolumeSourceBuilder> {
  ...
  factory IoK8sApiCoreV1StorageOSVolumeSource([void updates(IoK8sApiCoreV1StorageOSVolumeSourceBuilder b)]) = _$IoK8sApiCoreV1StorageOSVolumeSource;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1StorageOSVolumeSourceBuilder b) => b;
...
class _$IoK8sApiCoreV1StorageOSVolumeSourceSerializer implements PrimitiveSerializer<IoK8sApiCoreV1StorageOSVolumeSource> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1StorageOSVolumeSource, _$IoK8sApiCoreV1StorageOSVolumeSource];

  @override
  final String wireName = r'IoK8sApiCoreV1StorageOSVolumeSource';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1StorageOSVolumeSource object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1StorageOSVolumeSourceBuilder result,
  ...
  @override
  IoK8sApiCoreV1StorageOSVolumeSource deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1StorageOSVolumeSourceBuilder();
