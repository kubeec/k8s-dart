...
abstract class IoK8sApiCoreV1EmptyDirVolumeSource implements Built<IoK8sApiCoreV1EmptyDirVolumeSource, IoK8sApiCoreV1EmptyDirVolumeSourceBuilder> {
  ...
  factory IoK8sApiCoreV1EmptyDirVolumeSource([void updates(IoK8sApiCoreV1EmptyDirVolumeSourceBuilder b)]) = _$IoK8sApiCoreV1EmptyDirVolumeSource;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1EmptyDirVolumeSourceBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1EmptyDirVolumeSource> get serializer => _$IoK8sApiCoreV1EmptyDirVolumeSourceSerializer();
}

class _$IoK8sApiCoreV1EmptyDirVolumeSourceSerializer implements PrimitiveSerializer<IoK8sApiCoreV1EmptyDirVolumeSource> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1EmptyDirVolumeSource, _$IoK8sApiCoreV1EmptyDirVolumeSource];

  @override
  final String wireName = r'IoK8sApiCoreV1EmptyDirVolumeSource';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1EmptyDirVolumeSource object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1EmptyDirVolumeSourceBuilder result,
  ...
  @override
  IoK8sApiCoreV1EmptyDirVolumeSource deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1EmptyDirVolumeSourceBuilder();
