...
part 'io_k8s_api_flowcontrol_v1beta3_resource_policy_rule.g.dart';
...
@BuiltValue()
abstract class IoK8sApiFlowcontrolV1beta3ResourcePolicyRule implements Built<IoK8sApiFlowcontrolV1beta3ResourcePolicyRule, IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleBuilder> {
  ...
  IoK8sApiFlowcontrolV1beta3ResourcePolicyRule._();

  factory IoK8sApiFlowcontrolV1beta3ResourcePolicyRule([void updates(IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleBuilder b)]) = _$IoK8sApiFlowcontrolV1beta3ResourcePolicyRule;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiFlowcontrolV1beta3ResourcePolicyRule> get serializer => _$IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleSerializer();
}

class _$IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleSerializer implements PrimitiveSerializer<IoK8sApiFlowcontrolV1beta3ResourcePolicyRule> {
  @override
  final Iterable<Type> types = const [IoK8sApiFlowcontrolV1beta3ResourcePolicyRule, _$IoK8sApiFlowcontrolV1beta3ResourcePolicyRule];

  @override
  final String wireName = r'IoK8sApiFlowcontrolV1beta3ResourcePolicyRule';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiFlowcontrolV1beta3ResourcePolicyRule object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleBuilder result,
  ...
  @override
  IoK8sApiFlowcontrolV1beta3ResourcePolicyRule deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiFlowcontrolV1beta3ResourcePolicyRuleBuilder();
