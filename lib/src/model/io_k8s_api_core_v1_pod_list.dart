...
abstract class IoK8sApiCoreV1PodList implements Built<IoK8sApiCoreV1PodList, IoK8sApiCoreV1PodListBuilder> {
  ...
  factory IoK8sApiCoreV1PodList([void updates(IoK8sApiCoreV1PodListBuilder b)]) = _$IoK8sApiCoreV1PodList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1PodListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1PodList> get serializer => _$IoK8sApiCoreV1PodListSerializer();
}

class _$IoK8sApiCoreV1PodListSerializer implements PrimitiveSerializer<IoK8sApiCoreV1PodList> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1PodList, _$IoK8sApiCoreV1PodList];

  @override
  final String wireName = r'IoK8sApiCoreV1PodList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1PodList object, {
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1Pod)]),
    );
    if (object.kind != null) {
      yield r'kind';
      yield serializers.serialize(
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1PodListBuilder result,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1Pod)]),
          ) as BuiltList<IoK8sApiCoreV1Pod>;
  ...
  @override
  IoK8sApiCoreV1PodList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1PodListBuilder();
