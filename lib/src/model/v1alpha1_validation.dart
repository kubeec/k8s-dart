...
part 'v1alpha1_validation.g.dart';
...
class V1alpha1Validation {
  /// Returns a new [V1alpha1Validation] instance.
  V1alpha1Validation({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1alpha1Validation &&
  ...
  factory V1alpha1Validation.fromJson(Map<String, dynamic> json) => _$V1alpha1ValidationFromJson(json);

  Map<String, dynamic> toJson() => _$V1alpha1ValidationToJson(this);
