...
abstract class IoK8sApiCoreV1Binding implements Built<IoK8sApiCoreV1Binding, IoK8sApiCoreV1BindingBuilder> {
  ...
  factory IoK8sApiCoreV1Binding([void updates(IoK8sApiCoreV1BindingBuilder b)]) = _$IoK8sApiCoreV1Binding;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1BindingBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1Binding> get serializer => _$IoK8sApiCoreV1BindingSerializer();
}

class _$IoK8sApiCoreV1BindingSerializer implements PrimitiveSerializer<IoK8sApiCoreV1Binding> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1Binding, _$IoK8sApiCoreV1Binding];

  @override
  final String wireName = r'IoK8sApiCoreV1Binding';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1Binding object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1BindingBuilder result,
  ...
  @override
  IoK8sApiCoreV1Binding deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1BindingBuilder();
