...
part 'v1beta2_flow_schema_spec.g.dart';
...
class V1beta2FlowSchemaSpec {
  /// Returns a new [V1beta2FlowSchemaSpec] instance.
  ...
  final V1beta2FlowDistinguisherMethod? distinguisherMethod;
  ...
  final V1beta2PriorityLevelConfigurationReference priorityLevelConfiguration;
  ...
  final List<V1beta2PolicyRulesWithSubjects>? rules;



  @override
  bool operator ==(Object other) => identical(this, other) || other is V1beta2FlowSchemaSpec &&
  ...
  factory V1beta2FlowSchemaSpec.fromJson(Map<String, dynamic> json) => _$V1beta2FlowSchemaSpecFromJson(json);

  Map<String, dynamic> toJson() => _$V1beta2FlowSchemaSpecToJson(this);
