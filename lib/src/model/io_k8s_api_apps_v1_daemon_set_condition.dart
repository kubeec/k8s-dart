...
abstract class IoK8sApiAppsV1DaemonSetCondition implements Built<IoK8sApiAppsV1DaemonSetCondition, IoK8sApiAppsV1DaemonSetConditionBuilder> {
  ...
  factory IoK8sApiAppsV1DaemonSetCondition([void updates(IoK8sApiAppsV1DaemonSetConditionBuilder b)]) = _$IoK8sApiAppsV1DaemonSetCondition;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiAppsV1DaemonSetConditionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiAppsV1DaemonSetCondition> get serializer => _$IoK8sApiAppsV1DaemonSetConditionSerializer();
}

class _$IoK8sApiAppsV1DaemonSetConditionSerializer implements PrimitiveSerializer<IoK8sApiAppsV1DaemonSetCondition> {
  @override
  final Iterable<Type> types = const [IoK8sApiAppsV1DaemonSetCondition, _$IoK8sApiAppsV1DaemonSetCondition];

  @override
  final String wireName = r'IoK8sApiAppsV1DaemonSetCondition';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiAppsV1DaemonSetCondition object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiAppsV1DaemonSetConditionBuilder result,
  ...
  @override
  IoK8sApiAppsV1DaemonSetCondition deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiAppsV1DaemonSetConditionBuilder();
