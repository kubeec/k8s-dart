...
part 'v1beta3_non_resource_policy_rule.g.dart';
...
class V1beta3NonResourcePolicyRule {
  /// Returns a new [V1beta3NonResourcePolicyRule] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1beta3NonResourcePolicyRule &&
  ...
  factory V1beta3NonResourcePolicyRule.fromJson(Map<String, dynamic> json) => _$V1beta3NonResourcePolicyRuleFromJson(json);

  Map<String, dynamic> toJson() => _$V1beta3NonResourcePolicyRuleToJson(this);
