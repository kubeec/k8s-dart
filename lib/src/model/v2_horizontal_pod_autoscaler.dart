...
class V2HorizontalPodAutoscaler {
  /// Returns a new [V2HorizontalPodAutoscaler] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V2HorizontalPodAutoscaler &&
  ...
  factory V2HorizontalPodAutoscaler.fromJson(Map<String, dynamic> json) => _$V2HorizontalPodAutoscalerFromJson(json);

  Map<String, dynamic> toJson() => _$V2HorizontalPodAutoscalerToJson(this);
