...
abstract class IoK8sApiCoreV1SecretList implements Built<IoK8sApiCoreV1SecretList, IoK8sApiCoreV1SecretListBuilder> {
  ...
  factory IoK8sApiCoreV1SecretList([void updates(IoK8sApiCoreV1SecretListBuilder b)]) = _$IoK8sApiCoreV1SecretList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1SecretListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1SecretList> get serializer => _$IoK8sApiCoreV1SecretListSerializer();
}

class _$IoK8sApiCoreV1SecretListSerializer implements PrimitiveSerializer<IoK8sApiCoreV1SecretList> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1SecretList, _$IoK8sApiCoreV1SecretList];

  @override
  final String wireName = r'IoK8sApiCoreV1SecretList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1SecretList object, {
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1Secret)]),
    );
    if (object.kind != null) {
      yield r'kind';
      yield serializers.serialize(
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1SecretListBuilder result,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1Secret)]),
          ) as BuiltList<IoK8sApiCoreV1Secret>;
  ...
  @override
  IoK8sApiCoreV1SecretList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1SecretListBuilder();
