...
part 'io_k8s_api_core_v1_secret.g.dart';
...
@BuiltValue()
abstract class IoK8sApiCoreV1Secret implements Built<IoK8sApiCoreV1Secret, IoK8sApiCoreV1SecretBuilder> {
  ...
  @BuiltValueField(wireName: r'stringData')
  BuiltMap<String, String>? get stringData;

  /// Used to facilitate programmatic handling of secret data. More info: https://kubernetes.io/docs/concepts/configuration/secret/#secret-types
  @BuiltValueField(wireName: r'type')
  String? get type;

  IoK8sApiCoreV1Secret._();

  factory IoK8sApiCoreV1Secret([void updates(IoK8sApiCoreV1SecretBuilder b)]) = _$IoK8sApiCoreV1Secret;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1SecretBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1Secret> get serializer => _$IoK8sApiCoreV1SecretSerializer();
}

class _$IoK8sApiCoreV1SecretSerializer implements PrimitiveSerializer<IoK8sApiCoreV1Secret> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1Secret, _$IoK8sApiCoreV1Secret];

  @override
  final String wireName = r'IoK8sApiCoreV1Secret';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1Secret object, {
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1SecretBuilder result,
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'stringData':
          ...
          result.stringData.replace(valueDes);
          break;
        case r'type':
          final valueDes = serializers.deserialize(
            value,
  ...
  @override
  IoK8sApiCoreV1Secret deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1SecretBuilder();
