...
part 'v1alpha1_match_condition.g.dart';
...
class V1alpha1MatchCondition {
  /// Returns a new [V1alpha1MatchCondition] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1alpha1MatchCondition &&
  ...
  factory V1alpha1MatchCondition.fromJson(Map<String, dynamic> json) => _$V1alpha1MatchConditionFromJson(json);

  Map<String, dynamic> toJson() => _$V1alpha1MatchConditionToJson(this);
