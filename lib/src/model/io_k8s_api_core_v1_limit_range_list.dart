...
abstract class IoK8sApiCoreV1LimitRangeList implements Built<IoK8sApiCoreV1LimitRangeList, IoK8sApiCoreV1LimitRangeListBuilder> {
  ...
  factory IoK8sApiCoreV1LimitRangeList([void updates(IoK8sApiCoreV1LimitRangeListBuilder b)]) = _$IoK8sApiCoreV1LimitRangeList;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiCoreV1LimitRangeListBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiCoreV1LimitRangeList> get serializer => _$IoK8sApiCoreV1LimitRangeListSerializer();
}

class _$IoK8sApiCoreV1LimitRangeListSerializer implements PrimitiveSerializer<IoK8sApiCoreV1LimitRangeList> {
  @override
  final Iterable<Type> types = const [IoK8sApiCoreV1LimitRangeList, _$IoK8sApiCoreV1LimitRangeList];

  @override
  final String wireName = r'IoK8sApiCoreV1LimitRangeList';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiCoreV1LimitRangeList object, {
    ...
    yield serializers.serialize(
      object.items,
      specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1LimitRange)]),
    );
    if (object.kind != null) {
      yield r'kind';
      yield serializers.serialize(
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiCoreV1LimitRangeListBuilder result,
      ...
      switch (key) {
        ...
        case r'items':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(IoK8sApiCoreV1LimitRange)]),
          ) as BuiltList<IoK8sApiCoreV1LimitRange>;
  ...
  @override
  IoK8sApiCoreV1LimitRangeList deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiCoreV1LimitRangeListBuilder();
