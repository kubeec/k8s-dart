...
abstract class IoK8sApiBatchV1Job implements Built<IoK8sApiBatchV1Job, IoK8sApiBatchV1JobBuilder> {
  ...
  factory IoK8sApiBatchV1Job([void updates(IoK8sApiBatchV1JobBuilder b)]) = _$IoK8sApiBatchV1Job;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(IoK8sApiBatchV1JobBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<IoK8sApiBatchV1Job> get serializer => _$IoK8sApiBatchV1JobSerializer();
}

class _$IoK8sApiBatchV1JobSerializer implements PrimitiveSerializer<IoK8sApiBatchV1Job> {
  @override
  final Iterable<Type> types = const [IoK8sApiBatchV1Job, _$IoK8sApiBatchV1Job];

  @override
  final String wireName = r'IoK8sApiBatchV1Job';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    IoK8sApiBatchV1Job object, {
    ...
    if (object.status != null) {
      ...
      yield serializers.serialize(
        object.status,
        specifiedType: const FullType(IoK8sApiBatchV1JobStatus),
      );
    }
  }
  ...
  void _deserializeProperties(
    ...
    required IoK8sApiBatchV1JobBuilder result,
  ...
  @override
  IoK8sApiBatchV1Job deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = IoK8sApiBatchV1JobBuilder();
