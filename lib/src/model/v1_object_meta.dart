...
class V1ObjectMeta {
  /// Returns a new [V1ObjectMeta] instance.
  V1ObjectMeta({
  ...
  @JsonKey(
    ...
    name: r'deletionGracePeriodSeconds',
    required: false,
    includeIfNull: false
  )
  ...
  @JsonKey(
    ...
    name: r'managedFields',
    required: false,
    includeIfNull: false
  )


  final List<V1ManagedFieldsEntry>? managedFields;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1ObjectMeta &&
  ...
  int get hashCode =>
    ...
    deletionTimestamp.hashCode +
    finalizers.hashCode +
    generateName.hashCode +
    generation.hashCode +
    labels.hashCode +
  ...
  factory V1ObjectMeta.fromJson(Map<String, dynamic> json) => _$V1ObjectMetaFromJson(json);

  Map<String, dynamic> toJson() => _$V1ObjectMetaToJson(this);
