...
part of 'v1_iscsi_persistent_volume_source.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

V1ISCSIPersistentVolumeSource _$V1ISCSIPersistentVolumeSourceFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = V1ISCSIPersistentVolumeSource(
          chapAuthDiscovery:
...
Map<String, dynamic> _$V1ISCSIPersistentVolumeSourceToJson(
