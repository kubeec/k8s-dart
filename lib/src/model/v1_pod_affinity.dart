...
class V1PodAffinity {
  /// Returns a new [V1PodAffinity] instance.
  V1PodAffinity({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is V1PodAffinity &&
  ...
  factory V1PodAffinity.fromJson(Map<String, dynamic> json) => _$V1PodAffinityFromJson(json);

  Map<String, dynamic> toJson() => _$V1PodAffinityToJson(this);
