...
class FlowcontrolApiserverApi {
  FlowcontrolApiserverApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getFlowcontrolApiserverAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/flowcontrol.apiserver.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getFlowcontrolApiserverAPIGroup() async {
    final response = await getFlowcontrolApiserverAPIGroupWithHttpInfo();
