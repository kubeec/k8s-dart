...
class ApiextensionsApi {
  ApiextensionsApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getApiextensionsAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/apiextensions.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getApiextensionsAPIGroup() async {
    final response = await getApiextensionsAPIGroupWithHttpInfo();
