...
class NetworkingApi {
  NetworkingApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getNetworkingAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/networking.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getNetworkingAPIGroup() async {
    final response = await getNetworkingAPIGroupWithHttpInfo();
