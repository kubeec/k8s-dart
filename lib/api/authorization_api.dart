...
class AuthorizationApi {
  ...
  Future<Response> getAuthorizationAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/authorization.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getAuthorizationAPIGroup() async {
    final response = await getAuthorizationAPIGroupWithHttpInfo();
