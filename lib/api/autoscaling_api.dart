...
class AutoscalingApi {
  AutoscalingApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getAutoscalingAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/autoscaling/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getAutoscalingAPIGroup() async {
    final response = await getAutoscalingAPIGroupWithHttpInfo();
