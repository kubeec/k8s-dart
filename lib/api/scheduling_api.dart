...
class SchedulingApi {
  SchedulingApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getSchedulingAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/scheduling.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getSchedulingAPIGroup() async {
    final response = await getSchedulingAPIGroupWithHttpInfo();
