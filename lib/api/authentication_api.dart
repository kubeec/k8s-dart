...
class AuthenticationApi {
  ...
  Future<Response> getAuthenticationAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/authentication.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getAuthenticationAPIGroup() async {
    final response = await getAuthenticationAPIGroupWithHttpInfo();
