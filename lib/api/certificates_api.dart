...
class CertificatesApi {
  ...
  Future<Response> getCertificatesAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/certificates.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getCertificatesAPIGroup() async {
    final response = await getCertificatesAPIGroupWithHttpInfo();
