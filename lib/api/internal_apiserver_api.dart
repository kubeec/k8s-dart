...
class InternalApiserverApi {
  InternalApiserverApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getInternalApiserverAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/internal.apiserver.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getInternalApiserverAPIGroup() async {
    final response = await getInternalApiserverAPIGroupWithHttpInfo();
