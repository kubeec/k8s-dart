...
class WellKnownApi {
  ...
  Future<Response> getServiceAccountIssuerOpenIDConfigurationWithHttpInfo() async {
  ...
  Future<String?> getServiceAccountIssuerOpenIDConfiguration() async {
    final response = await getServiceAccountIssuerOpenIDConfigurationWithHttpInfo();
