...
class CoordinationApi {
  CoordinationApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getCoordinationAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/coordination.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getCoordinationAPIGroup() async {
    final response = await getCoordinationAPIGroupWithHttpInfo();
