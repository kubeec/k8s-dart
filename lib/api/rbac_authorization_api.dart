...
class RbacAuthorizationApi {
  RbacAuthorizationApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getRbacAuthorizationAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/rbac.authorization.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getRbacAuthorizationAPIGroup() async {
    final response = await getRbacAuthorizationAPIGroupWithHttpInfo();
