...
class AdmissionregistrationApi {
  AdmissionregistrationApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getAdmissionregistrationAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/admissionregistration.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getAdmissionregistrationAPIGroup() async {
    final response = await getAdmissionregistrationAPIGroupWithHttpInfo();
