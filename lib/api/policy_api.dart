...
class PolicyApi {
  PolicyApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getPolicyAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/policy/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getPolicyAPIGroup() async {
    final response = await getPolicyAPIGroupWithHttpInfo();
