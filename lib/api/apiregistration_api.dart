...
class ApiregistrationApi {
  ApiregistrationApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> getApiregistrationAPIGroupWithHttpInfo() async {
    // ignore: prefer_const_declarations
    final path = r'/apis/apiregistration.k8s.io/';
  ...
  Future<IoK8sApimachineryPkgApisMetaV1APIGroup?> getApiregistrationAPIGroup() async {
    final response = await getApiregistrationAPIGroupWithHttpInfo();
